...
type IndividualGeographicalAreaDocumentApi interface {
	...
	*/
	QueryServiceContinuity(ctx context.Context, geoId string) ApiQueryServiceContinuityRequest

	// QueryServiceContinuityExecute executes the request
	//  @return V2xServiceInfo
	QueryServiceContinuityExecute(r ApiQueryServiceContinuityRequest) (*V2xServiceInfo, *http.Response, error)
}
...
type ApiQueryServiceContinuityRequest struct {
	ctx context.Context
	ApiService IndividualGeographicalAreaDocumentApi
	geoId string
	serviceId *string
	suppFeat *string
}
...
func (a *IndividualGeographicalAreaDocumentApiService) QueryServiceContinuityExecute(r ApiQueryServiceContinuityRequest) (*V2xServiceInfo, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"geoId"+"}", url.PathEscape(parameterToString(r.geoId, "")), -1)
	...
	localVarQueryParams.Add("service-id", parameterToString(*r.serviceId, ""))
	if r.suppFeat != nil {
