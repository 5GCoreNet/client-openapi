...
type IndividualVALGroupDocumentDocumentApi interface {
	...
	*/
	DeleteIndValGroupDoc(ctx context.Context, groupDocId string) ApiDeleteIndValGroupDocRequest

	// DeleteIndValGroupDocExecute executes the request
	DeleteIndValGroupDocExecute(r ApiDeleteIndValGroupDocRequest) (*http.Response, error)
	...
	*/
	ModifyIndValGroupDoc(ctx context.Context, groupDocId string) ApiModifyIndValGroupDocRequest

	// ModifyIndValGroupDocExecute executes the request
	//  @return VALGroupDocument
	ModifyIndValGroupDocExecute(r ApiModifyIndValGroupDocRequest) (*VALGroupDocument, *http.Response, error)
	...
	*/
	RetrieveIndValGroupDoc(ctx context.Context, groupDocId string) ApiRetrieveIndValGroupDocRequest

	// RetrieveIndValGroupDocExecute executes the request
	//  @return VALGroupDocument
	RetrieveIndValGroupDocExecute(r ApiRetrieveIndValGroupDocRequest) (*VALGroupDocument, *http.Response, error)
	...
	*/
	UpdateIndValGroupDoc(ctx context.Context, groupDocId string) ApiUpdateIndValGroupDocRequest

	// UpdateIndValGroupDocExecute executes the request
	//  @return VALGroupDocument
	UpdateIndValGroupDocExecute(r ApiUpdateIndValGroupDocRequest) (*VALGroupDocument, *http.Response, error)
}
...
type ApiDeleteIndValGroupDocRequest struct {
	ctx context.Context
	ApiService IndividualVALGroupDocumentDocumentApi
	groupDocId string
}
...
func (a *IndividualVALGroupDocumentDocumentApiService) DeleteIndValGroupDocExecute(r ApiDeleteIndValGroupDocRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"groupDocId"+"}", url.PathEscape(parameterToString(r.groupDocId, "")), -1)
...
func (a *IndividualVALGroupDocumentDocumentApiService) RetrieveIndValGroupDocExecute(r ApiRetrieveIndValGroupDocRequest) (*VALGroupDocument, *http.Response, error) {
	...
	if r.groupMembers != nil {
		localVarQueryParams.Add("group-members", parameterToString(*r.groupMembers, ""))
	}
	if r.groupConfiguration != nil {
		localVarQueryParams.Add("group-configuration", parameterToString(*r.groupConfiguration, ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
