...
type IndividualAppliedBDTPolicySubscriptionApi interface {
	...
	*/
	...
	PartialUpdateAnSubscriptionExecute(r ApiPartialUpdateAnSubscriptionRequest) (*AppliedBdtPolicy, *http.Response, error)
	...
	*/
	...
	//  @return AppliedBdtPolicy
	ReadAnSubscriptionExecute(r ApiReadAnSubscriptionRequest) (*AppliedBdtPolicy, *http.Response, error)
}
...
type ApiDeleteAnSubscriptionRequest struct {
	ctx context.Context
	ApiService IndividualAppliedBDTPolicySubscriptionApi
	afId string
