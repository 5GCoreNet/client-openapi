...
type ApplicationAMContextsApi interface {
	...
	*/
	PostAppAmContexts(ctx context.Context, afId string) ApiPostAppAmContextsRequest

	// PostAppAmContextsExecute executes the request
	//  @return AppAmContextExpRespData
	PostAppAmContextsExecute(r ApiPostAppAmContextsRequest) (*AppAmContextExpRespData, *http.Response, error)
}
...
type ApiPostAppAmContextsRequest struct {
	ctx context.Context
	ApiService ApplicationAMContextsApi
	afId string
...
func (r ApiPostAppAmContextsRequest) AppAmContextExpData(appAmContextExpData AppAmContextExpData) ApiPostAppAmContextsRequest {
	r.appAmContextExpData = &appAmContextExpData
	return r
}
...
func (a *ApplicationAMContextsApiService) PostAppAmContextsExecute(r ApiPostAppAmContextsRequest) (*AppAmContextExpRespData, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationAMContextsApiService.PostAppAmContexts")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{afId}/app-am-contexts"
	localVarPath = strings.Replace(localVarPath, "{"+"afId"+"}", url.PathEscape(parameterToString(r.afId, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.appAmContextExpData == nil {
		return localVarReturnValue, nil, reportError("appAmContextExpData is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.appAmContextExpData
