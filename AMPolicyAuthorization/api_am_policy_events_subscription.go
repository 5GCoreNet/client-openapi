...
type AMPolicyEventsSubscriptionApi interface {
	...
	*/
	DeleteAmEventsSubsc(ctx context.Context, afId string, appAmContextId string) ApiDeleteAmEventsSubscRequest

	// DeleteAmEventsSubscExecute executes the request
	DeleteAmEventsSubscExecute(r ApiDeleteAmEventsSubscRequest) (*http.Response, error)
	...
	*/
	UpdateAmEventsSubsc(ctx context.Context, afId string, appAmContextId string) ApiUpdateAmEventsSubscRequest

	// UpdateAmEventsSubscExecute executes the request
	//  @return AmEventsSubscRespData
	UpdateAmEventsSubscExecute(r ApiUpdateAmEventsSubscRequest) (*AmEventsSubscRespData, *http.Response, error)
}
...
type ApiDeleteAmEventsSubscRequest struct {
	ctx context.Context
	ApiService AMPolicyEventsSubscriptionApi
	afId string
...
func (a *AMPolicyEventsSubscriptionApiService) DeleteAmEventsSubscExecute(r ApiDeleteAmEventsSubscRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/{afId}/app-am-contexts/{appAmContextId}/events-subscription"
