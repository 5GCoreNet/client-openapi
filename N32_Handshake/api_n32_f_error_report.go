...
type N32FErrorReportApi interface {
	...
	*/
	PostN32fError(ctx context.Context) ApiPostN32fErrorRequest

	// PostN32fErrorExecute executes the request
	PostN32fErrorExecute(r ApiPostN32fErrorRequest) (*http.Response, error)
}
