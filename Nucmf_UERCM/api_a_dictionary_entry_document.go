...
type ADictionaryEntryDocumentApi interface {
	...
	*/
	CreateDictionaryEntry(ctx context.Context) ApiCreateDictionaryEntryRequest

	// CreateDictionaryEntryExecute executes the request
	//  @return DicEntryCreatedData
	CreateDictionaryEntryExecute(r ApiCreateDictionaryEntryRequest) (*DicEntryCreatedData, *http.Response, error)
}
...
type ApiCreateDictionaryEntryRequest struct {
	ctx context.Context
	ApiService ADictionaryEntryDocumentApi
