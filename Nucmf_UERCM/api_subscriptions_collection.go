...
type SubscriptionsCollectionApi interface {
	...
	*/
	...
	CreateIndividualSubcriptionExecute(r ApiCreateIndividualSubcriptionRequest) (*CreatedSubscription, *http.Response, error)
}
...
func (r ApiCreateIndividualSubcriptionRequest) Execute() (*CreatedSubscription, *http.Response, error) {
...
//  @return CreatedSubscription
func (a *SubscriptionsCollectionApiService) CreateIndividualSubcriptionExecute(r ApiCreateIndividualSubcriptionRequest) (*CreatedSubscription, *http.Response, error) {
	var (
