...
type DictionaryEntryStoreApi interface {
	...
	*/
	RetrieveDictionaryEntry(ctx context.Context) ApiRetrieveDictionaryEntryRequest

	// RetrieveDictionaryEntryExecute executes the request
	//  @return RetrieveDictionaryEntry200Response
	RetrieveDictionaryEntryExecute(r ApiRetrieveDictionaryEntryRequest) (*RetrieveDictionaryEntry200Response, *http.Response, error)
}
...
type ApiRetrieveDictionaryEntryRequest struct {
	ctx context.Context
	ApiService DictionaryEntryStoreApi
	ueRadioCapaId *UeRadioCapaId
	racFormat *RacFormat
	supportedFeatures *string
}

// UE Radio Capability ID, either PLMN Assigned or Manufacturer Assigned
...
func (r ApiRetrieveDictionaryEntryRequest) SupportedFeatures(supportedFeatures string) ApiRetrieveDictionaryEntryRequest {
	r.supportedFeatures = &supportedFeatures
	return r
}

func (r ApiRetrieveDictionaryEntryRequest) Execute() (*RetrieveDictionaryEntry200Response, *http.Response, error) {
