...
type DicEntryIdDocumentApi interface {
	...
	*/
	GetDicEntry(ctx context.Context, dicEntryId int32) ApiGetDicEntryRequest

	// GetDicEntryExecute executes the request
	//  @return RetrieveDictionaryEntry200Response
	GetDicEntryExecute(r ApiGetDicEntryRequest) (*RetrieveDictionaryEntry200Response, *http.Response, error)
}
...
type ApiGetDicEntryRequest struct {
	ctx context.Context
	ApiService DicEntryIdDocumentApi
	dicEntryId int32
	racFormat *RacFormat
...
func (a *DicEntryIdDocumentApiService) GetDicEntryExecute(r ApiGetDicEntryRequest) (*RetrieveDictionaryEntry200Response, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"dicEntryId"+"}", url.PathEscape(parameterToString(r.dicEntryId, "")), -1)
