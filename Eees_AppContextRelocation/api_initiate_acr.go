...
type InitiateACRApi interface {
	...
	*/
	...
	InitiateExecute(r ApiInitiateRequest) (*http.Response, error)
}
...
func (a *InitiateACRApiService) InitiateExecute(r ApiInitiateRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InitiateACRApiService.Initiate")
	if err != nil {
	...
	if r.acrInitReq == nil {
		return nil, reportError("acrInitReq is required and must be specified")
	}
