...
type DetermineACRApi interface {
	...
	*/
	Determine(ctx context.Context) ApiDetermineRequest

	// DetermineExecute executes the request
	DetermineExecute(r ApiDetermineRequest) (*http.Response, error)
}
