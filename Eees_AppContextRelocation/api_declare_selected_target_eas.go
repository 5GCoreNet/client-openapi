...
type DeclareSelectedTargetEASApi interface {
	...
	*/
	Declare(ctx context.Context) ApiDeclareRequest

	// DeclareExecute executes the request
	DeclareExecute(r ApiDeclareRequest) (*http.Response, error)
}
...
type ApiDeclareRequest struct {
	ctx context.Context
	ApiService DeclareSelectedTargetEASApi
	acrDecReq *AcrDecReq
}
