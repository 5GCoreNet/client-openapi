...
type QueryUEInfoApi interface {
	...
	@return ApiQueryUeInfoRequest
	*/
	QueryUeInfo(ctx context.Context, supi string) ApiQueryUeInfoRequest

	// QueryUeInfoExecute executes the request
	//  @return UeInfo
	QueryUeInfoExecute(r ApiQueryUeInfoRequest) (*UeInfo, *http.Response, error)
}

// QueryUEInfoApiService QueryUEInfoApi service
type QueryUEInfoApiService service

type ApiQueryUeInfoRequest struct {
	ctx context.Context
	ApiService QueryUEInfoApi
	supi string
	fields *[]string
...
func (r ApiQueryUeInfoRequest) Execute() (*UeInfo, *http.Response, error) {
	return r.ApiService.QueryUeInfoExecute(r)
}
...
func (a *QueryUEInfoApiService) QueryUeInfoExecute(r ApiQueryUeInfoRequest) (*UeInfo, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *UeInfo
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QueryUEInfoApiService.QueryUeInfo")
	if err != nil {
