...
type ProvideUELocationApi interface {
	...
	*/
	ProvideLocationInfo(ctx context.Context, supi string) ApiProvideLocationInfoRequest

	// ProvideLocationInfoExecute executes the request
	//  @return LocationInfoResult
	ProvideLocationInfoExecute(r ApiProvideLocationInfoRequest) (*LocationInfoResult, *http.Response, error)
}
...
type ApiProvideLocationInfoRequest struct {
	ctx context.Context
	ApiService ProvideUELocationApi
	supi string
...
func (a *ProvideUELocationApiService) ProvideLocationInfoExecute(r ApiProvideLocationInfoRequest) (*LocationInfoResult, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *LocationInfoResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProvideUELocationApiService.ProvideLocationInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{supi}/loc-info/provide-loc-info"
	localVarPath = strings.Replace(localVarPath, "{"+"supi"+"}", url.PathEscape(parameterToString(r.supi, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.locationInfoRequest == nil {
		return localVarReturnValue, nil, reportError("locationInfoRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.locationInfoRequest
