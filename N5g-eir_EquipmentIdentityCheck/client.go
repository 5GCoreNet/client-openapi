...
// APIClient manages communication with the 5G-EIR Equipment Identity Check API v1.2.0
...
type APIClient struct {
	...
	EquipmentStatusDocumentApi *EquipmentStatusDocumentApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.EquipmentStatusDocumentApi = (*EquipmentStatusDocumentApiService)(&c.common)
