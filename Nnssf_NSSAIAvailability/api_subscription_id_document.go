...
type SubscriptionIDDocumentApi interface {
	...
	*/
	NSSAIAvailabilitySubModifyPatch(ctx context.Context, subscriptionId string) ApiNSSAIAvailabilitySubModifyPatchRequest

	// NSSAIAvailabilitySubModifyPatchExecute executes the request
	//  @return NssfEventSubscriptionCreatedData
	NSSAIAvailabilitySubModifyPatchExecute(r ApiNSSAIAvailabilitySubModifyPatchRequest) (*NssfEventSubscriptionCreatedData, *http.Response, error)
	...
	*/
	NSSAIAvailabilityUnsubscribe(ctx context.Context, subscriptionId string) ApiNSSAIAvailabilityUnsubscribeRequest

	// NSSAIAvailabilityUnsubscribeExecute executes the request
	NSSAIAvailabilityUnsubscribeExecute(r ApiNSSAIAvailabilityUnsubscribeRequest) (*http.Response, error)
}
