...
type NSSAIAvailabilityStoreApi interface {
	...
	*/
	NSSAIAvailabilityOptions(ctx context.Context) ApiNSSAIAvailabilityOptionsRequest

	// NSSAIAvailabilityOptionsExecute executes the request
	NSSAIAvailabilityOptionsExecute(r ApiNSSAIAvailabilityOptionsRequest) (*http.Response, error)
}
...
type ApiNSSAIAvailabilityOptionsRequest struct {
	ctx context.Context
	ApiService NSSAIAvailabilityStoreApi
}
