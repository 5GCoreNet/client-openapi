...
type NFInstanceIDDocumentApi interface {
	...
	*/
	NSSAIAvailabilityDelete(ctx context.Context, nfId string) ApiNSSAIAvailabilityDeleteRequest

	// NSSAIAvailabilityDeleteExecute executes the request
	NSSAIAvailabilityDeleteExecute(r ApiNSSAIAvailabilityDeleteRequest) (*http.Response, error)
	...
	*/
	NSSAIAvailabilityPatch(ctx context.Context, nfId string) ApiNSSAIAvailabilityPatchRequest

	// NSSAIAvailabilityPatchExecute executes the request
	//  @return AuthorizedNssaiAvailabilityInfo
	NSSAIAvailabilityPatchExecute(r ApiNSSAIAvailabilityPatchRequest) (*AuthorizedNssaiAvailabilityInfo, *http.Response, error)
	...
	*/
	NSSAIAvailabilityPut(ctx context.Context, nfId string) ApiNSSAIAvailabilityPutRequest

	// NSSAIAvailabilityPutExecute executes the request
	//  @return AuthorizedNssaiAvailabilityInfo
	NSSAIAvailabilityPutExecute(r ApiNSSAIAvailabilityPutRequest) (*AuthorizedNssaiAvailabilityInfo, *http.Response, error)
}
