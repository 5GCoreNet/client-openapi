...
type SubscriptionsCollectionApi interface {
	...
	*/
	NSSAIAvailabilityPost(ctx context.Context) ApiNSSAIAvailabilityPostRequest

	// NSSAIAvailabilityPostExecute executes the request
	//  @return NssfEventSubscriptionCreatedData
	NSSAIAvailabilityPostExecute(r ApiNSSAIAvailabilityPostRequest) (*NssfEventSubscriptionCreatedData, *http.Response, error)
}
