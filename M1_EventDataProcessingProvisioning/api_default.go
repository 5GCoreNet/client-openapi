...
type DefaultApi interface {
	...
	*/
	CreateEventDataProcessingConfiguration(ctx context.Context, provisioningSessionId string) ApiCreateEventDataProcessingConfigurationRequest

	// CreateEventDataProcessingConfigurationExecute executes the request
	CreateEventDataProcessingConfigurationExecute(r ApiCreateEventDataProcessingConfigurationRequest) (*http.Response, error)
	...
	*/
	DestroyEventDataProcessingConfiguration(ctx context.Context, provisioningSessionId string, eventDataProcessingConfigurationId string) ApiDestroyEventDataProcessingConfigurationRequest

	// DestroyEventDataProcessingConfigurationExecute executes the request
	DestroyEventDataProcessingConfigurationExecute(r ApiDestroyEventDataProcessingConfigurationRequest) (*http.Response, error)
	...
	*/
	PatchEventDataProcessingConfiguration(ctx context.Context, provisioningSessionId string, eventDataProcessingConfigurationId string) ApiPatchEventDataProcessingConfigurationRequest

	// PatchEventDataProcessingConfigurationExecute executes the request
	//  @return EventDataProcessingConfiguration
	PatchEventDataProcessingConfigurationExecute(r ApiPatchEventDataProcessingConfigurationRequest) (*EventDataProcessingConfiguration, *http.Response, error)
	...
	*/
	RetrieveEventDataProcessingConfiguration(ctx context.Context, provisioningSessionId string, eventDataProcessingConfigurationId string) ApiRetrieveEventDataProcessingConfigurationRequest

	// RetrieveEventDataProcessingConfigurationExecute executes the request
	//  @return EventDataProcessingConfiguration
	RetrieveEventDataProcessingConfigurationExecute(r ApiRetrieveEventDataProcessingConfigurationRequest) (*EventDataProcessingConfiguration, *http.Response, error)
	...
	*/
	UpdateEventDataProcessingConfiguration(ctx context.Context, provisioningSessionId string, eventDataProcessingConfigurationId string) ApiUpdateEventDataProcessingConfigurationRequest

	// UpdateEventDataProcessingConfigurationExecute executes the request
	UpdateEventDataProcessingConfigurationExecute(r ApiUpdateEventDataProcessingConfigurationRequest) (*http.Response, error)
}
...
func (a *DefaultApiService) DestroyEventDataProcessingConfigurationExecute(r ApiDestroyEventDataProcessingConfigurationRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"provisioningSessionId"+"}", url.PathEscape(parameterToString(r.provisioningSessionId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"eventDataProcessingConfigurationId"+"}", url.PathEscape(parameterToString(r.eventDataProcessingConfigurationId, "")), -1)
