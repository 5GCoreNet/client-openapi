# Go API client for M1_EventDataProcessingProvisioning
...
```golang
import M1_EventDataProcessingProvisioning "//"
```
...
```golang
ctx := context.WithValue(context.Background(), M1_EventDataProcessingProvisioning.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), M1_EventDataProcessingProvisioning.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), M1_EventDataProcessingProvisioning.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), M1_EventDataProcessingProvisioning.ContextOperationServerVariables, map[string]map[string]string{
