...
type DefaultApi interface {
	...
	*/
	CreatePolicyTemplate(ctx context.Context, provisioningSessionId string) ApiCreatePolicyTemplateRequest

	// CreatePolicyTemplateExecute executes the request
	CreatePolicyTemplateExecute(r ApiCreatePolicyTemplateRequest) (*http.Response, error)
	...
	*/
	DestroyPolicyTemplate(ctx context.Context, provisioningSessionId string, policyTemplateId string) ApiDestroyPolicyTemplateRequest

	// DestroyPolicyTemplateExecute executes the request
	DestroyPolicyTemplateExecute(r ApiDestroyPolicyTemplateRequest) (*http.Response, error)
	...
	*/
	PatchPolicyTemplate(ctx context.Context, provisioningSessionId string, policyTemplateId string) ApiPatchPolicyTemplateRequest
	...
	*/
	RetrievePolicyTemplate(ctx context.Context, provisioningSessionId string, policyTemplateId string) ApiRetrievePolicyTemplateRequest

	// RetrievePolicyTemplateExecute executes the request
	//  @return PolicyTemplate
	RetrievePolicyTemplateExecute(r ApiRetrievePolicyTemplateRequest) (*PolicyTemplate, *http.Response, error)
	...
	*/
	UpdatePolicyTemplate(ctx context.Context, provisioningSessionId string, policyTemplateId string) ApiUpdatePolicyTemplateRequest

	// UpdatePolicyTemplateExecute executes the request
	UpdatePolicyTemplateExecute(r ApiUpdatePolicyTemplateRequest) (*http.Response, error)
}
...
func (a *DefaultApiService) DestroyPolicyTemplateExecute(r ApiDestroyPolicyTemplateRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"provisioningSessionId"+"}", url.PathEscape(parameterToString(r.provisioningSessionId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"policyTemplateId"+"}", url.PathEscape(parameterToString(r.policyTemplateId, "")), -1)
