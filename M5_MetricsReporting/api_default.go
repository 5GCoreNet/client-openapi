...
type DefaultApi interface {
	...
	*/
	SubmitMetricsReport(ctx context.Context, provisioningSessionId string, metricsReportingConfigurationId string) ApiSubmitMetricsReportRequest

	// SubmitMetricsReportExecute executes the request
	SubmitMetricsReportExecute(r ApiSubmitMetricsReportRequest) (*http.Response, error)
}
