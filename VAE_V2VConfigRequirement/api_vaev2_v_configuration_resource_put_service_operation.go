...
type VAEV2VConfigurationResourcePutServiceOperationApi interface {
	...
	*/
	UpdateV2VConfiguration(ctx context.Context, configurationId string) ApiUpdateV2VConfigurationRequest

	// UpdateV2VConfigurationExecute executes the request
	//  @return V2vConfigurationData
	UpdateV2VConfigurationExecute(r ApiUpdateV2VConfigurationRequest) (*V2vConfigurationData, *http.Response, error)
}
...
type ApiUpdateV2VConfigurationRequest struct {
	ctx context.Context
	ApiService VAEV2VConfigurationResourcePutServiceOperationApi
