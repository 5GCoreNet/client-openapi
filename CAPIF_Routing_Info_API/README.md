# Go API client for CAPIF_Routing_Info_API
...
```golang
ctx := context.WithValue(context.Background(), CAPIF_Routing_Info_API.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), CAPIF_Routing_Info_API.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), CAPIF_Routing_Info_API.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), CAPIF_Routing_Info_API.ContextOperationServerVariables, map[string]map[string]string{
