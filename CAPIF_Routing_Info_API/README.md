# Go API client for openapi_CAPIF_Routing_Info_API
...
```golang
import openapi_CAPIF_Routing_Info_API "///openapi_CAPIF_Routing_Info_API"
```
...
```golang
ctx := context.WithValue(context.Background(), openapi_CAPIF_Routing_Info_API.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), openapi_CAPIF_Routing_Info_API.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), openapi_CAPIF_Routing_Info_API.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), openapi_CAPIF_Routing_Info_API.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**ServiceApisServiceApiIdGet**](docs/DefaultApi.md#serviceapisserviceapiidget) | **Get** /service-apis/{serviceApiId} | 
