# Go API client for CAPIF_API_Invoker_Management_API
...
```golang
import CAPIF_API_Invoker_Management_API "//"
```
...
```golang
ctx := context.WithValue(context.Background(), CAPIF_API_Invoker_Management_API.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), CAPIF_API_Invoker_Management_API.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), CAPIF_API_Invoker_Management_API.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), CAPIF_API_Invoker_Management_API.ContextOperationServerVariables, map[string]map[string]string{
