...
type CommunicationIndicator struct {
	CommunicationIndicatorAnyOf *CommunicationIndicatorAnyOf
	string *string
}
...
func (dst *CommunicationIndicator) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into CommunicationIndicatorAnyOf
	err = json.Unmarshal(data, &dst.CommunicationIndicatorAnyOf);
	if err == nil {
		jsonCommunicationIndicatorAnyOf, _ := json.Marshal(dst.CommunicationIndicatorAnyOf)
		if string(jsonCommunicationIndicatorAnyOf) == "{}" { // empty struct
			dst.CommunicationIndicatorAnyOf = nil
		} else {
			return nil // data stored in dst.CommunicationIndicatorAnyOf, return on the first match
		}
	} else {
		dst.CommunicationIndicatorAnyOf = nil
	}
...
func (src *CommunicationIndicator) MarshalJSON() ([]byte, error) {
	if src.CommunicationIndicatorAnyOf != nil {
		return json.Marshal(&src.CommunicationIndicatorAnyOf)
	}
