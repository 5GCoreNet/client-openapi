...
type IndividualCPSetProvisioningApi interface {
	...
	*/
	DeleteIndCPSetProvisioning(ctx context.Context, scsAsId string, subscriptionId string, setId string) ApiDeleteIndCPSetProvisioningRequest

	// DeleteIndCPSetProvisioningExecute executes the request
	DeleteIndCPSetProvisioningExecute(r ApiDeleteIndCPSetProvisioningRequest) (*http.Response, error)
	...
	*/
	FetchIndCPSetProvisioning(ctx context.Context, scsAsId string, subscriptionId string, setId string) ApiFetchIndCPSetProvisioningRequest

	// FetchIndCPSetProvisioningExecute executes the request
	//  @return CpParameterSet
	FetchIndCPSetProvisioningExecute(r ApiFetchIndCPSetProvisioningRequest) (*CpParameterSet, *http.Response, error)
	...
	*/
	UpdateIndCPSetProvisioning(ctx context.Context, scsAsId string, subscriptionId string, setId string) ApiUpdateIndCPSetProvisioningRequest

	// UpdateIndCPSetProvisioningExecute executes the request
	//  @return CpParameterSet
	UpdateIndCPSetProvisioningExecute(r ApiUpdateIndCPSetProvisioningRequest) (*CpParameterSet, *http.Response, error)
}
...
type ApiDeleteIndCPSetProvisioningRequest struct {
	ctx context.Context
	ApiService IndividualCPSetProvisioningApi
	scsAsId string
...
func (a *IndividualCPSetProvisioningApiService) DeleteIndCPSetProvisioningExecute(r ApiDeleteIndCPSetProvisioningRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"setId"+"}", url.PathEscape(parameterToString(r.setId, "")), -1)
