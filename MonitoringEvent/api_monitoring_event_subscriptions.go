...
type MonitoringEventSubscriptionsApi interface {
	...
	*/
	CreateMonitoringEventSubscription(ctx context.Context, scsAsId string) ApiCreateMonitoringEventSubscriptionRequest

	// CreateMonitoringEventSubscriptionExecute executes the request
	//  @return CreateMonitoringEventSubscription200Response
	CreateMonitoringEventSubscriptionExecute(r ApiCreateMonitoringEventSubscriptionRequest) (*CreateMonitoringEventSubscription200Response, *http.Response, error)
	...
	*/
	FetchAllMonitoringEventSubscriptions(ctx context.Context, scsAsId string) ApiFetchAllMonitoringEventSubscriptionsRequest

	// FetchAllMonitoringEventSubscriptionsExecute executes the request
	//  @return []MonitoringEventSubscription
	FetchAllMonitoringEventSubscriptionsExecute(r ApiFetchAllMonitoringEventSubscriptionsRequest) ([]MonitoringEventSubscription, *http.Response, error)
}
...
type ApiCreateMonitoringEventSubscriptionRequest struct {
	ctx context.Context
	ApiService MonitoringEventSubscriptionsApi
	scsAsId string
...
func (a *MonitoringEventSubscriptionsApiService) FetchAllMonitoringEventSubscriptionsExecute(r ApiFetchAllMonitoringEventSubscriptionsRequest) ([]MonitoringEventSubscription, *http.Response, error) {
	...
	if r.ipAddrs != nil {
		localVarQueryParams.Add("ip-addrs", parameterToString(*r.ipAddrs, "csv"))
	}
	if r.ipDomain != nil {
	...
	if r.macAddrs != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("mac-addrs", parameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("mac-addrs", parameterToString(t, "multi"))
		}
	}
	// to determine the Content-Type header
