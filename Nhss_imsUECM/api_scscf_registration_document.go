...
type SCSCFRegistrationDocumentApi interface {
	...
	*/
	SCSCFRegistration(ctx context.Context, imsUeId string) ApiSCSCFRegistrationRequest

	// SCSCFRegistrationExecute executes the request
	//  @return ScscfRegistration
	SCSCFRegistrationExecute(r ApiSCSCFRegistrationRequest) (*ScscfRegistration, *http.Response, error)
}
...
type ApiSCSCFRegistrationRequest struct {
	ctx context.Context
	ApiService SCSCFRegistrationDocumentApi
	imsUeId string
