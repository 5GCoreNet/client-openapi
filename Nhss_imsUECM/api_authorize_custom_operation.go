...
type AuthorizeCustomOperationApi interface {
	...
	*/
	Authorize(ctx context.Context, impu string) ApiAuthorizeRequest

	// AuthorizeExecute executes the request
	//  @return AuthorizationResponse
	AuthorizeExecute(r ApiAuthorizeRequest) (*AuthorizationResponse, *http.Response, error)
}
...
type ApiAuthorizeRequest struct {
	ctx context.Context
	ApiService AuthorizeCustomOperationApi
	impu string
...
func (a *AuthorizeCustomOperationApiService) AuthorizeExecute(r ApiAuthorizeRequest) (*AuthorizationResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthorizeCustomOperationApiService.Authorize")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{impu}/authorize"
