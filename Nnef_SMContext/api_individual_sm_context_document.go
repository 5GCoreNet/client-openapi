...
type IndividualSMContextDocumentApi interface {
	...
	*/
	Delete(ctx context.Context, smContextId string) ApiDeleteRequest

	// DeleteExecute executes the request
	//  @return SmContextReleasedData
	DeleteExecute(r ApiDeleteRequest) (*SmContextReleasedData, *http.Response, error)
	...
	*/
	Deliver(ctx context.Context, smContextId string) ApiDeliverRequest

	// DeliverExecute executes the request
	DeliverExecute(r ApiDeliverRequest) (*http.Response, error)
	...
	*/
	Update(ctx context.Context, smContextId string) ApiUpdateRequest

	// UpdateExecute executes the request
	UpdateExecute(r ApiUpdateRequest) (*http.Response, error)
}
...
type ApiDeleteRequest struct {
	ctx context.Context
	ApiService IndividualSMContextDocumentApi
	smContextId string
...
func (a *IndividualSMContextDocumentApiService) DeleteExecute(r ApiDeleteRequest) (*SmContextReleasedData, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"smContextId"+"}", url.PathEscape(parameterToString(r.smContextId, "")), -1)
