...
type DefaultApi interface {
	...
	*/
	SubscriberIdSubscriptionsPost(ctx context.Context, subscriberId string) ApiSubscriberIdSubscriptionsPostRequest

	// SubscriberIdSubscriptionsPostExecute executes the request
	//  @return EventSubscription
	SubscriberIdSubscriptionsPostExecute(r ApiSubscriberIdSubscriptionsPostRequest) (*EventSubscription, *http.Response, error)
	...
	*/
	SubscriberIdSubscriptionsSubscriptionIdDelete(ctx context.Context, subscriberId string, subscriptionId string) ApiSubscriberIdSubscriptionsSubscriptionIdDeleteRequest

	// SubscriberIdSubscriptionsSubscriptionIdDeleteExecute executes the request
	SubscriberIdSubscriptionsSubscriptionIdDeleteExecute(r ApiSubscriberIdSubscriptionsSubscriptionIdDeleteRequest) (*http.Response, error)
}
...
func (a *DefaultApiService) SubscriberIdSubscriptionsPostExecute(r ApiSubscriberIdSubscriptionsPostRequest) (*EventSubscription, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"subscriberId"+"}", url.PathEscape(parameterToString(r.subscriberId, "")), -1)
