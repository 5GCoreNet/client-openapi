...
type ACREventsSubscriptionCollectionApi interface {
	...
	*/
	...
	// CreateACREventsSubscriptonExecute executes the request
	//  @return ACREventsSubscription
	CreateACREventsSubscriptonExecute(r ApiCreateACREventsSubscriptonRequest) (*ACREventsSubscription, *http.Response, error)
}
...
type ApiCreateACREventsSubscriptonRequest struct {
	ctx context.Context
	ApiService ACREventsSubscriptionCollectionApi
