...
type IndividualSubscriptionDocumentApi interface {
	...
	*/
	ModifySubscription(ctx context.Context, subscriptionId string) ApiModifySubscriptionRequest

	// ModifySubscriptionExecute executes the request
	//  @return AmfUpdatedEventSubscription
	ModifySubscriptionExecute(r ApiModifySubscriptionRequest) (*AmfUpdatedEventSubscription, *http.Response, error)
}
