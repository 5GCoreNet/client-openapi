...
type DefaultApi interface {
	...
	*/
	ConnectionsConnectionIdGet(ctx context.Context, connectionId string) ApiConnectionsConnectionIdGetRequest

	// ConnectionsConnectionIdGetExecute executes the request
	//  @return ConnectionInfoType
	ConnectionsConnectionIdGetExecute(r ApiConnectionsConnectionIdGetRequest) (*ConnectionInfoType, *http.Response, error)
	...
	*/
	ConnectionsConnectionIdStreamsDelete(ctx context.Context, connectionId string) ApiConnectionsConnectionIdStreamsDeleteRequest

	// ConnectionsConnectionIdStreamsDeleteExecute executes the request
	ConnectionsConnectionIdStreamsDeleteExecute(r ApiConnectionsConnectionIdStreamsDeleteRequest) (*http.Response, error)
	...
	*/
	ConnectionsConnectionIdStreamsGet(ctx context.Context, connectionId string) ApiConnectionsConnectionIdStreamsGetRequest

	// ConnectionsConnectionIdStreamsGetExecute executes the request
	//  @return []StreamInfoWithReportersType
	ConnectionsConnectionIdStreamsGetExecute(r ApiConnectionsConnectionIdStreamsGetRequest) ([]StreamInfoWithReportersType, *http.Response, error)
	...
	*/
	ConnectionsConnectionIdStreamsPost(ctx context.Context, connectionId string) ApiConnectionsConnectionIdStreamsPostRequest

	// ConnectionsConnectionIdStreamsPostExecute executes the request
	//  @return []StreamInfoType
	ConnectionsConnectionIdStreamsPostExecute(r ApiConnectionsConnectionIdStreamsPostRequest) ([]StreamInfoType, *http.Response, error)
	...
	*/
	ConnectionsConnectionIdStreamsStreamIdGet(ctx context.Context, connectionId string, streamId string) ApiConnectionsConnectionIdStreamsStreamIdGetRequest

	// ConnectionsConnectionIdStreamsStreamIdGetExecute executes the request
	//  @return StreamInfoWithReportersType
	ConnectionsConnectionIdStreamsStreamIdGetExecute(r ApiConnectionsConnectionIdStreamsStreamIdGetRequest) (*StreamInfoWithReportersType, *http.Response, error)
	...
	*/
	ConnectionsGet(ctx context.Context) ApiConnectionsGetRequest

	// ConnectionsGetExecute executes the request
	//  @return []ConnectionInfoType
	ConnectionsGetExecute(r ApiConnectionsGetRequest) ([]ConnectionInfoType, *http.Response, error)
	...
	*/
	ConnectionsPost(ctx context.Context) ApiConnectionsPostRequest

	// ConnectionsPostExecute executes the request
	ConnectionsPostExecute(r ApiConnectionsPostRequest) (*http.Response, error)
}
...
func (a *DefaultApiService) ConnectionsConnectionIdGetExecute(r ApiConnectionsConnectionIdGetRequest) (*ConnectionInfoType, *http.Response, error) {
	...
	if r.connection != nil {
		localVarHeaderParams["Connection"] = parameterToString(*r.connection, "")
	}
	if r.secWebSocketExtensions != nil {
		localVarHeaderParams["Sec-WebSocket-Extensions"] = parameterToString(*r.secWebSocketExtensions, "")
	}
	if r.secWebSocketKey != nil {
		localVarHeaderParams["Sec-WebSocket-Key"] = parameterToString(*r.secWebSocketKey, "")
	}
	if r.secWebSocketProtocol != nil {
		localVarHeaderParams["Sec-WebSocket-Protocol"] = parameterToString(*r.secWebSocketProtocol, "")
	}
	if r.secWebSocketVersion != nil {
		localVarHeaderParams["Sec-WebSocket-Version"] = parameterToString(*r.secWebSocketVersion, "")
	}
...
func (a *DefaultApiService) ConnectionsConnectionIdStreamsDeleteExecute(r ApiConnectionsConnectionIdStreamsDeleteRequest) (*http.Response, error) {
...

	{
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("streamIds", parameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("streamIds", parameterToString(t, "multi"))
		}
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *DefaultApiService) ConnectionsGetExecute(r ApiConnectionsGetRequest) ([]ConnectionInfoType, *http.Response, error) {
	...
	if r.connectionIdList != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("connectionIdList", parameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("connectionIdList", parameterToString(t, "multi"))
		}
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
