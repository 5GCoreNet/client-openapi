...
```golang
ctx := context.WithValue(context.Background(), Nhss_SDM.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), Nhss_SDM.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), Nhss_SDM.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), Nhss_SDM.ContextOperationServerVariables, map[string]map[string]string{
