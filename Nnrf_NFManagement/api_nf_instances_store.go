...
type NFInstancesStoreApi interface {
	...
	*/
	...
	//  @return UriList
	GetNFInstancesExecute(r ApiGetNFInstancesRequest) (*UriList, *http.Response, error)
	...
	*/
	...
	OptionsNFInstancesExecute(r ApiOptionsNFInstancesRequest) (*OptionsResponse, *http.Response, error)
}
