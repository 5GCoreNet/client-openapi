...
type IndividualPDUSessionHSMFOrSMFApi interface {
	...
	*/
	...
	//  @return ReleasedData
	ReleasePduSessionExecute(r ApiReleasePduSessionRequest) (*ReleasedData, *http.Response, error)
	...
	*/
	...
	RetrievePduSessionExecute(r ApiRetrievePduSessionRequest) (*RetrievedData, *http.Response, error)
