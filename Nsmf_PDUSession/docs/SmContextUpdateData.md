...
**TargetServingNfId** | Pointer to **string** | String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.   | [optional] 
**SmContextStatusUri** | Pointer to **string** | String providing an URI formatted according to RFC 3986. | [optional] 
...
**N9DlForwardingTunnel** | Pointer to [**TunnelInfo**](TunnelInfo.md) |  | [optional] 
**N9InactivityTimer** | Pointer to **int32** | indicating a time in seconds. | [optional] 
