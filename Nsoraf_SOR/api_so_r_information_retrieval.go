...
type SoRInformationRetrievalApi interface {
	...
	*/
	GetSorInformation(ctx context.Context, supi string) ApiGetSorInformationRequest

	// GetSorInformationExecute executes the request
	//  @return SorInformation
	GetSorInformationExecute(r ApiGetSorInformationRequest) (*SorInformation, *http.Response, error)
}
...
type ApiGetSorInformationRequest struct {
	ctx context.Context
	ApiService SoRInformationRetrievalApi
	supi string
	plmnId *PlmnIdNid
