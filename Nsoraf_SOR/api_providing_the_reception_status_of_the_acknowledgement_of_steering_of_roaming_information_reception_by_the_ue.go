...
type ProvidingTheReceptionStatusOfTheAcknowledgementOfSteeringOfRoamingInformationReceptionByTheUEApi interface {
...
type ApiSorAckInfoRequest struct {
	ctx context.Context
	ApiService ProvidingTheReceptionStatusOfTheAcknowledgementOfSteeringOfRoamingInformationReceptionByTheUEApi
	supi string
	sorAckInfo *SorAckInfo
}

func (r ApiSorAckInfoRequest) SorAckInfo(sorAckInfo SorAckInfo) ApiSorAckInfoRequest {
	r.sorAckInfo = &sorAckInfo
	return r
}
...
func (a *ProvidingTheReceptionStatusOfTheAcknowledgementOfSteeringOfRoamingInformationReceptionByTheUEApiService) SorAckInfoExecute(r ApiSorAckInfoRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/{supi}/sor-information/sor-ack"
	...
	if r.sorAckInfo == nil {
		return nil, reportError("sorAckInfo is required and must be specified")
	}
