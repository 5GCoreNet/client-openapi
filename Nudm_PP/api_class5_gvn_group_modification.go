...
type Class5GVNGroupModificationApi interface {
	...
	*/
	Get5GVNGroup(ctx context.Context, extGroupId string) ApiGet5GVNGroupRequest

	// Get5GVNGroupExecute executes the request
	//  @return Model5GVnGroupConfiguration
	Get5GVNGroupExecute(r ApiGet5GVNGroupRequest) (*Model5GVnGroupConfiguration, *http.Response, error)
	...
	*/
	Modify5GVNGroup(ctx context.Context, extGroupId string) ApiModify5GVNGroupRequest

	// Modify5GVNGroupExecute executes the request
	//  @return PatchResult
	Modify5GVNGroupExecute(r ApiModify5GVNGroupRequest) (*PatchResult, *http.Response, error)
}
...
type ApiGet5GVNGroupRequest struct {
	ctx context.Context
	ApiService Class5GVNGroupModificationApi
	extGroupId string
}
...
func (a *Class5GVNGroupModificationApiService) Get5GVNGroupExecute(r ApiGet5GVNGroupRequest) (*Model5GVnGroupConfiguration, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"extGroupId"+"}", url.PathEscape(parameterToString(r.extGroupId, "")), -1)
