...
type Class5GVNGroupCreationApi interface {
	...
	*/
	Create5GVNGroup(ctx context.Context, extGroupId string) ApiCreate5GVNGroupRequest

	// Create5GVNGroupExecute executes the request
	Create5GVNGroupExecute(r ApiCreate5GVNGroupRequest) (*http.Response, error)
}
...
type ApiCreate5GVNGroupRequest struct {
	ctx context.Context
	ApiService Class5GVNGroupCreationApi
	extGroupId string
