...
type SubscriptionDataUpdateApi interface {
	...
	*/
	Update(ctx context.Context, ueId UpdateUeIdParameter) ApiUpdateRequest

	// UpdateExecute executes the request
	//  @return PatchResult
	UpdateExecute(r ApiUpdateRequest) (*PatchResult, *http.Response, error)
}
...
type ApiUpdateRequest struct {
	ctx context.Context
	ApiService SubscriptionDataUpdateApi
