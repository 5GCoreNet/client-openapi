...
type Class5GVNGroupDeletionApi interface {
	...
	*/
	Delete5GVNGroup(ctx context.Context, extGroupId string) ApiDelete5GVNGroupRequest
...
type ApiDelete5GVNGroupRequest struct {
	ctx context.Context
	ApiService Class5GVNGroupDeletionApi
	extGroupId string
