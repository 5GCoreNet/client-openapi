...
type SendMTSMSMessageAndTheDeliveryReportApi interface {
	...
	*/
	SendSMS(ctx context.Context, gpsi string) ApiSendSMSRequest
...
type ApiSendSMSRequest struct {
	ctx context.Context
	ApiService SendMTSMSMessageAndTheDeliveryReportApi
	gpsi string
	jsonData *SmsData
