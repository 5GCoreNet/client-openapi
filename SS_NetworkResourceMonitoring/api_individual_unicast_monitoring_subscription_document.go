...
type IndividualUnicastMonitoringSubscriptionDocumentApi interface {
	...
	*/
	ReadUnicastMonitoringSubscription(ctx context.Context, subscriptionId string) ApiReadUnicastMonitoringSubscriptionRequest

	// ReadUnicastMonitoringSubscriptionExecute executes the request
	//  @return MonitoringSubscription
	ReadUnicastMonitoringSubscriptionExecute(r ApiReadUnicastMonitoringSubscriptionRequest) (*MonitoringSubscription, *http.Response, error)
	...
	*/
	UnsubscribeUnicastMonitoring(ctx context.Context, subscriptionId string) ApiUnsubscribeUnicastMonitoringRequest

	// UnsubscribeUnicastMonitoringExecute executes the request
	UnsubscribeUnicastMonitoringExecute(r ApiUnsubscribeUnicastMonitoringRequest) (*http.Response, error)
}
...
type ApiReadUnicastMonitoringSubscriptionRequest struct {
	ctx context.Context
	ApiService IndividualUnicastMonitoringSubscriptionDocumentApi
