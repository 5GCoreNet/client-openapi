...
type UnicastMonitoringSubscriptionsCollectionApi interface {
	...
	*/
	SubscribeUnicastMonitoring(ctx context.Context) ApiSubscribeUnicastMonitoringRequest

	// SubscribeUnicastMonitoringExecute executes the request
	//  @return MonitoringReport
	SubscribeUnicastMonitoringExecute(r ApiSubscribeUnicastMonitoringRequest) (*MonitoringReport, *http.Response, error)
}
...
type ApiSubscribeUnicastMonitoringRequest struct {
	ctx context.Context
	ApiService UnicastMonitoringSubscriptionsCollectionApi
