...
type SubscriptionsCollectionApi interface {
	...
	*/
	...
	CreateIndividualSubcriptionExecute(r ApiCreateIndividualSubcriptionRequest) (*EasDeploySubData, *http.Response, error)
}
...
func (a *SubscriptionsCollectionApiService) CreateIndividualSubcriptionExecute(r ApiCreateIndividualSubcriptionRequest) (*EasDeploySubData, *http.Response, error) {
	...
	if r.easDeploySubData == nil {
		return localVarReturnValue, nil, reportError("easDeploySubData is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.easDeploySubData
