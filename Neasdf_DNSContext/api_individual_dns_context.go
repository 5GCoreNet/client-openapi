...
type IndividualDNSContextApi interface {
	...
	*/
	DeleteDnsContext(ctx context.Context, dnsContextId string) ApiDeleteDnsContextRequest

	// DeleteDnsContextExecute executes the request
	DeleteDnsContextExecute(r ApiDeleteDnsContextRequest) (*http.Response, error)
	...
	*/
	ReplaceDnsContext(ctx context.Context, dnsContextId string) ApiReplaceDnsContextRequest

	// ReplaceDnsContextExecute executes the request
	ReplaceDnsContextExecute(r ApiReplaceDnsContextRequest) (*http.Response, error)
	...
	*/
	UpdateDnsContext(ctx context.Context, dnsContextId string) ApiUpdateDnsContextRequest

	// UpdateDnsContextExecute executes the request
	//  @return PatchResult
	UpdateDnsContextExecute(r ApiUpdateDnsContextRequest) (*PatchResult, *http.Response, error)
}
...
type ApiDeleteDnsContextRequest struct {
	ctx context.Context
	ApiService IndividualDNSContextApi
	dnsContextId string
}
...
func (a *IndividualDNSContextApiService) DeleteDnsContextExecute(r ApiDeleteDnsContextRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"dnsContextId"+"}", url.PathEscape(parameterToString(r.dnsContextId, "")), -1)
