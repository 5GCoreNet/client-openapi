...
type DNSContextsCollectionApi interface {

	/*
	CreateDnsContext Create

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCreateDnsContextRequest
	*/
	CreateDnsContext(ctx context.Context) ApiCreateDnsContextRequest

	// CreateDnsContextExecute executes the request
	//  @return DnsContextCreatedData
	CreateDnsContextExecute(r ApiCreateDnsContextRequest) (*DnsContextCreatedData, *http.Response, error)
}

// DNSContextsCollectionApiService DNSContextsCollectionApi service
type DNSContextsCollectionApiService service

type ApiCreateDnsContextRequest struct {
	ctx context.Context
	ApiService DNSContextsCollectionApi
...
func (r ApiCreateDnsContextRequest) Execute() (*DnsContextCreatedData, *http.Response, error) {
	return r.ApiService.CreateDnsContextExecute(r)
}
...
func (a *DNSContextsCollectionApiService) CreateDnsContextExecute(r ApiCreateDnsContextRequest) (*DnsContextCreatedData, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *DnsContextCreatedData
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DNSContextsCollectionApiService.CreateDnsContext")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/dns-contexts"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.dnsContextCreateData == nil {
		return localVarReturnValue, nil, reportError("dnsContextCreateData is required and must be specified")
	}
