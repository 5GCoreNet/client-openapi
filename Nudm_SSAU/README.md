...
```golang
ctx := context.WithValue(context.Background(), Nudm_SSAU.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), Nudm_SSAU.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), Nudm_SSAU.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), Nudm_SSAU.ContextOperationServerVariables, map[string]map[string]string{
