...
type ServiceSpecificAuthorizationRequestApi interface {
	...
	*/
	ServiceSpecificAuthorization(ctx context.Context, ueIdentity string, serviceType ServiceType) ApiServiceSpecificAuthorizationRequest

	// ServiceSpecificAuthorizationExecute executes the request
	//  @return ServiceSpecificAuthorizationData
	ServiceSpecificAuthorizationExecute(r ApiServiceSpecificAuthorizationRequest) (*ServiceSpecificAuthorizationData, *http.Response, error)
}
...
type ApiServiceSpecificAuthorizationRequest struct {
	ctx context.Context
	ApiService ServiceSpecificAuthorizationRequestApi
	ueIdentity string
