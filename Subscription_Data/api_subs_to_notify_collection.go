...
type SubsToNotifyCollectionApi interface {
	...
	*/
	...
	QuerySubsToNotifyExecute(r ApiQuerySubsToNotifyRequest) ([]SubscriptionDataSubscriptions, *http.Response, error)
	...
	*/
	...
	//  @return SubscriptionDataSubscriptions
	SubscriptionDataSubscriptionsExecute(r ApiSubscriptionDataSubscriptionsRequest) (*SubscriptionDataSubscriptions, *http.Response, error)
}
...
func (a *SubsToNotifyCollectionApiService) RemoveMultipleSubscriptionDataSubscriptionsExecute(r ApiRemoveMultipleSubscriptionDataSubscriptionsRequest) (*http.Response, error) {
	...
	if r.nfInstanceId != nil {
		localVarQueryParams.Add("nf-instance-id", parameterToString(*r.nfInstanceId, ""))
	}
	if r.deleteAllNfs != nil {
		localVarQueryParams.Add("delete-all-nfs", parameterToString(*r.deleteAllNfs, ""))
	}
	if r.implicitUnsubscribeIndication != nil {
		localVarQueryParams.Add("implicit-unsubscribe-indication", parameterToString(*r.implicitUnsubscribeIndication, ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
