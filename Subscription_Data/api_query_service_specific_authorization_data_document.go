...
type QueryServiceSpecificAuthorizationDataDocumentApi interface {
	...
	*/
	GetSSAuData(ctx context.Context, ueId string, serviceType ServiceType) ApiGetSSAuDataRequest

	// GetSSAuDataExecute executes the request
	//  @return AuthorizationData
	GetSSAuDataExecute(r ApiGetSSAuDataRequest) (*AuthorizationData, *http.Response, error)
}
...
func (a *QueryServiceSpecificAuthorizationDataDocumentApiService) GetSSAuDataExecute(r ApiGetSSAuDataRequest) (*AuthorizationData, *http.Response, error) {
	...
	if r.mtcProviderInformation != nil {
		localVarQueryParams.Add("mtc-provider-information", parameterToString(*r.mtcProviderInformation, ""))
	}
	if r.afId != nil {
