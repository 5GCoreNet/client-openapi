...
type AMF3GPPAccessRegistrationDocumentApi interface {
	...
	*/
	...
	//  @return PatchResult
	AmfContext3gppExecute(r ApiAmfContext3gppRequest) (*PatchResult, *http.Response, error)
	...
	*/
	...
	CreateAmfContext3gppExecute(r ApiCreateAmfContext3gppRequest) (*Amf3GppAccessRegistration, *http.Response, error)
	...
	*/
	...
	//  @return Amf3GppAccessRegistration
	QueryAmfContext3gppExecute(r ApiQueryAmfContext3gppRequest) (*Amf3GppAccessRegistration, *http.Response, error)
}
