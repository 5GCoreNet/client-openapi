...
type QueryAMFSubscriptionInfoDocumentApi interface {
	...
	*/
	...
	GetAmfGroupSubscriptionsExecute(r ApiGetAmfGroupSubscriptionsRequest) ([]AmfSubscriptionInfo, *http.Response, error)
	...
	*/
	...
	//  @return []AmfSubscriptionInfo
	GetAmfSubscriptionInfoExecute(r ApiGetAmfSubscriptionInfoRequest) ([]AmfSubscriptionInfo, *http.Response, error)
}
