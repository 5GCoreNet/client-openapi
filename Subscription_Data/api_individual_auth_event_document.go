...
type IndividualAuthEventDocumentApi interface {
	...
	*/
	...
	//  @return AuthEvent
	QueryIndividualAuthenticationStatusExecute(r ApiQueryIndividualAuthenticationStatusRequest) (*AuthEvent, *http.Response, error)
}
...
func (a *IndividualAuthEventDocumentApiService) DeleteIndividualAuthenticationStatusExecute(r ApiDeleteIndividualAuthenticationStatusRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"servingNetworkName"+"}", url.PathEscape(parameterToString(r.servingNetworkName, "")), -1)
