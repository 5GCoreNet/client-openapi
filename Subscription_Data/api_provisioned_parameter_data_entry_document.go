...
type ProvisionedParameterDataEntryDocumentApi interface {
	...
	*/
	CreatePPDataEntry(ctx context.Context, ueId GetPPDataEntryUeIdParameter, afInstanceId string) ApiCreatePPDataEntryRequest

	// CreatePPDataEntryExecute executes the request
	//  @return PpDataEntry
	CreatePPDataEntryExecute(r ApiCreatePPDataEntryRequest) (*PpDataEntry, *http.Response, error)
	...
	*/
	DeletePPDataEntry(ctx context.Context, ueId GetPPDataEntryUeIdParameter, afInstanceId string) ApiDeletePPDataEntryRequest

	// DeletePPDataEntryExecute executes the request
	DeletePPDataEntryExecute(r ApiDeletePPDataEntryRequest) (*http.Response, error)
	...
	*/
	GetPPDataEntry(ctx context.Context, ueId GetPPDataEntryUeIdParameter, afInstanceId string) ApiGetPPDataEntryRequest

	// GetPPDataEntryExecute executes the request
	//  @return PpDataEntry
	GetPPDataEntryExecute(r ApiGetPPDataEntryRequest) (*PpDataEntry, *http.Response, error)
}
...
type ApiCreatePPDataEntryRequest struct {
	ctx context.Context
	ApiService ProvisionedParameterDataEntryDocumentApi
...
func (a *ProvisionedParameterDataEntryDocumentApiService) CreatePPDataEntryExecute(r ApiCreatePPDataEntryRequest) (*PpDataEntry, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProvisionedParameterDataEntryDocumentApiService.CreatePPDataEntry")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/subscription-data/{ueId}/pp-data-store/{afInstanceId}"
	localVarPath = strings.Replace(localVarPath, "{"+"ueId"+"}", url.PathEscape(parameterToString(r.ueId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"afInstanceId"+"}", url.PathEscape(parameterToString(r.afInstanceId, "")), -1)
...
func (a *ProvisionedParameterDataEntryDocumentApiService) DeletePPDataEntryExecute(r ApiDeletePPDataEntryRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProvisionedParameterDataEntryDocumentApiService.DeletePPDataEntry")
	if err != nil {
...
func (a *ProvisionedParameterDataEntryDocumentApiService) GetPPDataEntryExecute(r ApiGetPPDataEntryRequest) (*PpDataEntry, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProvisionedParameterDataEntryDocumentApiService.GetPPDataEntry")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
