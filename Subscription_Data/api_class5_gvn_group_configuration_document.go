...
type Class5GVnGroupConfigurationDocumentApi interface {
	...
	*/
	...
	Create5GVnGroupExecute(r ApiCreate5GVnGroupRequest) (*Model5GVnGroupConfiguration, *http.Response, error)
}
...
type ApiCreate5GVnGroupRequest struct {
	ctx context.Context
	ApiService Class5GVnGroupConfigurationDocumentApi
