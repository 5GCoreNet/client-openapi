...
type SDMSubscriptionsCollectionApi interface {
	...
	*/
	...
	CreateSdmSubscriptionsExecute(r ApiCreateSdmSubscriptionsRequest) (*SdmSubscription, *http.Response, error)
	...
	*/
	...
	//  @return []SdmSubscription
	QuerysdmsubscriptionsExecute(r ApiQuerysdmsubscriptionsRequest) ([]SdmSubscription, *http.Response, error)
}
