...
type ParameterProvisionProfileDataFor5GVNGroupDocumentApi interface {
	...
	*/
	...
	Query5GVNGroupPPDataExecute(r ApiQuery5GVNGroupPPDataRequest) (*Pp5gVnGroupProfileData, *http.Response, error)
}
...
func (a *ParameterProvisionProfileDataFor5GVNGroupDocumentApiService) Query5GVNGroupPPDataExecute(r ApiQuery5GVNGroupPPDataRequest) (*Pp5gVnGroupProfileData, *http.Response, error) {
	...
	if r.extGroupIds != nil {
		localVarQueryParams.Add("ext-group-ids", parameterToString(*r.extGroupIds, "csv"))
	}
