...
type SMSF3GPPRegistrationDocumentApi interface {
	...
	*/
	...
	CreateSmsfContext3gppExecute(r ApiCreateSmsfContext3gppRequest) (*SmsfRegistration, *http.Response, error)
	...
	*/
	...
	//  @return SmsfRegistration
	QuerySmsfContext3gppExecute(r ApiQuerySmsfContext3gppRequest) (*SmsfRegistration, *http.Response, error)
}
