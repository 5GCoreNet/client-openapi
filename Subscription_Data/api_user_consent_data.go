...
type UserConsentDataApi interface {
	...
	*/
	...
	QueryUserConsentDataExecute(r ApiQueryUserConsentDataRequest) (*UcSubscriptionData, *http.Response, error)
}
...
func (a *UserConsentDataApiService) QueryUserConsentDataExecute(r ApiQueryUserConsentDataRequest) (*UcSubscriptionData, *http.Response, error) {
	...
	if r.ucPurpose != nil {
		localVarQueryParams.Add("ucPurpose", parameterToString(*r.ucPurpose, ""))
	}
