...
type OperationMode struct {
	OperationModeAnyOf *OperationModeAnyOf
	string *string
}
...
func (dst *OperationMode) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into OperationModeAnyOf
	err = json.Unmarshal(data, &dst.OperationModeAnyOf);
	if err == nil {
		jsonOperationModeAnyOf, _ := json.Marshal(dst.OperationModeAnyOf)
		if string(jsonOperationModeAnyOf) == "{}" { // empty struct
			dst.OperationModeAnyOf = nil
		} else {
			return nil // data stored in dst.OperationModeAnyOf, return on the first match
		}
	} else {
		dst.OperationModeAnyOf = nil
	}
...
func (src *OperationMode) MarshalJSON() ([]byte, error) {
	if src.OperationModeAnyOf != nil {
		return json.Marshal(&src.OperationModeAnyOf)
	}
