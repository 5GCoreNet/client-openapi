...
type ContextDataDocumentApi interface {
	...
	*/
	...
	QueryContextDataExecute(r ApiQueryContextDataRequest) (*ContextDataSets, *http.Response, error)
}
...
func (a *ContextDataDocumentApiService) QueryContextDataExecute(r ApiQueryContextDataRequest) (*ContextDataSets, *http.Response, error) {
	...
	localVarQueryParams.Add("context-dataset-names", parameterToString(*r.contextDatasetNames, "csv"))
