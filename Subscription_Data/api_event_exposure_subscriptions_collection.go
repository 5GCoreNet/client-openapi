...
type EventExposureSubscriptionsCollectionApi interface {
	...
	*/
	...
	CreateEeSubscriptionsExecute(r ApiCreateEeSubscriptionsRequest) (*EeSubscription, *http.Response, error)
	...
	*/
	...
	QueryeesubscriptionsExecute(r ApiQueryeesubscriptionsRequest) ([]EeSubscriptionExt, *http.Response, error)
}
...
func (a *EventExposureSubscriptionsCollectionApiService) QueryeesubscriptionsExecute(r ApiQueryeesubscriptionsRequest) ([]EeSubscriptionExt, *http.Response, error) {
	...
	if r.eventTypes != nil {
		localVarQueryParams.Add("event-types", parameterToString(*r.eventTypes, "csv"))
	}
	if r.nfIdentifiers != nil {
		localVarQueryParams.Add("nf-identifiers", parameterToString(*r.nfIdentifiers, "csv"))
	}
	// to determine the Content-Type header
