...
type UESubscribedDataDocumentApi interface {
	...
	*/
	QueryUeSubscribedData(ctx context.Context, ueId string) ApiQueryUeSubscribedDataRequest

	// QueryUeSubscribedDataExecute executes the request
	//  @return UeSubscribedDataSets
	QueryUeSubscribedDataExecute(r ApiQueryUeSubscribedDataRequest) (*UeSubscribedDataSets, *http.Response, error)
}
...
type ApiQueryUeSubscribedDataRequest struct {
	ctx context.Context
	ApiService UESubscribedDataDocumentApi
	ueId string
...
func (a *UESubscribedDataDocumentApiService) QueryUeSubscribedDataExecute(r ApiQueryUeSubscribedDataRequest) (*UeSubscribedDataSets, *http.Response, error) {
	...
	if r.datasetNames != nil {
		localVarQueryParams.Add("dataset-names", parameterToString(*r.datasetNames, "csv"))
	}
	if r.servingPlmn != nil {
		localVarQueryParams.Add("serving-plmn", parameterToString(*r.servingPlmn, ""))
	}
