...
type ServiceParameterSubscriptionsApi interface {
	...
	*/
	CreateAnSubscription(ctx context.Context, afId string) ApiCreateAnSubscriptionRequest

	// CreateAnSubscriptionExecute executes the request
	//  @return ServiceParameterData
	CreateAnSubscriptionExecute(r ApiCreateAnSubscriptionRequest) (*ServiceParameterData, *http.Response, error)
	...
	*/
	...
	//  @return []ServiceParameterData
	ReadAllSubscriptionsExecute(r ApiReadAllSubscriptionsRequest) ([]ServiceParameterData, *http.Response, error)
}
...
type ApiCreateAnSubscriptionRequest struct {
	ctx context.Context
	ApiService ServiceParameterSubscriptionsApi
	afId string
...
func (a *ServiceParameterSubscriptionsApiService) ReadAllSubscriptionsExecute(r ApiReadAllSubscriptionsRequest) ([]ServiceParameterData, *http.Response, error) {
	...
	if r.gpsis != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("gpsis", parameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("gpsis", parameterToString(t, "multi"))
		}
	}
	if r.ipAddrs != nil {
		t := *r.ipAddrs
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("ip-addrs", parameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("ip-addrs", parameterToString(t, "multi"))
		}
	}
	if r.ipDomain != nil {
