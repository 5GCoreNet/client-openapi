...
type IndividualServiceParameterSubscriptionApi interface {
	...
	*/
	...
	FullyUpdateAnSubscriptionExecute(r ApiFullyUpdateAnSubscriptionRequest) (*ServiceParameterData, *http.Response, error)
	...
	*/
	...
	//  @return ServiceParameterData
	PartialUpdateAnSubscriptionExecute(r ApiPartialUpdateAnSubscriptionRequest) (*ServiceParameterData, *http.Response, error)
	...
	*/
	...
	//  @return ServiceParameterData
	ReadAnSubscriptionExecute(r ApiReadAnSubscriptionRequest) (*ServiceParameterData, *http.Response, error)
}
...
type ApiDeleteAnSubscriptionRequest struct {
	ctx context.Context
	ApiService IndividualServiceParameterSubscriptionApi
	afId string
