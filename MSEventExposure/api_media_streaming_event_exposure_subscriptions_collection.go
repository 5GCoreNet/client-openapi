...
type MediaStreamingEventExposureSubscriptionsCollectionApi interface {
	...
	*/
	...
	// CreateMSEventExposureSubscExecute executes the request
	//  @return AfEventExposureSubsc
	CreateMSEventExposureSubscExecute(r ApiCreateMSEventExposureSubscRequest) (*AfEventExposureSubsc, *http.Response, error)
	...
	*/
	RetrieveMSEventExposureSubscs(ctx context.Context) ApiRetrieveMSEventExposureSubscsRequest

	// RetrieveMSEventExposureSubscsExecute executes the request
	//  @return []AfEventExposureSubsc
	RetrieveMSEventExposureSubscsExecute(r ApiRetrieveMSEventExposureSubscsRequest) ([]AfEventExposureSubsc, *http.Response, error)
}
...
type ApiCreateMSEventExposureSubscRequest struct {
	ctx context.Context
	ApiService MediaStreamingEventExposureSubscriptionsCollectionApi
