# Go API client for CAPIF_Publish_Service_API
...
```golang
import CAPIF_Publish_Service_API "//"
```
...
```golang
ctx := context.WithValue(context.Background(), CAPIF_Publish_Service_API.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), CAPIF_Publish_Service_API.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), CAPIF_Publish_Service_API.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), CAPIF_Publish_Service_API.ContextOperationServerVariables, map[string]map[string]string{
