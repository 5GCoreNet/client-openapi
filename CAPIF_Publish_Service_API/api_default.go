...
type DefaultApi interface {
	...
	*/
	ApfIdServiceApisGet(ctx context.Context, apfId string) ApiApfIdServiceApisGetRequest

	// ApfIdServiceApisGetExecute executes the request
	//  @return []ServiceAPIDescription
	ApfIdServiceApisGetExecute(r ApiApfIdServiceApisGetRequest) ([]ServiceAPIDescription, *http.Response, error)
	...
	*/
	ApfIdServiceApisPost(ctx context.Context, apfId string) ApiApfIdServiceApisPostRequest

	// ApfIdServiceApisPostExecute executes the request
	//  @return ServiceAPIDescription
	ApfIdServiceApisPostExecute(r ApiApfIdServiceApisPostRequest) (*ServiceAPIDescription, *http.Response, error)
	...
	*/
	ApfIdServiceApisServiceApiIdDelete(ctx context.Context, serviceApiId string, apfId string) ApiApfIdServiceApisServiceApiIdDeleteRequest

	// ApfIdServiceApisServiceApiIdDeleteExecute executes the request
	ApfIdServiceApisServiceApiIdDeleteExecute(r ApiApfIdServiceApisServiceApiIdDeleteRequest) (*http.Response, error)
	...
	*/
	ApfIdServiceApisServiceApiIdGet(ctx context.Context, serviceApiId string, apfId string) ApiApfIdServiceApisServiceApiIdGetRequest

	// ApfIdServiceApisServiceApiIdGetExecute executes the request
	//  @return ServiceAPIDescription
	ApfIdServiceApisServiceApiIdGetExecute(r ApiApfIdServiceApisServiceApiIdGetRequest) (*ServiceAPIDescription, *http.Response, error)
	...
	*/
	ApfIdServiceApisServiceApiIdPut(ctx context.Context, serviceApiId string, apfId string) ApiApfIdServiceApisServiceApiIdPutRequest

	// ApfIdServiceApisServiceApiIdPutExecute executes the request
	//  @return ServiceAPIDescription
	ApfIdServiceApisServiceApiIdPutExecute(r ApiApfIdServiceApisServiceApiIdPutRequest) (*ServiceAPIDescription, *http.Response, error)
}
...
func (a *DefaultApiService) ApfIdServiceApisGetExecute(r ApiApfIdServiceApisGetRequest) ([]ServiceAPIDescription, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"apfId"+"}", url.PathEscape(parameterToString(r.apfId, "")), -1)
...
func (a *DefaultApiService) ApfIdServiceApisServiceApiIdDeleteExecute(r ApiApfIdServiceApisServiceApiIdDeleteRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"serviceApiId"+"}", url.PathEscape(parameterToString(r.serviceApiId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"apfId"+"}", url.PathEscape(parameterToString(r.apfId, "")), -1)
