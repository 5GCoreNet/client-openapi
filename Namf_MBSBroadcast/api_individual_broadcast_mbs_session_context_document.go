...
type IndividualBroadcastMBSSessionContextDocumentApi interface {
	...
	*/
	ContextDelete(ctx context.Context, mbsContextRef string) ApiContextDeleteRequest

	// ContextDeleteExecute executes the request
	ContextDeleteExecute(r ApiContextDeleteRequest) (*http.Response, error)
	...
	*/
	ContextUpdate(ctx context.Context, mbsContextRef string) ApiContextUpdateRequest

	// ContextUpdateExecute executes the request
	//  @return ContextUpdateRspData
	ContextUpdateExecute(r ApiContextUpdateRequest) (*ContextUpdateRspData, *http.Response, error)
}
...
type ApiContextDeleteRequest struct {
	ctx context.Context
	ApiService IndividualBroadcastMBSSessionContextDocumentApi
...
func (a *IndividualBroadcastMBSSessionContextDocumentApiService) ContextDeleteExecute(r ApiContextDeleteRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"mbsContextRef"+"}", url.PathEscape(parameterToString(r.mbsContextRef, "")), -1)
