...
type BroadcastMBSSessionContextsCollectionCollectionApi interface {
	...
	*/
	ContextCreate(ctx context.Context) ApiContextCreateRequest

	// ContextCreateExecute executes the request
	//  @return ContextCreateRspData
	ContextCreateExecute(r ApiContextCreateRequest) (*ContextCreateRspData, *http.Response, error)
}
...
type ApiContextCreateRequest struct {
	ctx context.Context
	ApiService BroadcastMBSSessionContextsCollectionCollectionApi
