...
type DefaultApi interface {
	...
	*/
	EesProfilesGet(ctx context.Context) ApiEesProfilesGetRequest

	// EesProfilesGetExecute executes the request
	//  @return ECSServProvResp
	EesProfilesGetExecute(r ApiEesProfilesGetRequest) (*ECSServProvResp, *http.Response, error)
}
