...
type DefaultApi interface {
	...
	*/
	RetrieveServiceAccessInformation(ctx context.Context, provisioningSessionId string) ApiRetrieveServiceAccessInformationRequest

	// RetrieveServiceAccessInformationExecute executes the request
	//  @return ServiceAccessInformationResource
	RetrieveServiceAccessInformationExecute(r ApiRetrieveServiceAccessInformationRequest) (*ServiceAccessInformationResource, *http.Response, error)
}
