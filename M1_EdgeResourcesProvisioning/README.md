# Go API client for M1_EdgeResourcesProvisioning
...
```golang
import M1_EdgeResourcesProvisioning "//"
```
...
```golang
ctx := context.WithValue(context.Background(), M1_EdgeResourcesProvisioning.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), M1_EdgeResourcesProvisioning.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), M1_EdgeResourcesProvisioning.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), M1_EdgeResourcesProvisioning.ContextOperationServerVariables, map[string]map[string]string{
