...
type GetAuthDataForFNRGApi interface {
	...
	*/
	...
	//  @return RgAuthCtx
	GetRgAuthDataExecute(r ApiGetRgAuthDataRequest) (*RgAuthCtx, *http.Response, error)
}
...
func (a *GetAuthDataForFNRGApiService) GetRgAuthDataExecute(r ApiGetRgAuthDataRequest) (*RgAuthCtx, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"supiOrSuci"+"}", url.PathEscape(parameterToString(r.supiOrSuci, "")), -1)
	...
	localVarQueryParams.Add("authenticated-ind", parameterToString(*r.authenticatedInd, ""))
