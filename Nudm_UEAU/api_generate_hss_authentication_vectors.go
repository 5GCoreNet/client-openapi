...
type GenerateHSSAuthenticationVectorsApi interface {
	...
	*/
	GenerateAv(ctx context.Context, supi string, hssAuthType HssAuthTypeInUri) ApiGenerateAvRequest

	// GenerateAvExecute executes the request
	//  @return HssAuthenticationInfoResult
	GenerateAvExecute(r ApiGenerateAvRequest) (*HssAuthenticationInfoResult, *http.Response, error)
}
...
func (a *GenerateHSSAuthenticationVectorsApiService) GenerateAvExecute(r ApiGenerateAvRequest) (*HssAuthenticationInfoResult, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"hssAuthType"+"}", url.PathEscape(parameterToString(r.hssAuthType, "")), -1)
