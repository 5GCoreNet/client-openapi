# Go API client for openapi_MoLcsNotify
...
```golang
import openapi_MoLcsNotify "///openapi_MoLcsNotify"
```
...
```golang
ctx := context.WithValue(context.Background(), openapi_MoLcsNotify.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), openapi_MoLcsNotify.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), openapi_MoLcsNotify.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), openapi_MoLcsNotify.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*AFLevelUELocationUpdateNotificationOperationApi* | [**UELocationNotify**](docs/AFLevelUELocationUpdateNotificationOperationApi.md#uelocationnotify) | **Post** / | UE location information update notification
...
## Documentation For Models
 ...
 - [LocUpdateDataReply](docs/LocUpdateDataReply.md)
