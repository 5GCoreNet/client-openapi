...
type IndividualASTIConfigurationApi interface {
	...
	*/
	DeleteAnConfiguration(ctx context.Context, afId string, configId string) ApiDeleteAnConfigurationRequest
	...
	*/
	FullyModifyAnConfiguration(ctx context.Context, afId string, configId string) ApiFullyModifyAnConfigurationRequest

	// FullyModifyAnConfigurationExecute executes the request
	//  @return AccessTimeDistributionData
	FullyModifyAnConfigurationExecute(r ApiFullyModifyAnConfigurationRequest) (*AccessTimeDistributionData, *http.Response, error)
	...
	*/
	ReadAnConfiguration(ctx context.Context, afId string, configId string) ApiReadAnConfigurationRequest

	// ReadAnConfigurationExecute executes the request
	//  @return AccessTimeDistributionData
	ReadAnConfigurationExecute(r ApiReadAnConfigurationRequest) (*AccessTimeDistributionData, *http.Response, error)
}
...
type ApiDeleteAnConfigurationRequest struct {
	ctx context.Context
	ApiService IndividualASTIConfigurationApi
	afId string
	configId string
}
