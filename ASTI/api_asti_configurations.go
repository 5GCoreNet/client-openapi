...
type ASTIConfigurationsApi interface {
	...
	*/
	CreateNewConfiguration(ctx context.Context, afId string) ApiCreateNewConfigurationRequest

	// CreateNewConfigurationExecute executes the request
	//  @return AccessTimeDistributionData
	CreateNewConfigurationExecute(r ApiCreateNewConfigurationRequest) (*AccessTimeDistributionData, *http.Response, error)
	...
	*/
	ReadAllConfigurations(ctx context.Context, afId string) ApiReadAllConfigurationsRequest

	// ReadAllConfigurationsExecute executes the request
	//  @return []AccessTimeDistributionData
	ReadAllConfigurationsExecute(r ApiReadAllConfigurationsRequest) ([]AccessTimeDistributionData, *http.Response, error)
	...
	*/
	RetrieveStatusofConfiguration(ctx context.Context, afId string) ApiRetrieveStatusofConfigurationRequest

	// RetrieveStatusofConfigurationExecute executes the request
	//  @return StatusResponseData
	RetrieveStatusofConfigurationExecute(r ApiRetrieveStatusofConfigurationRequest) (*StatusResponseData, *http.Response, error)
}
...
type ApiCreateNewConfigurationRequest struct {
	ctx context.Context
	ApiService ASTIConfigurationsApi
	afId string
