...
type ParameterUpdateInTheUESMSContextInSMSFApi interface {
	...
	*/
	SMSServiceParameterUpdate(ctx context.Context, supi string) ApiSMSServiceParameterUpdateRequest

	// SMSServiceParameterUpdateExecute executes the request
	//  @return SMSServiceParameterUpdate200Response
	SMSServiceParameterUpdateExecute(r ApiSMSServiceParameterUpdateRequest) (*SMSServiceParameterUpdate200Response, *http.Response, error)
}
...
type ApiSMSServiceParameterUpdateRequest struct {
	ctx context.Context
	ApiService ParameterUpdateInTheUESMSContextInSMSFApi
	supi string
	patchItem *[]PatchItem
