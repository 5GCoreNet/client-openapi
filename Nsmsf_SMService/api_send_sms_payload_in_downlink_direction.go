...
type SendSMSPayloadInDownlinkDirectionApi interface {
	...
	*/
	SendMtSMS(ctx context.Context, supi string) ApiSendMtSMSRequest

	// SendMtSMSExecute executes the request
	//  @return SendMtSMS200Response
	SendMtSMSExecute(r ApiSendMtSMSRequest) (*SendMtSMS200Response, *http.Response, error)
}
...
type ApiSendMtSMSRequest struct {
	ctx context.Context
	ApiService SendSMSPayloadInDownlinkDirectionApi
	supi string
	jsonData *SmsData
