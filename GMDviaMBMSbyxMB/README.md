# Go API client for GMDviaMBMSbyxMB
...
```golang
ctx := context.WithValue(context.Background(), GMDviaMBMSbyxMB.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), GMDviaMBMSbyxMB.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), GMDviaMBMSbyxMB.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), GMDviaMBMSbyxMB.ContextOperationServerVariables, map[string]map[string]string{
