...
type IndividualBaselineDNSPatternApi interface {
	...
	*/
	CreateOrReplaceBaseDnsPattern(ctx context.Context, smfId VarNfId, smfImplementationSegmentPaths string) ApiCreateOrReplaceBaseDnsPatternRequest

	// CreateOrReplaceBaseDnsPatternExecute executes the request
	//  @return BaseDnsPatternCreatedData
	CreateOrReplaceBaseDnsPatternExecute(r ApiCreateOrReplaceBaseDnsPatternRequest) (*BaseDnsPatternCreatedData, *http.Response, error)
	...
	*/
	DeleteBaseDnsPattern(ctx context.Context, smfId VarNfId, smfImplementationSegmentPaths string) ApiDeleteBaseDnsPatternRequest

	// DeleteBaseDnsPatternExecute executes the request
	DeleteBaseDnsPatternExecute(r ApiDeleteBaseDnsPatternRequest) (*http.Response, error)
	...
	*/
	UpdateBaseDNSPattern(ctx context.Context, smfId VarNfId, smfImplementationSegmentPaths string) ApiUpdateBaseDNSPatternRequest

	// UpdateBaseDNSPatternExecute executes the request
	//  @return PatchResult
	UpdateBaseDNSPatternExecute(r ApiUpdateBaseDNSPatternRequest) (*PatchResult, *http.Response, error)
}
...
type ApiCreateOrReplaceBaseDnsPatternRequest struct {
	ctx context.Context
	ApiService IndividualBaselineDNSPatternApi
	smfId VarNfId
...
func (a *IndividualBaselineDNSPatternApiService) CreateOrReplaceBaseDnsPatternExecute(r ApiCreateOrReplaceBaseDnsPatternRequest) (*BaseDnsPatternCreatedData, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"smfId"+"}", url.PathEscape(parameterToString(r.smfId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"smfImplementationSegmentPaths"+"}", url.PathEscape(parameterToString(r.smfImplementationSegmentPaths, "")), -1)
