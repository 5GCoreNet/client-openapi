...
type ApplicationEventSubscriptionCollectionApi interface {
	...
	*/
	PostAfEventExposureSubsc(ctx context.Context) ApiPostAfEventExposureSubscRequest

	// PostAfEventExposureSubscExecute executes the request
	//  @return AfEventExposureSubsc
	PostAfEventExposureSubscExecute(r ApiPostAfEventExposureSubscRequest) (*AfEventExposureSubsc, *http.Response, error)
}
...
type ApiPostAfEventExposureSubscRequest struct {
	ctx context.Context
	ApiService ApplicationEventSubscriptionCollectionApi
