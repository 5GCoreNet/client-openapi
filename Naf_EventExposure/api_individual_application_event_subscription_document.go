...
type IndividualApplicationEventSubscriptionDocumentApi interface {
	...
	*/
	DeleteAfEventExposureSubsc(ctx context.Context, subscriptionId string) ApiDeleteAfEventExposureSubscRequest

	// DeleteAfEventExposureSubscExecute executes the request
	DeleteAfEventExposureSubscExecute(r ApiDeleteAfEventExposureSubscRequest) (*http.Response, error)
	...
	*/
	GetAfEventExposureSubsc(ctx context.Context, subscriptionId string) ApiGetAfEventExposureSubscRequest

	// GetAfEventExposureSubscExecute executes the request
	//  @return AfEventExposureSubsc
	GetAfEventExposureSubscExecute(r ApiGetAfEventExposureSubscRequest) (*AfEventExposureSubsc, *http.Response, error)
	...
	*/
	PutAfEventExposureSubsc(ctx context.Context, subscriptionId string) ApiPutAfEventExposureSubscRequest

	// PutAfEventExposureSubscExecute executes the request
	//  @return AfEventExposureSubsc
	PutAfEventExposureSubscExecute(r ApiPutAfEventExposureSubscRequest) (*AfEventExposureSubsc, *http.Response, error)
}
...
type ApiDeleteAfEventExposureSubscRequest struct {
	ctx context.Context
	ApiService IndividualApplicationEventSubscriptionDocumentApi
