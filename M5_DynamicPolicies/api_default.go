...
type DefaultApi interface {
	...
	*/
	CreateDynamicPolicy(ctx context.Context) ApiCreateDynamicPolicyRequest

	// CreateDynamicPolicyExecute executes the request
	//  @return DynamicPolicy
	CreateDynamicPolicyExecute(r ApiCreateDynamicPolicyRequest) (*DynamicPolicy, *http.Response, error)
	...
	*/
	DestroyDynamicPolicy(ctx context.Context, dynamicPolicyId string) ApiDestroyDynamicPolicyRequest

	// DestroyDynamicPolicyExecute executes the request
	DestroyDynamicPolicyExecute(r ApiDestroyDynamicPolicyRequest) (*http.Response, error)
	...
	*/
	PatchDynamicPolicy(ctx context.Context, dynamicPolicyId string) ApiPatchDynamicPolicyRequest

	// PatchDynamicPolicyExecute executes the request
	//  @return DynamicPolicy
	PatchDynamicPolicyExecute(r ApiPatchDynamicPolicyRequest) (*DynamicPolicy, *http.Response, error)
	...
	*/
	RetrieveDynamicPolicy(ctx context.Context, dynamicPolicyId string) ApiRetrieveDynamicPolicyRequest

	// RetrieveDynamicPolicyExecute executes the request
	//  @return DynamicPolicy
	RetrieveDynamicPolicyExecute(r ApiRetrieveDynamicPolicyRequest) (*DynamicPolicy, *http.Response, error)
	...
	*/
	UpdateDynamicPolicy(ctx context.Context, dynamicPolicyId string) ApiUpdateDynamicPolicyRequest

	// UpdateDynamicPolicyExecute executes the request
	UpdateDynamicPolicyExecute(r ApiUpdateDynamicPolicyRequest) (*http.Response, error)
}
...
func (a *DefaultApiService) DestroyDynamicPolicyExecute(r ApiDestroyDynamicPolicyRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"dynamicPolicyId"+"}", url.PathEscape(parameterToString(r.dynamicPolicyId, "")), -1)
