# Go API client for Eees_ACRManagementEvent
...
```golang
import Eees_ACRManagementEvent "//"
```
...
```golang
ctx := context.WithValue(context.Background(), Eees_ACRManagementEvent.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), Eees_ACRManagementEvent.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), Eees_ACRManagementEvent.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), Eees_ACRManagementEvent.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**SubscriptionsGet**](docs/DefaultApi.md#subscriptionsget) | **Get** /subscriptions | 
