...
type CreateEESubscriptionApi interface {
	...
	*/
	CreateEeSubscription(ctx context.Context, ueIdentity string) ApiCreateEeSubscriptionRequest
...
type ApiCreateEeSubscriptionRequest struct {
	ctx context.Context
	ApiService CreateEESubscriptionApi
	ueIdentity string
