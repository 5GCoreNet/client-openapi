...
type UpdateEESubscriptionApi interface {
	...
	*/
	UpdateEeSubscription(ctx context.Context, ueIdentity string, subscriptionId string) ApiUpdateEeSubscriptionRequest

	// UpdateEeSubscriptionExecute executes the request
	//  @return PatchResult
	UpdateEeSubscriptionExecute(r ApiUpdateEeSubscriptionRequest) (*PatchResult, *http.Response, error)
}
...
type ApiUpdateEeSubscriptionRequest struct {
	ctx context.Context
	ApiService UpdateEESubscriptionApi
	ueIdentity string
