...
type DeleteEESubscriptionApi interface {
	...
	*/
	DeleteEeSubscription(ctx context.Context, ueIdentity string, subscriptionId string) ApiDeleteEeSubscriptionRequest

	// DeleteEeSubscriptionExecute executes the request
	DeleteEeSubscriptionExecute(r ApiDeleteEeSubscriptionRequest) (*http.Response, error)
}
...
type ApiDeleteEeSubscriptionRequest struct {
	ctx context.Context
	ApiService DeleteEESubscriptionApi
	ueIdentity string
