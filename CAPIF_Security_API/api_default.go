...
type DefaultApi interface {
	...
	*/
	SecuritiesSecurityIdTokenPost(ctx context.Context, securityId string) ApiSecuritiesSecurityIdTokenPostRequest

	// SecuritiesSecurityIdTokenPostExecute executes the request
	//  @return AccessTokenRsp
	SecuritiesSecurityIdTokenPostExecute(r ApiSecuritiesSecurityIdTokenPostRequest) (*AccessTokenRsp, *http.Response, error)
	...
	*/
	TrustedInvokersApiInvokerIdDelete(ctx context.Context, apiInvokerId string) ApiTrustedInvokersApiInvokerIdDeleteRequest

	// TrustedInvokersApiInvokerIdDeleteExecute executes the request
	TrustedInvokersApiInvokerIdDeleteExecute(r ApiTrustedInvokersApiInvokerIdDeleteRequest) (*http.Response, error)
	...
	*/
	TrustedInvokersApiInvokerIdDeletePost(ctx context.Context, apiInvokerId string) ApiTrustedInvokersApiInvokerIdDeletePostRequest

	// TrustedInvokersApiInvokerIdDeletePostExecute executes the request
	TrustedInvokersApiInvokerIdDeletePostExecute(r ApiTrustedInvokersApiInvokerIdDeletePostRequest) (*http.Response, error)
	...
	*/
	TrustedInvokersApiInvokerIdGet(ctx context.Context, apiInvokerId string) ApiTrustedInvokersApiInvokerIdGetRequest

	// TrustedInvokersApiInvokerIdGetExecute executes the request
	//  @return ServiceSecurity
	TrustedInvokersApiInvokerIdGetExecute(r ApiTrustedInvokersApiInvokerIdGetRequest) (*ServiceSecurity, *http.Response, error)
	...
	*/
	TrustedInvokersApiInvokerIdPut(ctx context.Context, apiInvokerId string) ApiTrustedInvokersApiInvokerIdPutRequest

	// TrustedInvokersApiInvokerIdPutExecute executes the request
	//  @return ServiceSecurity
	TrustedInvokersApiInvokerIdPutExecute(r ApiTrustedInvokersApiInvokerIdPutRequest) (*ServiceSecurity, *http.Response, error)
	...
	*/
	TrustedInvokersApiInvokerIdUpdatePost(ctx context.Context, apiInvokerId string) ApiTrustedInvokersApiInvokerIdUpdatePostRequest

	// TrustedInvokersApiInvokerIdUpdatePostExecute executes the request
	//  @return ServiceSecurity
	TrustedInvokersApiInvokerIdUpdatePostExecute(r ApiTrustedInvokersApiInvokerIdUpdatePostRequest) (*ServiceSecurity, *http.Response, error)
}
...
func (a *DefaultApiService) SecuritiesSecurityIdTokenPostExecute(r ApiSecuritiesSecurityIdTokenPostRequest) (*AccessTokenRsp, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"securityId"+"}", url.PathEscape(parameterToString(r.securityId, "")), -1)
...
func (a *DefaultApiService) TrustedInvokersApiInvokerIdDeleteExecute(r ApiTrustedInvokersApiInvokerIdDeleteRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"apiInvokerId"+"}", url.PathEscape(parameterToString(r.apiInvokerId, "")), -1)
...
func (a *DefaultApiService) TrustedInvokersApiInvokerIdGetExecute(r ApiTrustedInvokersApiInvokerIdGetRequest) (*ServiceSecurity, *http.Response, error) {
	...
	if r.authenticationInfo != nil {
		localVarQueryParams.Add("authenticationInfo", parameterToString(*r.authenticationInfo, ""))
	}
	if r.authorizationInfo != nil {
		localVarQueryParams.Add("authorizationInfo", parameterToString(*r.authorizationInfo, ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
