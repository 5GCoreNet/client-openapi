...
type MBSUserDataIngestSessionsCollectionApi interface {
	...
	*/
	CreateMBSUserDataIngSession(ctx context.Context) ApiCreateMBSUserDataIngSessionRequest

	// CreateMBSUserDataIngSessionExecute executes the request
	//  @return MBSUserDataIngSession
	CreateMBSUserDataIngSessionExecute(r ApiCreateMBSUserDataIngSessionRequest) (*MBSUserDataIngSession, *http.Response, error)
	...
	*/
	RetrieveMBSUserDataIngSessions(ctx context.Context) ApiRetrieveMBSUserDataIngSessionsRequest

	// RetrieveMBSUserDataIngSessionsExecute executes the request
	//  @return []MBSUserDataIngSession
	RetrieveMBSUserDataIngSessionsExecute(r ApiRetrieveMBSUserDataIngSessionsRequest) ([]MBSUserDataIngSession, *http.Response, error)
}
