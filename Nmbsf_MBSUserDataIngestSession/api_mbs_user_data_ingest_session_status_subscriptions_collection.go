...
type MBSUserDataIngestSessionStatusSubscriptionsCollectionApi interface {
	...
	*/
	CreateMBSUserDataIngStatSubsc(ctx context.Context) ApiCreateMBSUserDataIngStatSubscRequest

	// CreateMBSUserDataIngStatSubscExecute executes the request
	//  @return MBSUserDataIngStatSubsc
	CreateMBSUserDataIngStatSubscExecute(r ApiCreateMBSUserDataIngStatSubscRequest) (*MBSUserDataIngStatSubsc, *http.Response, error)
	...
	*/
	RetrieveMBSUserDataIngStatSubscs(ctx context.Context) ApiRetrieveMBSUserDataIngStatSubscsRequest

	// RetrieveMBSUserDataIngStatSubscsExecute executes the request
	//  @return []MBSUserDataIngStatSubsc
	RetrieveMBSUserDataIngStatSubscsExecute(r ApiRetrieveMBSUserDataIngStatSubscsRequest) ([]MBSUserDataIngStatSubsc, *http.Response, error)
}
...
type ApiCreateMBSUserDataIngStatSubscRequest struct {
	ctx context.Context
	ApiService MBSUserDataIngestSessionStatusSubscriptionsCollectionApi
