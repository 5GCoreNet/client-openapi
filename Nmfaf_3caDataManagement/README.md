# Go API client for Nmfaf_3caDataManagement
...
```golang
import Nmfaf_3caDataManagement "//"
```
...
```golang
ctx := context.WithValue(context.Background(), Nmfaf_3caDataManagement.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), Nmfaf_3caDataManagement.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), Nmfaf_3caDataManagement.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), Nmfaf_3caDataManagement.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*MFAFDataOrAnalyticsResourcesCollectionApi* | [**CreateIndividualSubcription**](docs/MFAFDataOrAnalyticsResourcesCollectionApi.md#createindividualsubcription) | **Post** /mfaf-data-analytics | subscribe to notifications
...
## Documentation For Models
 ...
 - [NmfafDataAnaNotification](docs/NmfafDataAnaNotification.md)
 - [NmfafDataRetrievalNotification](docs/NmfafDataRetrievalNotification.md)
