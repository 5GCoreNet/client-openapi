...
func Interface{}AsNadrfStoredDataSpec(v *interface{}) NadrfStoredDataSpec {
	return NadrfStoredDataSpec{
		Interface{}: v,
	}
}
...
func (dst *NadrfStoredDataSpec) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(NadrfStoredDataSpec)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(NadrfStoredDataSpec)")
	}
}
...
type NullableNadrfStoredDataSpec struct {
	value *NadrfStoredDataSpec
	isSet bool
}

func (v NullableNadrfStoredDataSpec) Get() *NadrfStoredDataSpec {
	return v.value
}

func (v *NullableNadrfStoredDataSpec) Set(val *NadrfStoredDataSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableNadrfStoredDataSpec) IsSet() bool {
	return v.isSet
}
...
func NewNullableNadrfStoredDataSpec(val *NadrfStoredDataSpec) *NullableNadrfStoredDataSpec {
	return &NullableNadrfStoredDataSpec{value: val, isSet: true}
}
