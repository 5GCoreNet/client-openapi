...
```golang
ctx := context.WithValue(context.Background(), Nhss_EE.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), Nhss_EE.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), Nhss_EE.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), Nhss_EE.ContextOperationServerVariables, map[string]map[string]string{
