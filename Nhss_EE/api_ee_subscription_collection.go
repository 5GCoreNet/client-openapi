...
type EESubscriptionCollectionApi interface {

	/*
	CreateEeSubscription Subscribe

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param ueId IMSI of the subscriber or the identity of a group of UEs
	@return ApiCreateEeSubscriptionRequest
	*/
	CreateEeSubscription(ctx context.Context, ueId string) ApiCreateEeSubscriptionRequest

	// CreateEeSubscriptionExecute executes the request
	//  @return CreatedEeSubscription
	CreateEeSubscriptionExecute(r ApiCreateEeSubscriptionRequest) (*CreatedEeSubscription, *http.Response, error)
}
...
type ApiCreateEeSubscriptionRequest struct {
	ctx context.Context
	ApiService EESubscriptionCollectionApi
	ueId string
...
func (a *EESubscriptionCollectionApiService) CreateEeSubscriptionExecute(r ApiCreateEeSubscriptionRequest) (*CreatedEeSubscription, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EESubscriptionCollectionApiService.CreateEeSubscription")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{ueId}/ee-subscriptions"
