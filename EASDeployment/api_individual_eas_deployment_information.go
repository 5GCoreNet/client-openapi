...
type IndividualEASDeploymentInformationApi interface {
	...
	*/
	DeleteAnDeployment(ctx context.Context, afId string, easDeployInfoId string) ApiDeleteAnDeploymentRequest

	// DeleteAnDeploymentExecute executes the request
	DeleteAnDeploymentExecute(r ApiDeleteAnDeploymentRequest) (*http.Response, error)
	...
	*/
	FullyUpdateAnDeployment(ctx context.Context, afId string, easDeployInfoId string) ApiFullyUpdateAnDeploymentRequest

	// FullyUpdateAnDeploymentExecute executes the request
	//  @return EasDeployInfo
	FullyUpdateAnDeploymentExecute(r ApiFullyUpdateAnDeploymentRequest) (*EasDeployInfo, *http.Response, error)
	...
	*/
	...
	// ReadAnDeploymentExecute executes the request
	//  @return EasDeployInfo
	ReadAnDeploymentExecute(r ApiReadAnDeploymentRequest) (*EasDeployInfo, *http.Response, error)
}
...
type ApiDeleteAnDeploymentRequest struct {
	ctx context.Context
	ApiService IndividualEASDeploymentInformationApi
	afId string
...
func (a *IndividualEASDeploymentInformationApiService) DeleteAnDeploymentExecute(r ApiDeleteAnDeploymentRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"easDeployInfoId"+"}", url.PathEscape(parameterToString(r.easDeployInfoId, "")), -1)
