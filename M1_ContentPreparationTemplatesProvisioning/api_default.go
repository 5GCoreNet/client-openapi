...
type DefaultApi interface {
	...
	*/
	CreateContentPreparationTemplate(ctx context.Context, provisioningSessionId string) ApiCreateContentPreparationTemplateRequest

	// CreateContentPreparationTemplateExecute executes the request
	CreateContentPreparationTemplateExecute(r ApiCreateContentPreparationTemplateRequest) (*http.Response, error)
	...
	*/
	DestroyContentPreparationTemplate(ctx context.Context, provisioningSessionId string, contentPreparationTemplateId string) ApiDestroyContentPreparationTemplateRequest

	// DestroyContentPreparationTemplateExecute executes the request
	DestroyContentPreparationTemplateExecute(r ApiDestroyContentPreparationTemplateRequest) (*http.Response, error)
	...
	*/
	PatchContentPreparationTemplate(ctx context.Context, provisioningSessionId string, contentPreparationTemplateId string) ApiPatchContentPreparationTemplateRequest

	// PatchContentPreparationTemplateExecute executes the request
	//  @return string
	PatchContentPreparationTemplateExecute(r ApiPatchContentPreparationTemplateRequest) (string, *http.Response, error)
	...
	*/
	RetrieveContentPreparationTemplate(ctx context.Context, provisioningSessionId string, contentPreparationTemplateId string) ApiRetrieveContentPreparationTemplateRequest

	// RetrieveContentPreparationTemplateExecute executes the request
	//  @return string
	RetrieveContentPreparationTemplateExecute(r ApiRetrieveContentPreparationTemplateRequest) (string, *http.Response, error)
	...
	*/
	UpdateContentPreparationTemplate(ctx context.Context, provisioningSessionId string, contentPreparationTemplateId string) ApiUpdateContentPreparationTemplateRequest

	// UpdateContentPreparationTemplateExecute executes the request
	UpdateContentPreparationTemplateExecute(r ApiUpdateContentPreparationTemplateRequest) (*http.Response, error)
}
...
func (a *DefaultApiService) DestroyContentPreparationTemplateExecute(r ApiDestroyContentPreparationTemplateRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"provisioningSessionId"+"}", url.PathEscape(parameterToString(r.provisioningSessionId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"contentPreparationTemplateId"+"}", url.PathEscape(parameterToString(r.contentPreparationTemplateId, "")), -1)
