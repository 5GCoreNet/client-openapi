...
type IndividualAPIProviderEnrolmentDetailsApi interface {
	...
	*/
	ModifyIndApiProviderEnrolment(ctx context.Context, registrationId string) ApiModifyIndApiProviderEnrolmentRequest

	// ModifyIndApiProviderEnrolmentExecute executes the request
	//  @return APIProviderEnrolmentDetails
	ModifyIndApiProviderEnrolmentExecute(r ApiModifyIndApiProviderEnrolmentRequest) (*APIProviderEnrolmentDetails, *http.Response, error)
}
...
type ApiModifyIndApiProviderEnrolmentRequest struct {
	ctx context.Context
	ApiService IndividualAPIProviderEnrolmentDetailsApi
