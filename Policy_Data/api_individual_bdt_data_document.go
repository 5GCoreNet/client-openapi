...
type IndividualBdtDataDocumentApi interface {
	...
	*/
	...
	//  @return BdtData
	CreateIndividualBdtDataExecute(r ApiCreateIndividualBdtDataRequest) (*BdtData, *http.Response, error)
	...
	*/
	...
	//  @return BdtData
	ReadIndividualBdtDataExecute(r ApiReadIndividualBdtDataRequest) (*BdtData, *http.Response, error)
	...
	*/
	...
	//  @return BdtData
	UpdateIndividualBdtDataExecute(r ApiUpdateIndividualBdtDataRequest) (*BdtData, *http.Response, error)
}
...
func (a *IndividualBdtDataDocumentApiService) CreateIndividualBdtDataExecute(r ApiCreateIndividualBdtDataRequest) (*BdtData, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"bdtReferenceId"+"}", url.PathEscape(parameterToString(r.bdtReferenceId, "")), -1)
