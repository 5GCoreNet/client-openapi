...
type UsageMonitoringInformationDocumentApi interface {
	...
	*/
	...
	//  @return UsageMonData
	CreateUsageMonitoringResourceExecute(r ApiCreateUsageMonitoringResourceRequest) (*UsageMonData, *http.Response, error)
	...
	*/
	...
	//  @return UsageMonData
	ReadUsageMonitoringInformationExecute(r ApiReadUsageMonitoringInformationRequest) (*UsageMonData, *http.Response, error)
}
...
func (a *UsageMonitoringInformationDocumentApiService) CreateUsageMonitoringResourceExecute(r ApiCreateUsageMonitoringResourceRequest) (*UsageMonData, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"usageMonId"+"}", url.PathEscape(parameterToString(r.usageMonId, "")), -1)
