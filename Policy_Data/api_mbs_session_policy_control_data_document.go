...
type MBSSessionPolicyControlDataDocumentApi interface {
	...
	*/
	GetMBSSessPolCtrlData(ctx context.Context, polSessionId MbsSessPolDataId) ApiGetMBSSessPolCtrlDataRequest

	// GetMBSSessPolCtrlDataExecute executes the request
	//  @return MbsSessPolCtrlData
	GetMBSSessPolCtrlDataExecute(r ApiGetMBSSessPolCtrlDataRequest) (*MbsSessPolCtrlData, *http.Response, error)
}
...
type ApiGetMBSSessPolCtrlDataRequest struct {
	ctx context.Context
	ApiService MBSSessionPolicyControlDataDocumentApi
...
func (a *MBSSessionPolicyControlDataDocumentApiService) GetMBSSessPolCtrlDataExecute(r ApiGetMBSSessPolCtrlDataRequest) (*MbsSessPolCtrlData, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"polSessionId"+"}", url.PathEscape(parameterToString(r.polSessionId, "")), -1)
