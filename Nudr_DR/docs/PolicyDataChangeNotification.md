...
**OpSpecDataMap** | Pointer to [**map[string]OperatorSpecificDataContainer**](OperatorSpecificDataContainer.md) | Operator Specific Data resource data, if changed and notification was requested. The key of the map is operator specific data element name and the value is the operator specific data of the UE.  | [optional] 
...
**SlicePolicyData** | Pointer to [**SlicePolicyData**](SlicePolicyData.md) |  | [optional] 
