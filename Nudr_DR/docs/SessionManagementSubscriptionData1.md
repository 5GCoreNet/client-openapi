...
**ExpectedUeBehavioursList** | Pointer to [**map[string]ExpectedUeBehaviourData1**](ExpectedUeBehaviourData1.md) | A map(list of key-value pairs) where Dnn serves as key of ExpectedUeBehaviourData | [optional] 
**SuggestedPacketNumDlList** | Pointer to [**map[string]SuggestedPacketNumDl1**](SuggestedPacketNumDl1.md) | A map(list of key-value pairs) where Dnn serves as key of SuggestedPacketNumDl | [optional] 
