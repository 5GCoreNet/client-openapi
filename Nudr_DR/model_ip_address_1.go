...
func Interface{}AsIpAddress1(v *interface{}) IpAddress1 {
	return IpAddress1{
		Interface{}: v,
	}
}
...
func (dst *IpAddress1) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(IpAddress1)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(IpAddress1)")
	}
}
