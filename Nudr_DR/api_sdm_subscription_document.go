...
type SDMSubscriptionDocumentApi interface {
	...
	*/
	...
	//  @return PatchResult
	ModifysdmSubscriptionExecute(r ApiModifysdmSubscriptionRequest) (*PatchResult, *http.Response, error)
	...
	*/
	...
	QuerysdmSubscriptionExecute(r ApiQuerysdmSubscriptionRequest) (map[string]interface{}, *http.Response, error)
