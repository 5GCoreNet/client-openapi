...
type EventExposureGroupSubscriptionDocumentApi interface {
	...
	*/
	...
	//  @return PatchResult
	ModifyEeGroupSubscriptionExecute(r ApiModifyEeGroupSubscriptionRequest) (*PatchResult, *http.Response, error)
	...
	*/
	...
	QueryEeGroupSubscriptionExecute(r ApiQueryEeGroupSubscriptionRequest) (map[string]interface{}, *http.Response, error)
