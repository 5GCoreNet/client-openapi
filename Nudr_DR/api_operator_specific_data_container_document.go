...
type OperatorSpecificDataContainerDocumentApi interface {
	...
	*/
	...
	CreateOperSpecDataExecute(r ApiCreateOperSpecDataRequest) (*map[string]OperatorSpecificDataContainer, *http.Response, error)
	...
	*/
	...
	//  @return PatchResult
	ModifyOperSpecDataExecute(r ApiModifyOperSpecDataRequest) (*PatchResult, *http.Response, error)
	...
	*/
	...
	//  @return map[string]OperatorSpecificDataContainer
	QueryOperSpecDataExecute(r ApiQueryOperSpecDataRequest) (*map[string]OperatorSpecificDataContainer, *http.Response, error)
}
