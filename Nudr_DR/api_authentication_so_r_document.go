...
type AuthenticationSoRDocumentApi interface {
	...
	*/
	...
	//  @return SorData
	QueryAuthSoRExecute(r ApiQueryAuthSoRRequest) (*SorData, *http.Response, error)
	...
	*/
	...
	//  @return PatchResult
	UpdateAuthenticationSoRExecute(r ApiUpdateAuthenticationSoRRequest) (*PatchResult, *http.Response, error)
}
