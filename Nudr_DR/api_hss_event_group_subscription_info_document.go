...
type HSSEventGroupSubscriptionInfoDocumentApi interface {
	...
	*/
	CreateHssGroupSubscriptions(ctx context.Context, externalGroupId string, subsId string) ApiCreateHssGroupSubscriptionsRequest

	// CreateHssGroupSubscriptionsExecute executes the request
	//  @return HssSubscriptionInfo
	CreateHssGroupSubscriptionsExecute(r ApiCreateHssGroupSubscriptionsRequest) (*HssSubscriptionInfo, *http.Response, error)
}
