...
type ProvisionedParameterDataEntriesCollectionApi interface {
	...
	*/
	GetMultiplePPDataEntries(ctx context.Context, ueId GetMultiplePPDataEntriesUeIdParameter) ApiGetMultiplePPDataEntriesRequest

	// GetMultiplePPDataEntriesExecute executes the request
	//  @return PpDataEntryList
	GetMultiplePPDataEntriesExecute(r ApiGetMultiplePPDataEntriesRequest) (*PpDataEntryList, *http.Response, error)
}
