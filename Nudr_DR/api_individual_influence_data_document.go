...
type IndividualInfluenceDataDocumentApi interface {
	...
	*/
	...
	CreateOrReplaceIndividualInfluenceDataExecute(r ApiCreateOrReplaceIndividualInfluenceDataRequest) (*TrafficInfluData, *http.Response, error)
	...
	*/
	...
	//  @return TrafficInfluData
	UpdateIndividualInfluenceDataExecute(r ApiUpdateIndividualInfluenceDataRequest) (*TrafficInfluData, *http.Response, error)
}
...
func (a *IndividualInfluenceDataDocumentApiService) CreateOrReplaceIndividualInfluenceDataExecute(r ApiCreateOrReplaceIndividualInfluenceDataRequest) (*TrafficInfluData, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"influenceId"+"}", url.PathEscape(parameterToString(r.influenceId, "")), -1)
