...
type HSSSDMSubscriptionInfoDocumentApi interface {
	...
	*/
	...
	GetHssSDMSubscriptionInfoExecute(r ApiGetHssSDMSubscriptionInfoRequest) (*SmfSubscriptionInfo, *http.Response, error)
	...
	*/
	...
	//  @return PatchResult
	ModifyHssSDMSubscriptionInfoExecute(r ApiModifyHssSDMSubscriptionInfoRequest) (*PatchResult, *http.Response, error)
