...
type NullableEeSubscription1 struct {
	value *EeSubscription1
	isSet bool
}

func (v NullableEeSubscription1) Get() *EeSubscription1 {
	return v.value
}

func (v *NullableEeSubscription1) Set(val *EeSubscription1) {
	v.value = val
	v.isSet = true
}
...
func NewNullableEeSubscription1(val *EeSubscription1) *NullableEeSubscription1 {
	return &NullableEeSubscription1{value: val, isSet: true}
}
