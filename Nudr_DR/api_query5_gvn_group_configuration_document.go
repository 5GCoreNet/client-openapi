...
type Query5GVnGroupConfigurationDocumentApi interface {
	...
	*/
	...
	Get5GVnGroupConfigurationExecute(r ApiGet5GVnGroupConfigurationRequest) (*Model5GVnGroupConfiguration, *http.Response, error)
}
...
type ApiGet5GVnGroupConfigurationRequest struct {
	ctx context.Context
	ApiService Query5GVnGroupConfigurationDocumentApi
