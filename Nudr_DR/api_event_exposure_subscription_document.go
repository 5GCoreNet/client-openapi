...
type EventExposureSubscriptionDocumentApi interface {
	...
	*/
	...
	//  @return PatchResult
	ModifyEesubscriptionExecute(r ApiModifyEesubscriptionRequest) (*PatchResult, *http.Response, error)
	...
	*/
	...
	QueryeeSubscriptionExecute(r ApiQueryeeSubscriptionRequest) (map[string]interface{}, *http.Response, error)
