...
type PolicyDataForIndividualUeDocumentApi interface {
	...
	*/
	...
	ReadPolicyDataExecute(r ApiReadPolicyDataRequest) (*PolicyDataForIndividualUe, *http.Response, error)
}
...
func (a *PolicyDataForIndividualUeDocumentApiService) ReadPolicyDataExecute(r ApiReadPolicyDataRequest) (*PolicyDataForIndividualUe, *http.Response, error) {
	...
	if r.dataSubsetNames != nil {
		localVarQueryParams.Add("data-subset-names", parameterToString(*r.dataSubsetNames, "csv"))
	}
