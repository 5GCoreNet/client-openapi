...
type ServiceSpecificAuthorizationInfoDocumentApi interface {
	...
	*/
	CreateServiceSpecificAuthorizationInfo(ctx context.Context, ueId string, serviceType ServiceType) ApiCreateServiceSpecificAuthorizationInfoRequest

	// CreateServiceSpecificAuthorizationInfoExecute executes the request
	//  @return ServiceSpecificAuthorizationInfo
	CreateServiceSpecificAuthorizationInfoExecute(r ApiCreateServiceSpecificAuthorizationInfoRequest) (*ServiceSpecificAuthorizationInfo, *http.Response, error)
	...
	*/
	GetServiceSpecificAuthorizationInfo(ctx context.Context, ueId string, serviceType ServiceType) ApiGetServiceSpecificAuthorizationInfoRequest

	// GetServiceSpecificAuthorizationInfoExecute executes the request
	//  @return ServiceSpecificAuthorizationInfo
	GetServiceSpecificAuthorizationInfoExecute(r ApiGetServiceSpecificAuthorizationInfoRequest) (*ServiceSpecificAuthorizationInfo, *http.Response, error)
	...
	*/
	ModifyServiceSpecificAuthorizationInfo(ctx context.Context, ueId string, serviceType ServiceType) ApiModifyServiceSpecificAuthorizationInfoRequest

	// ModifyServiceSpecificAuthorizationInfoExecute executes the request
	//  @return PatchResult
	ModifyServiceSpecificAuthorizationInfoExecute(r ApiModifyServiceSpecificAuthorizationInfoRequest) (*PatchResult, *http.Response, error)
	...
	*/
	RemoveServiceSpecificAuthorizationInfo(ctx context.Context, ueId string, serviceType ServiceType) ApiRemoveServiceSpecificAuthorizationInfoRequest
...
func (a *ServiceSpecificAuthorizationInfoDocumentApiService) CreateServiceSpecificAuthorizationInfoExecute(r ApiCreateServiceSpecificAuthorizationInfoRequest) (*ServiceSpecificAuthorizationInfo, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"serviceType"+"}", url.PathEscape(parameterToString(r.serviceType, "")), -1)
