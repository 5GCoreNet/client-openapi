...
type NullableSmsSubscriptionData1 struct {
	value *SmsSubscriptionData1
	isSet bool
}

func (v NullableSmsSubscriptionData1) Get() *SmsSubscriptionData1 {
	return v.value
}

func (v *NullableSmsSubscriptionData1) Set(val *SmsSubscriptionData1) {
	v.value = val
	v.isSet = true
}

func (v NullableSmsSubscriptionData1) IsSet() bool {
	return v.isSet
}
...
func NewNullableSmsSubscriptionData1(val *SmsSubscriptionData1) *NullableSmsSubscriptionData1 {
	return &NullableSmsSubscriptionData1{value: val, isSet: true}
}
