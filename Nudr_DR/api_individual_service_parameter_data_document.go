...
type IndividualServiceParameterDataDocumentApi interface {
	...
	*/
	...
	CreateOrReplaceServiceParameterDataExecute(r ApiCreateOrReplaceServiceParameterDataRequest) (*ServiceParameterData, *http.Response, error)
	...
	*/
	...
	//  @return ServiceParameterData
	UpdateIndividualServiceParameterDataExecute(r ApiUpdateIndividualServiceParameterDataRequest) (*ServiceParameterData, *http.Response, error)
}
...
func (a *IndividualServiceParameterDataDocumentApiService) CreateOrReplaceServiceParameterDataExecute(r ApiCreateOrReplaceServiceParameterDataRequest) (*ServiceParameterData, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"serviceParamId"+"}", url.PathEscape(parameterToString(r.serviceParamId, "")), -1)
