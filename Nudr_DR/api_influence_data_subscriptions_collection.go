...
type InfluenceDataSubscriptionsCollectionApi interface {
	...
	*/
	...
	CreateIndividualInfluenceDataSubscriptionExecute(r ApiCreateIndividualInfluenceDataSubscriptionRequest) (*TrafficInfluSub, *http.Response, error)
	...
	*/
	...
	//  @return []TrafficInfluSub
	ReadInfluenceDataSubscriptionsExecute(r ApiReadInfluenceDataSubscriptionsRequest) ([]TrafficInfluSub, *http.Response, error)
}
