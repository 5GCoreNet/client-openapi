...
type Class5GVNGroupsStoreApi interface {
	...
	*/
	...
	Query5GVnGroupExecute(r ApiQuery5GVnGroupRequest) (*map[string]Model5GVnGroupConfiguration, *http.Response, error)
}
...
func (a *Class5GVNGroupsStoreApiService) Query5GVnGroupExecute(r ApiQuery5GVnGroupRequest) (*map[string]Model5GVnGroupConfiguration, *http.Response, error) {
	...
	if r.gpsis != nil {
		localVarQueryParams.Add("gpsis", parameterToString(*r.gpsis, "csv"))
	}
