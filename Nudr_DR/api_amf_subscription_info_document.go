...
type AmfSubscriptionInfoDocumentApi interface {
	...
	*/
	...
	//  @return PatchResult
	ModifyAmfGroupSubscriptionsExecute(r ApiModifyAmfGroupSubscriptionsRequest) (*PatchResult, *http.Response, error)
	...
	*/
	...
	//  @return PatchResult
	ModifyAmfSubscriptionInfoExecute(r ApiModifyAmfSubscriptionInfoRequest) (*PatchResult, *http.Response, error)
}
