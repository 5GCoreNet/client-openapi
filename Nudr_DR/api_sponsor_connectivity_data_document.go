...
type SponsorConnectivityDataDocumentApi interface {
	...
	*/
	...
	ReadSponsorConnectivityDataExecute(r ApiReadSponsorConnectivityDataRequest) (*SponsorConnectivityData, *http.Response, error)
}
...
func (a *SponsorConnectivityDataDocumentApiService) ReadSponsorConnectivityDataExecute(r ApiReadSponsorConnectivityDataRequest) (*SponsorConnectivityData, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *SponsorConnectivityData
	)
	...
	localVarPath = strings.Replace(localVarPath, "{"+"sponsorId"+"}", url.PathEscape(parameterToString(r.sponsorId, "")), -1)
