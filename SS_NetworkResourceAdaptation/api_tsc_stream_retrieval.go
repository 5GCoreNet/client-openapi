...
type TSCStreamRetrievalApi interface {
	...
	*/
	GetTscStream(ctx context.Context) ApiGetTscStreamRequest

	// GetTscStreamExecute executes the request
	//  @return []TscStreamData
	GetTscStreamExecute(r ApiGetTscStreamRequest) ([]TscStreamData, *http.Response, error)
}
...
type ApiGetTscStreamRequest struct {
	ctx context.Context
	ApiService TSCStreamRetrievalApi
	valStreamIds *[]string
}
...
func (a *TSCStreamRetrievalApiService) GetTscStreamExecute(r ApiGetTscStreamRequest) ([]TscStreamData, *http.Response, error) {
	...
	if r.valStreamIds != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("val-stream-ids", parameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("val-stream-ids", parameterToString(t, "multi"))
		}
	}
