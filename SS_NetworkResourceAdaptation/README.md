# Go API client for SS_NetworkResourceAdaptation
...
```golang
import SS_NetworkResourceAdaptation "//"
```
...
```golang
ctx := context.WithValue(context.Background(), SS_NetworkResourceAdaptation.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), SS_NetworkResourceAdaptation.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), SS_NetworkResourceAdaptation.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), SS_NetworkResourceAdaptation.ContextOperationServerVariables, map[string]map[string]string{
