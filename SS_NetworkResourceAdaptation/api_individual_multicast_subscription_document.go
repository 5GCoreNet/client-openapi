...
type IndividualMulticastSubscriptionDocumentApi interface {
	...
	*/
	DeleteMulticastSubscription(ctx context.Context, multiSubId string) ApiDeleteMulticastSubscriptionRequest

	// DeleteMulticastSubscriptionExecute executes the request
	DeleteMulticastSubscriptionExecute(r ApiDeleteMulticastSubscriptionRequest) (*http.Response, error)
	...
	*/
	GetMulticastSubscription(ctx context.Context, multiSubId string) ApiGetMulticastSubscriptionRequest

	// GetMulticastSubscriptionExecute executes the request
	//  @return MulticastSubscription
	GetMulticastSubscriptionExecute(r ApiGetMulticastSubscriptionRequest) (*MulticastSubscription, *http.Response, error)
}
...
type ApiDeleteMulticastSubscriptionRequest struct {
	ctx context.Context
	ApiService IndividualMulticastSubscriptionDocumentApi
	multiSubId string
}
...
func (a *IndividualMulticastSubscriptionDocumentApiService) DeleteMulticastSubscriptionExecute(r ApiDeleteMulticastSubscriptionRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"multiSubId"+"}", url.PathEscape(parameterToString(r.multiSubId, "")), -1)
