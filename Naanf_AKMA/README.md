...
```golang
ctx := context.WithValue(context.Background(), Naanf_AKMA.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), Naanf_AKMA.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), Naanf_AKMA.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), Naanf_AKMA.ContextOperationServerVariables, map[string]map[string]string{
