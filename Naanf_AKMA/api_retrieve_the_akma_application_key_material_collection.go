...
type RetrieveTheAKMAApplicationKeyMaterialCollectionApi interface {
	...
	*/
	GetAKMAAPPKeyMaterial(ctx context.Context) ApiGetAKMAAPPKeyMaterialRequest

	// GetAKMAAPPKeyMaterialExecute executes the request
	//  @return AkmaAfKeyData
	GetAKMAAPPKeyMaterialExecute(r ApiGetAKMAAPPKeyMaterialRequest) (*AkmaAfKeyData, *http.Response, error)
}
...
type ApiGetAKMAAPPKeyMaterialRequest struct {
	ctx context.Context
	ApiService RetrieveTheAKMAApplicationKeyMaterialCollectionApi
