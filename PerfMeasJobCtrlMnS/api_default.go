...
type DefaultApi interface {
	...
	*/
	MeasJobsGet(ctx context.Context) ApiMeasJobsGetRequest

	// MeasJobsGetExecute executes the request
	//  @return MeasJobsRetrievalResponseType
	MeasJobsGetExecute(r ApiMeasJobsGetRequest) (*MeasJobsRetrievalResponseType, *http.Response, error)
	...
	*/
	MeasJobsJobIdDelete(ctx context.Context, jobId string) ApiMeasJobsJobIdDeleteRequest

	// MeasJobsJobIdDeleteExecute executes the request
	MeasJobsJobIdDeleteExecute(r ApiMeasJobsJobIdDeleteRequest) (*http.Response, error)
	...
	*/
	MeasJobsJobIdGet(ctx context.Context, jobId string) ApiMeasJobsJobIdGetRequest

	// MeasJobsJobIdGetExecute executes the request
	//  @return MeasJobsRetrievalResponseType
	MeasJobsJobIdGetExecute(r ApiMeasJobsJobIdGetRequest) (*MeasJobsRetrievalResponseType, *http.Response, error)
	...
	*/
	MeasJobsPost(ctx context.Context) ApiMeasJobsPostRequest

	// MeasJobsPostExecute executes the request
	//  @return MeasJobCreationResponseType
	MeasJobsPostExecute(r ApiMeasJobsPostRequest) (*MeasJobCreationResponseType, *http.Response, error)
}
...
func (a *DefaultApiService) MeasJobsGetExecute(r ApiMeasJobsGetRequest) (*MeasJobsRetrievalResponseType, *http.Response, error) {
...

	{
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("jobIdList", parameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("jobIdList", parameterToString(t, "multi"))
		}
	}
