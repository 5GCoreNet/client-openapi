...
type ApplicationAMContextsCollectionApi interface {
	...
	*/
	...
	PostAppAmContextsExecute(r ApiPostAppAmContextsRequest) (*AppAmContextRespData, *http.Response, error)
}
...
type ApiPostAppAmContextsRequest struct {
	ctx context.Context
	ApiService ApplicationAMContextsCollectionApi
