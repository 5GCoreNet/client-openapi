...
type AMPolicyEventsSubscriptionDocumentApi interface {
	...
	*/
	DeleteAmEventsSubsc(ctx context.Context, appAmContextId string) ApiDeleteAmEventsSubscRequest
	...
	*/
	UpdateAmEventsSubsc(ctx context.Context, appAmContextId string) ApiUpdateAmEventsSubscRequest
...
type ApiDeleteAmEventsSubscRequest struct {
	ctx context.Context
	ApiService AMPolicyEventsSubscriptionDocumentApi
