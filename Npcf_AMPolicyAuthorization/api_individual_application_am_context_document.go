...
type IndividualApplicationAMContextDocumentApi interface {
	...
	*/
	DeleteAppAmContext(ctx context.Context, appAmContextId string) ApiDeleteAppAmContextRequest
	...
	*/
	...
	GetAppAmContextExecute(r ApiGetAppAmContextRequest) (*AppAmContextData, *http.Response, error)
	...
	*/
	ModAppAmContext(ctx context.Context, appAmContextId string) ApiModAppAmContextRequest

	// ModAppAmContextExecute executes the request
	//  @return AppAmContextRespData
	ModAppAmContextExecute(r ApiModAppAmContextRequest) (*AppAmContextRespData, *http.Response, error)
}
...
type ApiDeleteAppAmContextRequest struct {
	ctx context.Context
	ApiService IndividualApplicationAMContextDocumentApi
