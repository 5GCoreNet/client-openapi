...
// APIClient manages communication with the Npcf_AMPolicyAuthorization Service API API v1.0.1
...
type APIClient struct {
	...
	IndividualApplicationAMContextDocumentApi IndividualApplicationAMContextDocumentApi
}
