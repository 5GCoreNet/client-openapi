...
**MedComponents** | Pointer to [**map[string]MediaComponent**](MediaComponent.md) | Contains media component information. The key of the map is the medCompN attribute. | [optional] 
