...
------------ | ------------- | ------------- | -------------
**AdReports** | Pointer to [**[]AppDetectionReport**](AppDetectionReport.md) | Includes the detected application report. | [optional] 
...
**UeLocTime** | Pointer to **time.Time** | string with format &#39;date-time&#39; as defined in OpenAPI. | [optional] 
