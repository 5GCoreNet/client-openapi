...
type N32FForwardApi interface {
	...
	*/
	N32fProcessOptions(ctx context.Context) ApiN32fProcessOptionsRequest

	// N32fProcessOptionsExecute executes the request
	N32fProcessOptionsExecute(r ApiN32fProcessOptionsRequest) (*http.Response, error)
	...
	*/
	PostN32fProcess(ctx context.Context) ApiPostN32fProcessRequest

	// PostN32fProcessExecute executes the request
	//  @return N32fReformattedRspMsg
	PostN32fProcessExecute(r ApiPostN32fProcessRequest) (*N32fReformattedRspMsg, *http.Response, error)
}
...
func (a *N32FForwardApiService) PostN32fProcessExecute(r ApiPostN32fProcessRequest) (*N32fReformattedRspMsg, *http.Response, error) {
	...
	if r.var3gppSbiMessagePriority != nil {
		localVarHeaderParams["3gpp-Sbi-Message-Priority"] = parameterToString(*r.var3gppSbiMessagePriority, "")
	}
	// body params
