...
type TimerUpdateApi interface {
	...
	*/
	UpdateTimer(ctx context.Context, realmId string, storageId string, timerId string) ApiUpdateTimerRequest

	// UpdateTimerExecute executes the request
	//  @return PatchResult
	UpdateTimerExecute(r ApiUpdateTimerRequest) (*PatchResult, *http.Response, error)
}
