...
type TimersDeleteApi interface {
	...
	*/
	DeleteTimers(ctx context.Context, realmId string, storageId string) ApiDeleteTimersRequest

	// DeleteTimersExecute executes the request
	//  @return TimerIdList
	DeleteTimersExecute(r ApiDeleteTimersRequest) (*TimerIdList, *http.Response, error)
}
...
func (a *TimersDeleteApiService) DeleteTimersExecute(r ApiDeleteTimersRequest) (*TimerIdList, *http.Response, error) {
	...
	if r.expiredFilter != nil {
		localVarQueryParams.Add("expired-filter", parameterToString(*r.expiredFilter, ""))
	}
