...
type TimerGetApi interface {
	...
	*/
	GetTimer(ctx context.Context, realmId string, storageId string, timerId string) ApiGetTimerRequest

	// GetTimerExecute executes the request
	//  @return Timer
	GetTimerExecute(r ApiGetTimerRequest) (*Timer, *http.Response, error)
}
...
func (r ApiGetTimerRequest) SupportedFeatures(supportedFeatures string) ApiGetTimerRequest {
	r.supportedFeatures = &supportedFeatures
	return r
}

func (r ApiGetTimerRequest) Execute() (*Timer, *http.Response, error) {
