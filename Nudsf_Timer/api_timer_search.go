...
type TimerSearchApi interface {
	...
	*/
	SearchTimer(ctx context.Context, realmId string, storageId string) ApiSearchTimerRequest

	// SearchTimerExecute executes the request
	//  @return TimerIdList
	SearchTimerExecute(r ApiSearchTimerRequest) (*TimerIdList, *http.Response, error)
}
