...
type APIClient struct {
	...
	TimerGetApi TimerGetApi

	TimerSearchApi TimerSearchApi

	TimerStartApi TimerStartApi

	TimerStopApi TimerStopApi

	TimerUpdateApi TimerUpdateApi

	TimersDeleteApi TimersDeleteApi
}
