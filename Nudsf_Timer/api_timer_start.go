...
type TimerStartApi interface {
	...
	*/
	CreateOrModifyTimer(ctx context.Context, realmId string, storageId string, timerId string) ApiCreateOrModifyTimerRequest

	// CreateOrModifyTimerExecute executes the request
	CreateOrModifyTimerExecute(r ApiCreateOrModifyTimerRequest) (*http.Response, error)
}
...
func (r ApiCreateOrModifyTimerRequest) Timer(timer Timer) ApiCreateOrModifyTimerRequest {
	r.timer = &timer
	return r
}

// Features required to be supported by the target NF
func (r ApiCreateOrModifyTimerRequest) SupportedFeatures(supportedFeatures string) ApiCreateOrModifyTimerRequest {
	r.supportedFeatures = &supportedFeatures
	return r
}

func (r ApiCreateOrModifyTimerRequest) Execute() (*http.Response, error) {
	return r.ApiService.CreateOrModifyTimerExecute(r)
}
...
func (a *TimerStartApiService) CreateOrModifyTimerExecute(r ApiCreateOrModifyTimerRequest) (*http.Response, error) {
	...
	if r.timer == nil {
		return nil, reportError("timer is required and must be specified")
	}
