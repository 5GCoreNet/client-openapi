# Go API client for Nnwdaf_MLModelProvision
...
```golang
import Nnwdaf_MLModelProvision "//"
```
...
```golang
ctx := context.WithValue(context.Background(), Nnwdaf_MLModelProvision.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), Nnwdaf_MLModelProvision.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), Nnwdaf_MLModelProvision.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), Nnwdaf_MLModelProvision.ContextOperationServerVariables, map[string]map[string]string{
