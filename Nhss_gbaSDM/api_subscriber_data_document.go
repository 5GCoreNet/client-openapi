...
type SubscriberDataDocumentApi interface {
	...
	*/
	GetSubscriberData(ctx context.Context, ueId UeId) ApiGetSubscriberDataRequest

	// GetSubscriberDataExecute executes the request
	//  @return GbaSubscriberData
	GetSubscriberDataExecute(r ApiGetSubscriberDataRequest) (*GbaSubscriberData, *http.Response, error)
}
...
type ApiGetSubscriberDataRequest struct {
	ctx context.Context
	ApiService SubscriberDataDocumentApi
	ueId UeId
...
func (r ApiGetSubscriberDataRequest) Execute() (*GbaSubscriberData, *http.Response, error) {
	return r.ApiService.GetSubscriberDataExecute(r)
}
...
func (a *SubscriberDataDocumentApiService) GetSubscriberDataExecute(r ApiGetSubscriberDataRequest) (*GbaSubscriberData, *http.Response, error) {
	...
	localVarPath := localBasePath + "/{ueId}/subscriber-data"
