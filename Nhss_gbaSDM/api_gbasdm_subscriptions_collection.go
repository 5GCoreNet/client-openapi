...
type GBASDMSubscriptionsCollectionApi interface {
	...
	*/
	GbaSdmSubscribe(ctx context.Context, ueId UeId) ApiGbaSdmSubscribeRequest

	// GbaSdmSubscribeExecute executes the request
	//  @return GbaSdmSubscription
	GbaSdmSubscribeExecute(r ApiGbaSdmSubscribeRequest) (*GbaSdmSubscription, *http.Response, error)
}
...
type ApiGbaSdmSubscribeRequest struct {
	ctx context.Context
	ApiService GBASDMSubscriptionsCollectionApi
	ueId UeId
