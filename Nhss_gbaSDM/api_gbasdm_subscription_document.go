...
type GBASDMSubscriptionDocumentApi interface {
	...
	*/
	GbaSdmSubsModify(ctx context.Context, ueId UeId, subscriptionId string) ApiGbaSdmSubsModifyRequest

	// GbaSdmSubsModifyExecute executes the request
	//  @return PatchResult
	GbaSdmSubsModifyExecute(r ApiGbaSdmSubsModifyRequest) (*PatchResult, *http.Response, error)
	...
	*/
	GbaSdmUnsubscribe(ctx context.Context, ueId UeId, subscriptionId string) ApiGbaSdmUnsubscribeRequest

	// GbaSdmUnsubscribeExecute executes the request
	GbaSdmUnsubscribeExecute(r ApiGbaSdmUnsubscribeRequest) (*http.Response, error)
}
...
type ApiGbaSdmSubsModifyRequest struct {
	ctx context.Context
	ApiService GBASDMSubscriptionDocumentApi
	ueId UeId
