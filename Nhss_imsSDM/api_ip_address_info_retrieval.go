...
type IPAddressInfoRetrievalApi interface {
	...
	*/
	GetIpAddressInfo(ctx context.Context, imsUeId string) ApiGetIpAddressInfoRequest

	// GetIpAddressInfoExecute executes the request
	//  @return IpAddr
	GetIpAddressInfoExecute(r ApiGetIpAddressInfoRequest) (*IpAddr, *http.Response, error)
}
...
type ApiGetIpAddressInfoRequest struct {
	ctx context.Context
	ApiService IPAddressInfoRetrievalApi
	imsUeId string
}

func (r ApiGetIpAddressInfoRequest) Execute() (*IpAddr, *http.Response, error) {
	return r.ApiService.GetIpAddressInfoExecute(r)
}
...
func (a *IPAddressInfoRetrievalApiService) GetIpAddressInfoExecute(r ApiGetIpAddressInfoRequest) (*IpAddr, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *IpAddr
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPAddressInfoRetrievalApiService.GetIpAddressInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{imsUeId}/access-data/ps-domain/ip-address"
