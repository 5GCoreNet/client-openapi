...
type UpdateSMSRegistrationInfoApi interface {
	...
	*/
	UpdateSmsRegistrationInfo(ctx context.Context, imsUeId string) ApiUpdateSmsRegistrationInfoRequest

	// UpdateSmsRegistrationInfoExecute executes the request
	//  @return SmsRegistrationInfo
	UpdateSmsRegistrationInfoExecute(r ApiUpdateSmsRegistrationInfoRequest) (*SmsRegistrationInfo, *http.Response, error)
}
...
type ApiUpdateSmsRegistrationInfoRequest struct {
	ctx context.Context
	ApiService UpdateSMSRegistrationInfoApi
	imsUeId string
