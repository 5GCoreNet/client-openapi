...
type UpdateDsaiStateApi interface {
	...
	*/
	UpdateDsaiState(ctx context.Context, imsUeId string) ApiUpdateDsaiStateRequest

	// UpdateDsaiStateExecute executes the request
	//  @return PatchResult
	UpdateDsaiStateExecute(r ApiUpdateDsaiStateRequest) (*PatchResult, *http.Response, error)
}
...
func (r ApiUpdateDsaiStateRequest) Execute() (*PatchResult, *http.Response, error) {
	return r.ApiService.UpdateDsaiStateExecute(r)
}
...
func (a *UpdateDsaiStateApiService) UpdateDsaiStateExecute(r ApiUpdateDsaiStateRequest) (*PatchResult, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UpdateDsaiStateApiService.UpdateDsaiState")
	if err != nil {
