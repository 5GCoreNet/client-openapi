...
type CSUserStateInfoRetrievalApi interface {
	...
	*/
	GetCsUserStateInfo(ctx context.Context, imsUeId string) ApiGetCsUserStateInfoRequest

	// GetCsUserStateInfoExecute executes the request
	//  @return CsUserState
	GetCsUserStateInfoExecute(r ApiGetCsUserStateInfoRequest) (*CsUserState, *http.Response, error)
}
...
type ApiGetCsUserStateInfoRequest struct {
	ctx context.Context
	ApiService CSUserStateInfoRetrievalApi
	imsUeId string
...
func (r ApiGetCsUserStateInfoRequest) Execute() (*CsUserState, *http.Response, error) {
	return r.ApiService.GetCsUserStateInfoExecute(r)
}
...
func (a *CSUserStateInfoRetrievalApiService) GetCsUserStateInfoExecute(r ApiGetCsUserStateInfoRequest) (*CsUserState, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *CsUserState
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CSUserStateInfoRetrievalApiService.GetCsUserStateInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{imsUeId}/access-data/cs-domain/user-state"
