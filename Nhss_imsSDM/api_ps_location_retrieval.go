...
type PSLocationRetrievalApi interface {
	...
	*/
	GetLocPsDomain(ctx context.Context, imsUeId string) ApiGetLocPsDomainRequest

	// GetLocPsDomainExecute executes the request
	//  @return PsLocation
	GetLocPsDomainExecute(r ApiGetLocPsDomainRequest) (*PsLocation, *http.Response, error)
}
...
type ApiGetLocPsDomainRequest struct {
	ctx context.Context
	ApiService PSLocationRetrievalApi
	imsUeId string
...
func (a *PSLocationRetrievalApiService) GetLocPsDomainExecute(r ApiGetLocPsDomainRequest) (*PsLocation, *http.Response, error) {
	...
	if r.servingNode != nil {
		localVarQueryParams.Add("serving-node", parameterToString(*r.servingNode, ""))
	}
	if r.localTime != nil {
		localVarQueryParams.Add("local-time", parameterToString(*r.localTime, ""))
	}
	if r.currentLocation != nil {
		localVarQueryParams.Add("current-location", parameterToString(*r.currentLocation, ""))
	}
	if r.ratType != nil {
