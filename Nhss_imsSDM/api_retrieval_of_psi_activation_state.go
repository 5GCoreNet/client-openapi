...
type RetrievalOfPSIActivationStateApi interface {
	...
	*/
	GetPsiState(ctx context.Context, imsUeId string) ApiGetPsiStateRequest

	// GetPsiStateExecute executes the request
	//  @return PsiActivationState
	GetPsiStateExecute(r ApiGetPsiStateRequest) (*PsiActivationState, *http.Response, error)
}
...
type ApiGetPsiStateRequest struct {
	ctx context.Context
	ApiService RetrievalOfPSIActivationStateApi
	imsUeId string
...
func (r ApiGetPsiStateRequest) Execute() (*PsiActivationState, *http.Response, error) {
	return r.ApiService.GetPsiStateExecute(r)
}
...
func (a *RetrievalOfPSIActivationStateApiService) GetPsiStateExecute(r ApiGetPsiStateRequest) (*PsiActivationState, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *PsiActivationState
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RetrievalOfPSIActivationStateApiService.GetPsiState")
	if err != nil {
