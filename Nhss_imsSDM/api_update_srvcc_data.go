...
type UpdateSRVCCDataApi interface {
	...
	*/
	UpdateSrvccData(ctx context.Context, imsUeId string) ApiUpdateSrvccDataRequest

	// UpdateSrvccDataExecute executes the request
	//  @return PatchResult
	UpdateSrvccDataExecute(r ApiUpdateSrvccDataRequest) (*PatchResult, *http.Response, error)
}
...
func (r ApiUpdateSrvccDataRequest) Execute() (*PatchResult, *http.Response, error) {
	return r.ApiService.UpdateSrvccDataExecute(r)
}
