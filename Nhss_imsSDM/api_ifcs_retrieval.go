...
type IFCsRetrievalApi interface {
	...
	*/
	GetIfcs(ctx context.Context, imsUeId string) ApiGetIfcsRequest

	// GetIfcsExecute executes the request
	//  @return Ifcs
	GetIfcsExecute(r ApiGetIfcsRequest) (*Ifcs, *http.Response, error)
}
