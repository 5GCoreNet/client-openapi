...
type RepositoryDataApi interface {
	...
	*/
	GetRepositoryDataServInd(ctx context.Context, imsUeId string, serviceIndication string) ApiGetRepositoryDataServIndRequest

	// GetRepositoryDataServIndExecute executes the request
	//  @return RepositoryData
	GetRepositoryDataServIndExecute(r ApiGetRepositoryDataServIndRequest) (*RepositoryData, *http.Response, error)
}
