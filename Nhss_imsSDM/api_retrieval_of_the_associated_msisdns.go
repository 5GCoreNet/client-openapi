...
type RetrievalOfTheAssociatedMsisdnsApi interface {
	...
	*/
	GetMsisdns(ctx context.Context, imsUeId string) ApiGetMsisdnsRequest

	// GetMsisdnsExecute executes the request
	//  @return MsisdnList
	GetMsisdnsExecute(r ApiGetMsisdnsRequest) (*MsisdnList, *http.Response, error)
}
...
type ApiGetMsisdnsRequest struct {
	ctx context.Context
	ApiService RetrievalOfTheAssociatedMsisdnsApi
	imsUeId string
	privateId *string
}
...
func (r ApiGetMsisdnsRequest) Execute() (*MsisdnList, *http.Response, error) {
	return r.ApiService.GetMsisdnsExecute(r)
}
...
func (a *RetrievalOfTheAssociatedMsisdnsApiService) GetMsisdnsExecute(r ApiGetMsisdnsRequest) (*MsisdnList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/{imsUeId}/identities/msisdns"
	...
	if r.privateId != nil {
		localVarQueryParams.Add("private-id", parameterToString(*r.privateId, ""))
	}
