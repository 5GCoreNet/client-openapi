...
type IMEISVRetrievalApi interface {
	...
	*/
	GetIMEISVInfo(ctx context.Context, imsUeId string) ApiGetIMEISVInfoRequest

	// GetIMEISVInfoExecute executes the request
	//  @return ImeiSvInformation
	GetIMEISVInfoExecute(r ApiGetIMEISVInfoRequest) (*ImeiSvInformation, *http.Response, error)
}
...
func (r ApiGetIMEISVInfoRequest) Execute() (*ImeiSvInformation, *http.Response, error) {
	return r.ApiService.GetIMEISVInfoExecute(r)
}
...
func (a *IMEISVRetrievalApiService) GetIMEISVInfoExecute(r ApiGetIMEISVInfoRequest) (*ImeiSvInformation, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *ImeiSvInformation
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IMEISVRetrievalApiService.GetIMEISVInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{imsUeId}/identities/imeisv"
