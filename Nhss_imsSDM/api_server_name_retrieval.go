...
type ServerNameRetrievalApi interface {
	...
	*/
	GetServerName(ctx context.Context, imsUeId string) ApiGetServerNameRequest

	// GetServerNameExecute executes the request
	//  @return ImsLocationData
	GetServerNameExecute(r ApiGetServerNameRequest) (*ImsLocationData, *http.Response, error)
}
...
type ApiGetServerNameRequest struct {
	ctx context.Context
	ApiService ServerNameRetrievalApi
	imsUeId string
...
func (r ApiGetServerNameRequest) Execute() (*ImsLocationData, *http.Response, error) {
	return r.ApiService.GetServerNameExecute(r)
}
...
func (a *ServerNameRetrievalApiService) GetServerNameExecute(r ApiGetServerNameRequest) (*ImsLocationData, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *ImsLocationData
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServerNameRetrievalApiService.GetServerName")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{imsUeId}/ims-data/location-data/server-name"
