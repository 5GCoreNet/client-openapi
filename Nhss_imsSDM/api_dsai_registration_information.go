...
type DSAIRegistrationInformationApi interface {
	...
	*/
	GetDsaiInfo(ctx context.Context, imsUeId string) ApiGetDsaiInfoRequest

	// GetDsaiInfoExecute executes the request
	//  @return DsaiTagInformation
	GetDsaiInfoExecute(r ApiGetDsaiInfoRequest) (*DsaiTagInformation, *http.Response, error)
}
...
type ApiGetDsaiInfoRequest struct {
	ctx context.Context
	ApiService DSAIRegistrationInformationApi
	imsUeId string
