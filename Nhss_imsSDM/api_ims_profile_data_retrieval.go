...
type IMSProfileDataRetrievalApi interface {
	...
	*/
	GetProfileData(ctx context.Context, imsUeId string) ApiGetProfileDataRequest

	// GetProfileDataExecute executes the request
	//  @return ImsProfileData
	GetProfileDataExecute(r ApiGetProfileDataRequest) (*ImsProfileData, *http.Response, error)
}
...
type ApiGetProfileDataRequest struct {
	ctx context.Context
	ApiService IMSProfileDataRetrievalApi
	imsUeId string
...
func (a *IMSProfileDataRetrievalApiService) GetProfileDataExecute(r ApiGetProfileDataRequest) (*ImsProfileData, *http.Response, error) {
	...
	if r.datasetNames != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("dataset-names", parameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("dataset-names", parameterToString(t, "multi"))
		}
	}
