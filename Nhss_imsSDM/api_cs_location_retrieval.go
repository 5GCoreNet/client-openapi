...
type CSLocationRetrievalApi interface {
	...
	*/
	...
	// GetLocCsDomainExecute executes the request
	//  @return CsLocation
	GetLocCsDomainExecute(r ApiGetLocCsDomainRequest) (*CsLocation, *http.Response, error)
}
...
type ApiGetLocCsDomainRequest struct {
	ctx context.Context
	ApiService CSLocationRetrievalApi
	imsUeId string
	servingNode *bool
	localTime *bool
