...
type RetrievalOfAssociatedIMSPrivateIdentitiesApi interface {
	...
	*/
	GetImsPrivateIds(ctx context.Context, imsUeId string) ApiGetImsPrivateIdsRequest

	// GetImsPrivateIdsExecute executes the request
	//  @return PrivateIdentities
	GetImsPrivateIdsExecute(r ApiGetImsPrivateIdsRequest) (*PrivateIdentities, *http.Response, error)
}
...
type ApiGetImsPrivateIdsRequest struct {
	ctx context.Context
	ApiService RetrievalOfAssociatedIMSPrivateIdentitiesApi
	imsUeId string
...
func (r ApiGetImsPrivateIdsRequest) Execute() (*PrivateIdentities, *http.Response, error) {
	return r.ApiService.GetImsPrivateIdsExecute(r)
}
...
func (a *RetrievalOfAssociatedIMSPrivateIdentitiesApiService) GetImsPrivateIdsExecute(r ApiGetImsPrivateIdsRequest) (*PrivateIdentities, *http.Response, error) {
	...
	localVarPath := localBasePath + "/{imsUeId}/identities/private-identities"
	...
	if r.impi != nil {
		localVarQueryParams.Add("impi", parameterToString(*r.impi, ""))
	}
