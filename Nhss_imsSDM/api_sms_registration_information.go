...
type SMSRegistrationInformationApi interface {
	...
	*/
	GetSmsRegistrationInfo(ctx context.Context, imsUeId string) ApiGetSmsRegistrationInfoRequest

	// GetSmsRegistrationInfoExecute executes the request
	//  @return SmsRegistrationInfo
	GetSmsRegistrationInfoExecute(r ApiGetSmsRegistrationInfoRequest) (*SmsRegistrationInfo, *http.Response, error)
}
...
type ApiGetSmsRegistrationInfoRequest struct {
	ctx context.Context
	ApiService SMSRegistrationInformationApi
	imsUeId string
...
func (r ApiGetSmsRegistrationInfoRequest) Execute() (*SmsRegistrationInfo, *http.Response, error) {
	return r.ApiService.GetSmsRegistrationInfoExecute(r)
}
...
func (a *SMSRegistrationInformationApiService) GetSmsRegistrationInfoExecute(r ApiGetSmsRegistrationInfoRequest) (*SmsRegistrationInfo, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SMSRegistrationInformationApiService.GetSmsRegistrationInfo")
	if err != nil {
