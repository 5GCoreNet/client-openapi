...
type ChargingInfoRetrievalApi interface {
	...
	*/
	GetChargingInfo(ctx context.Context, imsUeId string) ApiGetChargingInfoRequest

	// GetChargingInfoExecute executes the request
	//  @return ChargingInfo
	GetChargingInfoExecute(r ApiGetChargingInfoRequest) (*ChargingInfo, *http.Response, error)
}
...
type ApiGetChargingInfoRequest struct {
	ctx context.Context
	ApiService ChargingInfoRetrievalApi
	imsUeId string
...
func (r ApiGetChargingInfoRequest) Execute() (*ChargingInfo, *http.Response, error) {
	return r.ApiService.GetChargingInfoExecute(r)
}
...
func (a *ChargingInfoRetrievalApiService) GetChargingInfoExecute(r ApiGetChargingInfoRequest) (*ChargingInfo, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *ChargingInfo
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChargingInfoRetrievalApiService.GetChargingInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{imsUeId}/ims-data/profile-data/charging-info"
