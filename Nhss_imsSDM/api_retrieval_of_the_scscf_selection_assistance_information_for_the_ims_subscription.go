...
type RetrievalOfTheSCSCFSelectionAssistanceInformationForTheIMSSubscriptionApi interface {
	...
	*/
	GetScscfSelectionAssistanceInfo(ctx context.Context, imsUeId string) ApiGetScscfSelectionAssistanceInfoRequest

	// GetScscfSelectionAssistanceInfoExecute executes the request
	//  @return ScscfSelectionAssistanceInformation
	GetScscfSelectionAssistanceInfoExecute(r ApiGetScscfSelectionAssistanceInfoRequest) (*ScscfSelectionAssistanceInformation, *http.Response, error)
}
...
type ApiGetScscfSelectionAssistanceInfoRequest struct {
	ctx context.Context
	ApiService RetrievalOfTheSCSCFSelectionAssistanceInformationForTheIMSSubscriptionApi
	imsUeId string
}

func (r ApiGetScscfSelectionAssistanceInfoRequest) Execute() (*ScscfSelectionAssistanceInformation, *http.Response, error) {
	return r.ApiService.GetScscfSelectionAssistanceInfoExecute(r)
}
...
func (a *RetrievalOfTheSCSCFSelectionAssistanceInformationForTheIMSSubscriptionApiService) GetScscfSelectionAssistanceInfoExecute(r ApiGetScscfSelectionAssistanceInfoRequest) (*ScscfSelectionAssistanceInformation, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *ScscfSelectionAssistanceInformation
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RetrievalOfTheSCSCFSelectionAssistanceInformationForTheIMSSubscriptionApiService.GetScscfSelectionAssistanceInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{imsUeId}/ims-data/location-data/scscf-selection-assistance-info"
