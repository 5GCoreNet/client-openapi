...
type SDMSubscriptionDeletionApi interface {
	...
	*/
	ImsSdmUnsubscribe(ctx context.Context, imsUeId string, subscriptionId string) ApiImsSdmUnsubscribeRequest

	// ImsSdmUnsubscribeExecute executes the request
	ImsSdmUnsubscribeExecute(r ApiImsSdmUnsubscribeRequest) (*http.Response, error)
}
...
type ApiImsSdmUnsubscribeRequest struct {
	ctx context.Context
	ApiService SDMSubscriptionDeletionApi
	imsUeId string
