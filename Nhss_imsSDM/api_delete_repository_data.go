...
type DeleteRepositoryDataApi interface {
	...
	*/
	DeleteRepositoryDataServInd(ctx context.Context, imsUeId string, serviceIndication string) ApiDeleteRepositoryDataServIndRequest

	// DeleteRepositoryDataServIndExecute executes the request
	DeleteRepositoryDataServIndExecute(r ApiDeleteRepositoryDataServIndRequest) (*http.Response, error)
}
...
type ApiDeleteRepositoryDataServIndRequest struct {
	ctx context.Context
	ApiService DeleteRepositoryDataApi
	imsUeId string
