...
type UpdatePSIStateDataApi interface {
	...
	*/
	UpdatePsiState(ctx context.Context, imsUeId string) ApiUpdatePsiStateRequest

	// UpdatePsiStateExecute executes the request
	//  @return PatchResult
	UpdatePsiStateExecute(r ApiUpdatePsiStateRequest) (*PatchResult, *http.Response, error)
}
...
type ApiUpdatePsiStateRequest struct {
	ctx context.Context
	ApiService UpdatePSIStateDataApi
	imsUeId string
	patchItem *[]PatchItem
