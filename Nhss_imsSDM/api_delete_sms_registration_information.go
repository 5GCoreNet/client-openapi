...
type DeleteSMSRegistrationInformationApi interface {
	...
	*/
	DeleteSmsRegistrationInfo(ctx context.Context, imsUeId string) ApiDeleteSmsRegistrationInfoRequest

	// DeleteSmsRegistrationInfoExecute executes the request
	DeleteSmsRegistrationInfoExecute(r ApiDeleteSmsRegistrationInfoRequest) (*http.Response, error)
}
...
type ApiDeleteSmsRegistrationInfoRequest struct {
	ctx context.Context
	ApiService DeleteSMSRegistrationInformationApi
	imsUeId string
...
func (r ApiDeleteSmsRegistrationInfoRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteSmsRegistrationInfoExecute(r)
}
