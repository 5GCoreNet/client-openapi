...
func NewNullableRepositoryDataList(val *RepositoryDataList) *NullableRepositoryDataList {
	return &NullableRepositoryDataList{value: val, isSet: true}
}
