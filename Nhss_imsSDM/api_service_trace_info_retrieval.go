...
type ServiceTraceInfoRetrievalApi interface {
	...
	*/
	GetServiceTraceInfo(ctx context.Context, imsUeId string) ApiGetServiceTraceInfoRequest

	// GetServiceTraceInfoExecute executes the request
	//  @return ServiceLevelTraceInformation
	GetServiceTraceInfoExecute(r ApiGetServiceTraceInfoRequest) (*ServiceLevelTraceInformation, *http.Response, error)
}
...
type ApiGetServiceTraceInfoRequest struct {
	ctx context.Context
	ApiService ServiceTraceInfoRetrievalApi
	imsUeId string
...
func (r ApiGetServiceTraceInfoRequest) Execute() (*ServiceLevelTraceInformation, *http.Response, error) {
	return r.ApiService.GetServiceTraceInfoExecute(r)
}
...
func (a *ServiceTraceInfoRetrievalApiService) GetServiceTraceInfoExecute(r ApiGetServiceTraceInfoRequest) (*ServiceLevelTraceInformation, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *ServiceLevelTraceInformation
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceTraceInfoRetrievalApiService.GetServiceTraceInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{imsUeId}/ims-data/profile-data/service-level-trace-information"
