...
type ReachabilitySubscriptionModificationApi interface {
	...
	*/
	UeReachSubsModify(ctx context.Context, imsUeId string, subscriptionId string) ApiUeReachSubsModifyRequest

	// UeReachSubsModifyExecute executes the request
	//  @return PatchResult
	UeReachSubsModifyExecute(r ApiUeReachSubsModifyRequest) (*PatchResult, *http.Response, error)
}
...
type ApiUeReachSubsModifyRequest struct {
	ctx context.Context
	ApiService ReachabilitySubscriptionModificationApi
	imsUeId string
