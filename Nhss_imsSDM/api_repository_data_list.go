...
type RepositoryDataListApi interface {
	...
	*/
	GetRepositoryDataServIndList(ctx context.Context, imsUeId string) ApiGetRepositoryDataServIndListRequest

	// GetRepositoryDataServIndListExecute executes the request
	//  @return RepositoryDataList
	GetRepositoryDataServIndListExecute(r ApiGetRepositoryDataServIndListRequest) (*RepositoryDataList, *http.Response, error)
}
...
type ApiGetRepositoryDataServIndListRequest struct {
	ctx context.Context
	ApiService RepositoryDataListApi
	imsUeId string
...
func (a *RepositoryDataListApiService) GetRepositoryDataServIndListExecute(r ApiGetRepositoryDataServIndListRequest) (*RepositoryDataList, *http.Response, error) {
	...
	localVarQueryParams.Add("service-indications", parameterToString(*r.serviceIndications, "csv"))
