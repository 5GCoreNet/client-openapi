...
type RetrievalOfUESRVCCCapabilityAndSTNSRApi interface {
	...
	*/
	...
	// GetSrvccDataExecute executes the request
	//  @return SrvccData
	GetSrvccDataExecute(r ApiGetSrvccDataRequest) (*SrvccData, *http.Response, error)
}
...
type ApiGetSrvccDataRequest struct {
	ctx context.Context
	ApiService RetrievalOfUESRVCCCapabilityAndSTNSRApi
	imsUeId string
...
func (r ApiGetSrvccDataRequest) Execute() (*SrvccData, *http.Response, error) {
	return r.ApiService.GetSrvccDataExecute(r)
}
...
func (a *RetrievalOfUESRVCCCapabilityAndSTNSRApiService) GetSrvccDataExecute(r ApiGetSrvccDataRequest) (*SrvccData, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *SrvccData
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RetrievalOfUESRVCCCapabilityAndSTNSRApiService.GetSrvccData")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{imsUeId}/srvcc-data"
