...
type TADSInfoRetrievalApi interface {
	...
	*/
	GetTadsInfo(ctx context.Context, imsUeId string) ApiGetTadsInfoRequest

	// GetTadsInfoExecute executes the request
	//  @return TadsInformation
	GetTadsInfoExecute(r ApiGetTadsInfoRequest) (*TadsInformation, *http.Response, error)
}
...
type ApiGetTadsInfoRequest struct {
	ctx context.Context
	ApiService TADSInfoRetrievalApi
	imsUeId string
...
func (r ApiGetTadsInfoRequest) Execute() (*TadsInformation, *http.Response, error) {
	return r.ApiService.GetTadsInfoExecute(r)
}
...
func (a *TADSInfoRetrievalApiService) GetTadsInfoExecute(r ApiGetTadsInfoRequest) (*TadsInformation, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *TadsInformation
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TADSInfoRetrievalApiService.GetTadsInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{imsUeId}/access-data/ps-domain/tads-info"
