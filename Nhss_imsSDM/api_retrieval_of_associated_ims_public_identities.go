...
type RetrievalOfAssociatedIMSPublicIdentitiesApi interface {
	...
	*/
	GetImsAssocIds(ctx context.Context, imsUeId string) ApiGetImsAssocIdsRequest

	// GetImsAssocIdsExecute executes the request
	//  @return ImsAssociatedIdentities
	GetImsAssocIdsExecute(r ApiGetImsAssocIdsRequest) (*ImsAssociatedIdentities, *http.Response, error)
}
...
type ApiGetImsAssocIdsRequest struct {
	ctx context.Context
	ApiService RetrievalOfAssociatedIMSPublicIdentitiesApi
	imsUeId string
}

func (r ApiGetImsAssocIdsRequest) Execute() (*ImsAssociatedIdentities, *http.Response, error) {
	return r.ApiService.GetImsAssocIdsExecute(r)
}
...
func (a *RetrievalOfAssociatedIMSPublicIdentitiesApiService) GetImsAssocIdsExecute(r ApiGetImsAssocIdsRequest) (*ImsAssociatedIdentities, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *ImsAssociatedIdentities
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RetrievalOfAssociatedIMSPublicIdentitiesApiService.GetImsAssocIds")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{imsUeId}/identities/ims-associated-identities"
