...
type RetrievalOfTheSCSCFCapabilitiesForTheIMSSubscriptionApi interface {
	...
	*/
	GetScscfCapabilities(ctx context.Context, imsUeId string) ApiGetScscfCapabilitiesRequest

	// GetScscfCapabilitiesExecute executes the request
	//  @return ScscfCapabilityList
	GetScscfCapabilitiesExecute(r ApiGetScscfCapabilitiesRequest) (*ScscfCapabilityList, *http.Response, error)
}
...
type ApiGetScscfCapabilitiesRequest struct {
	ctx context.Context
	ApiService RetrievalOfTheSCSCFCapabilitiesForTheIMSSubscriptionApi
	imsUeId string
}

func (r ApiGetScscfCapabilitiesRequest) Execute() (*ScscfCapabilityList, *http.Response, error) {
	return r.ApiService.GetScscfCapabilitiesExecute(r)
}
...
func (a *RetrievalOfTheSCSCFCapabilitiesForTheIMSSubscriptionApiService) GetScscfCapabilitiesExecute(r ApiGetScscfCapabilitiesRequest) (*ScscfCapabilityList, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *ScscfCapabilityList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RetrievalOfTheSCSCFCapabilitiesForTheIMSSubscriptionApiService.GetScscfCapabilities")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{imsUeId}/ims-data/location-data/scscf-capabilities"
