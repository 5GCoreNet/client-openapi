...
type SDMSubscriptionCreationApi interface {
	...
	*/
	ImsSdmSubscribe(ctx context.Context, imsUeId string) ApiImsSdmSubscribeRequest

	// ImsSdmSubscribeExecute executes the request
	//  @return ImsSdmSubscription
	ImsSdmSubscribeExecute(r ApiImsSdmSubscribeRequest) (*ImsSdmSubscription, *http.Response, error)
}
...
type ApiImsSdmSubscribeRequest struct {
	ctx context.Context
	ApiService SDMSubscriptionCreationApi
	imsUeId string
...
func (r ApiImsSdmSubscribeRequest) Execute() (*ImsSdmSubscription, *http.Response, error) {
	return r.ApiService.ImsSdmSubscribeExecute(r)
}
...
func (a *SDMSubscriptionCreationApiService) ImsSdmSubscribeExecute(r ApiImsSdmSubscribeRequest) (*ImsSdmSubscription, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SDMSubscriptionCreationApiService.ImsSdmSubscribe")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{imsUeId}/subscriptions"
