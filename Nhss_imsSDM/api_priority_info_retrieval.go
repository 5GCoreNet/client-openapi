...
type PriorityInfoRetrievalApi interface {
	...
	*/
	GetPriorityInfo(ctx context.Context, imsUeId string) ApiGetPriorityInfoRequest

	// GetPriorityInfoExecute executes the request
	//  @return PriorityLevels
	GetPriorityInfoExecute(r ApiGetPriorityInfoRequest) (*PriorityLevels, *http.Response, error)
}
...
type ApiGetPriorityInfoRequest struct {
	ctx context.Context
	ApiService PriorityInfoRetrievalApi
	imsUeId string
...
func (r ApiGetPriorityInfoRequest) Execute() (*PriorityLevels, *http.Response, error) {
	return r.ApiService.GetPriorityInfoExecute(r)
}
...
func (a *PriorityInfoRetrievalApiService) GetPriorityInfoExecute(r ApiGetPriorityInfoRequest) (*PriorityLevels, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *PriorityLevels
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PriorityInfoRetrievalApiService.GetPriorityInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{imsUeId}/ims-data/profile-data/priority-levels"
