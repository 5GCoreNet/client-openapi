...
type UpdateRepositoryDataApi interface {
	...
	*/
	UpdateRepositoryDataServInd(ctx context.Context, imsUeId string, serviceIndication string) ApiUpdateRepositoryDataServIndRequest

	// UpdateRepositoryDataServIndExecute executes the request
	//  @return RepositoryData
	UpdateRepositoryDataServIndExecute(r ApiUpdateRepositoryDataServIndRequest) (*RepositoryData, *http.Response, error)
}
...
type ApiUpdateRepositoryDataServIndRequest struct {
	ctx context.Context
	ApiService UpdateRepositoryDataApi
	imsUeId string
...
func (r ApiUpdateRepositoryDataServIndRequest) RepositoryData(repositoryData RepositoryData) ApiUpdateRepositoryDataServIndRequest {
	r.repositoryData = &repositoryData
	return r
}

func (r ApiUpdateRepositoryDataServIndRequest) Execute() (*RepositoryData, *http.Response, error) {
	return r.ApiService.UpdateRepositoryDataServIndExecute(r)
}
...
func (a *UpdateRepositoryDataApiService) UpdateRepositoryDataServIndExecute(r ApiUpdateRepositoryDataServIndRequest) (*RepositoryData, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UpdateRepositoryDataApiService.UpdateRepositoryDataServInd")
	if err != nil {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"serviceIndication"+"}", url.PathEscape(parameterToString(r.serviceIndication, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.repositoryData == nil {
		return localVarReturnValue, nil, reportError("repositoryData is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.repositoryData
