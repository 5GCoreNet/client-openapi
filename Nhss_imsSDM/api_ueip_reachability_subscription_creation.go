...
type UEIPReachabilitySubscriptionCreationApi interface {
	...
	*/
	UeReachIpSubscribe(ctx context.Context, imsUeId string) ApiUeReachIpSubscribeRequest

	// UeReachIpSubscribeExecute executes the request
	//  @return CreatedUeReachabilitySubscription
	UeReachIpSubscribeExecute(r ApiUeReachIpSubscribeRequest) (*CreatedUeReachabilitySubscription, *http.Response, error)
}
...
type ApiUeReachIpSubscribeRequest struct {
	ctx context.Context
	ApiService UEIPReachabilitySubscriptionCreationApi
	imsUeId string
