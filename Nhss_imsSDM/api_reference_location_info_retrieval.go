...
type ReferenceLocationInfoRetrievalApi interface {
	...
	*/
	GetReferenceLocationInfo(ctx context.Context, imsUeId string) ApiGetReferenceLocationInfoRequest

	// GetReferenceLocationInfoExecute executes the request
	//  @return ReferenceLocationInformation
	GetReferenceLocationInfoExecute(r ApiGetReferenceLocationInfoRequest) (*ReferenceLocationInformation, *http.Response, error)
}
...
type ApiGetReferenceLocationInfoRequest struct {
	ctx context.Context
	ApiService ReferenceLocationInfoRetrievalApi
	imsUeId string
...
func (r ApiGetReferenceLocationInfoRequest) Execute() (*ReferenceLocationInformation, *http.Response, error) {
	return r.ApiService.GetReferenceLocationInfoExecute(r)
}
...
func (a *ReferenceLocationInfoRetrievalApiService) GetReferenceLocationInfoExecute(r ApiGetReferenceLocationInfoRequest) (*ReferenceLocationInformation, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *ReferenceLocationInformation
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReferenceLocationInfoRetrievalApiService.GetReferenceLocationInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{imsUeId}/access-data/wireline-domain/reference-location"
