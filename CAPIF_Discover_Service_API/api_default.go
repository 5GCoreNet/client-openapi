...
type DefaultApi interface {
	...
	*/
	AllServiceAPIsGet(ctx context.Context) ApiAllServiceAPIsGetRequest

	// AllServiceAPIsGetExecute executes the request
	//  @return DiscoveredAPIs
	AllServiceAPIsGetExecute(r ApiAllServiceAPIsGetRequest) (*DiscoveredAPIs, *http.Response, error)
}
