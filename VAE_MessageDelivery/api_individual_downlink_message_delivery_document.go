...
type IndividualDownlinkMessageDeliveryDocumentApi interface {
	...
	*/
	ReadIndividualDownlinkMessageDelivery(ctx context.Context, subscriptionId string, dlDeliveryId string) ApiReadIndividualDownlinkMessageDeliveryRequest

	// ReadIndividualDownlinkMessageDeliveryExecute executes the request
	//  @return DownlinkMessageDeliveryData
	ReadIndividualDownlinkMessageDeliveryExecute(r ApiReadIndividualDownlinkMessageDeliveryRequest) (*DownlinkMessageDeliveryData, *http.Response, error)
}
...
type ApiReadIndividualDownlinkMessageDeliveryRequest struct {
	ctx context.Context
	ApiService IndividualDownlinkMessageDeliveryDocumentApi
...
func (a *IndividualDownlinkMessageDeliveryDocumentApiService) ReadIndividualDownlinkMessageDeliveryExecute(r ApiReadIndividualDownlinkMessageDeliveryRequest) (*DownlinkMessageDeliveryData, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"dlDeliveryId"+"}", url.PathEscape(parameterToString(r.dlDeliveryId, "")), -1)
