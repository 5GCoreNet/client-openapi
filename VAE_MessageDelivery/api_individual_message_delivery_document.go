...
type IndividualMessageDeliveryDocumentApi interface {
	...
	*/
	DeleteMessageDelivery(ctx context.Context, subscriptionId string, dlDeliveryId string) ApiDeleteMessageDeliveryRequest

	// DeleteMessageDeliveryExecute executes the request
	DeleteMessageDeliveryExecute(r ApiDeleteMessageDeliveryRequest) (*http.Response, error)
}
...
type ApiDeleteMessageDeliveryRequest struct {
	ctx context.Context
	ApiService IndividualMessageDeliveryDocumentApi
	subscriptionId string
	dlDeliveryId string
}

func (r ApiDeleteMessageDeliveryRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteMessageDeliveryExecute(r)
}
