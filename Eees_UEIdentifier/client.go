...
// APIClient manages communication with the EES UE Identifier Service API v1.0.0
...
type APIClient struct {
	...
	FetchUEIdentifierApi *FetchUEIdentifierApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.FetchUEIdentifierApi = (*FetchUEIdentifierApiService)(&c.common)
