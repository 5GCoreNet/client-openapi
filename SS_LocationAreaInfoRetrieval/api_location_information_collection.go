...
type LocationInformationCollectionApi interface {
	...
	*/
	RetrieveUeLocInfo(ctx context.Context) ApiRetrieveUeLocInfoRequest

	// RetrieveUeLocInfoExecute executes the request
	//  @return []LMInformation
	RetrieveUeLocInfoExecute(r ApiRetrieveUeLocInfoRequest) ([]LMInformation, *http.Response, error)
}
...
type ApiRetrieveUeLocInfoRequest struct {
	ctx context.Context
	ApiService LocationInformationCollectionApi
