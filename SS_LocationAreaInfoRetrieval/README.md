# Go API client for openapi_SS_LocationAreaInfoRetrieval
...
```golang
import openapi_SS_LocationAreaInfoRetrieval "///openapi_SS_LocationAreaInfoRetrieval"
```
...
```golang
ctx := context.WithValue(context.Background(), openapi_SS_LocationAreaInfoRetrieval.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), openapi_SS_LocationAreaInfoRetrieval.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), openapi_SS_LocationAreaInfoRetrieval.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), openapi_SS_LocationAreaInfoRetrieval.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*LocationInformationCollectionApi* | [**RetrieveUeLocInfo**](docs/LocationInformationCollectionApi.md#retrieveuelocinfo) | **Get** /location-retrievals | 
