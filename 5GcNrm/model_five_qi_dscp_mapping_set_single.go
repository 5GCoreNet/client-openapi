...
func NewFiveQiDscpMappingSetSingle(id NullableString) *FiveQiDscpMappingSetSingle {
	this := FiveQiDscpMappingSetSingle{}
	this.Id = id
	return &this
}
...
type NullableFiveQiDscpMappingSetSingle struct {
	value *FiveQiDscpMappingSetSingle
	isSet bool
}
...
func NewNullableFiveQiDscpMappingSetSingle(val *FiveQiDscpMappingSetSingle) *NullableFiveQiDscpMappingSetSingle {
	return &NullableFiveQiDscpMappingSetSingle{value: val, isSet: true}
}
