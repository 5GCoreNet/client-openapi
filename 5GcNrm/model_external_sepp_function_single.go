...
func NewExternalSeppFunctionSingle(id NullableString) *ExternalSeppFunctionSingle {
	this := ExternalSeppFunctionSingle{}
	this.Id = id
	return &this
}
...
type NullableExternalSeppFunctionSingle struct {
	value *ExternalSeppFunctionSingle
	isSet bool
}
...
func NewNullableExternalSeppFunctionSingle(val *ExternalSeppFunctionSingle) *NullableExternalSeppFunctionSingle {
	return &NullableExternalSeppFunctionSingle{value: val, isSet: true}
}
