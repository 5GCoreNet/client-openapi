...
type UECMRegistrationInfoRetrievalApi interface {
	...
	*/
	...
	GetRegistrationsExecute(r ApiGetRegistrationsRequest) (*RegistrationDataSets, *http.Response, error)
}
...
func (a *UECMRegistrationInfoRetrievalApiService) GetRegistrationsExecute(r ApiGetRegistrationsRequest) (*RegistrationDataSets, *http.Response, error) {
	...
	localVarQueryParams.Add("registration-dataset-names", parameterToString(*r.registrationDatasetNames, "csv"))
