...
type NWDAFRegistrationApi interface {
	...
	*/
	...
	NwdafRegistrationExecute(r ApiNwdafRegistrationRequest) (*NwdafRegistration, *http.Response, error)
}
...
func (a *NWDAFRegistrationApiService) NwdafRegistrationExecute(r ApiNwdafRegistrationRequest) (*NwdafRegistration, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"nwdafRegistrationId"+"}", url.PathEscape(parameterToString(r.nwdafRegistrationId, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.nwdafRegistration == nil {
		return localVarReturnValue, nil, reportError("nwdafRegistration is required and must be specified")
	}
