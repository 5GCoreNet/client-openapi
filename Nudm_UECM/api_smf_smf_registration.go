...
type SMFSmfRegistrationApi interface {
	...
	*/
	...
	GetSmfRegistrationExecute(r ApiGetSmfRegistrationRequest) (*SmfRegistrationInfo, *http.Response, error)
	...
	*/
	...
	RegistrationExecute(r ApiRegistrationRequest) (*SmfRegistration, *http.Response, error)
}
