...
type DataReportingProvisioningSessionsApi interface {
	...
	*/
	CreateDataRepProvSession(ctx context.Context) ApiCreateDataRepProvSessionRequest

	// CreateDataRepProvSessionExecute executes the request
	//  @return DataReportingProvisioningSession
	CreateDataRepProvSessionExecute(r ApiCreateDataRepProvSessionRequest) (*DataReportingProvisioningSession, *http.Response, error)
}
...
type ApiCreateDataRepProvSessionRequest struct {
	ctx context.Context
	ApiService DataReportingProvisioningSessionsApi
...
func (r ApiCreateDataRepProvSessionRequest) Execute() (*DataReportingProvisioningSession, *http.Response, error) {
	return r.ApiService.CreateDataRepProvSessionExecute(r)
}
