...
type DataReportingConfigurationsApi interface {
	...
	*/
	CreateDataRepConfig(ctx context.Context, sessionId string) ApiCreateDataRepConfigRequest

	// CreateDataRepConfigExecute executes the request
	//  @return DataReportingConfiguration
	CreateDataRepConfigExecute(r ApiCreateDataRepConfigRequest) (*DataReportingConfiguration, *http.Response, error)
}
...
type ApiCreateDataRepConfigRequest struct {
	ctx context.Context
	ApiService DataReportingConfigurationsApi
	sessionId string
