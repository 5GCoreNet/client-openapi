...
type IndividualDataReportingProvisioningSessionApi interface {
	...
	*/
	DeleteIndDataRepProvSession(ctx context.Context, sessionId string) ApiDeleteIndDataRepProvSessionRequest

	// DeleteIndDataRepProvSessionExecute executes the request
	DeleteIndDataRepProvSessionExecute(r ApiDeleteIndDataRepProvSessionRequest) (*http.Response, error)
	...
	*/
	GetIndDataRepProvSession(ctx context.Context, sessionId string) ApiGetIndDataRepProvSessionRequest

	// GetIndDataRepProvSessionExecute executes the request
	//  @return DataReportingProvisioningSession
	GetIndDataRepProvSessionExecute(r ApiGetIndDataRepProvSessionRequest) (*DataReportingProvisioningSession, *http.Response, error)
}
...
type ApiDeleteIndDataRepProvSessionRequest struct {
	ctx context.Context
	ApiService IndividualDataReportingProvisioningSessionApi
	sessionId string
}
