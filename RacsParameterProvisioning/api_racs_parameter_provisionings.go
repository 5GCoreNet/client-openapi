...
type RACSParameterProvisioningsApi interface {
	...
	*/
	CreateRACSParameterProvisioning(ctx context.Context, scsAsId string) ApiCreateRACSParameterProvisioningRequest

	// CreateRACSParameterProvisioningExecute executes the request
	//  @return RacsProvisioningData
	CreateRACSParameterProvisioningExecute(r ApiCreateRACSParameterProvisioningRequest) (*RacsProvisioningData, *http.Response, error)
	...
	*/
	...
	// FetchAllRACSParameterProvisioningsExecute executes the request
	//  @return []RacsProvisioningData
	FetchAllRACSParameterProvisioningsExecute(r ApiFetchAllRACSParameterProvisioningsRequest) ([]RacsProvisioningData, *http.Response, error)
}
...
type ApiCreateRACSParameterProvisioningRequest struct {
	ctx context.Context
	ApiService RACSParameterProvisioningsApi
	scsAsId string
