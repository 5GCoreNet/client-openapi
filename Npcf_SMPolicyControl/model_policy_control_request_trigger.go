...
type PolicyControlRequestTrigger struct {
	PolicyControlRequestTriggerAnyOf *PolicyControlRequestTriggerAnyOf
	string *string
}
...
func (dst *PolicyControlRequestTrigger) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into PolicyControlRequestTriggerAnyOf
	err = json.Unmarshal(data, &dst.PolicyControlRequestTriggerAnyOf);
	if err == nil {
		jsonPolicyControlRequestTriggerAnyOf, _ := json.Marshal(dst.PolicyControlRequestTriggerAnyOf)
		if string(jsonPolicyControlRequestTriggerAnyOf) == "{}" { // empty struct
			dst.PolicyControlRequestTriggerAnyOf = nil
		} else {
			return nil // data stored in dst.PolicyControlRequestTriggerAnyOf, return on the first match
		}
	} else {
		dst.PolicyControlRequestTriggerAnyOf = nil
	}
...
func (src *PolicyControlRequestTrigger) MarshalJSON() ([]byte, error) {
	if src.PolicyControlRequestTriggerAnyOf != nil {
		return json.Marshal(&src.PolicyControlRequestTriggerAnyOf)
	}
