...
type IndividualAnalyticsExposureSubscriptionApi interface {
	...
	*/
	...
	FullyUpdateAnSubscriptionExecute(r ApiFullyUpdateAnSubscriptionRequest) (*AnalyticsExposureSubsc, *http.Response, error)
	...
	*/
	...
	//  @return AnalyticsExposureSubsc
	ReadAnSubscriptionExecute(r ApiReadAnSubscriptionRequest) (*AnalyticsExposureSubsc, *http.Response, error)
}
...
type ApiDeleteAnSubscriptionRequest struct {
	ctx context.Context
	ApiService IndividualAnalyticsExposureSubscriptionApi
	afId string
