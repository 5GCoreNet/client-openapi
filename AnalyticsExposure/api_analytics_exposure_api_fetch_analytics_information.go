...
type AnalyticsExposureAPIFetchAnalyticsInformationApi interface {
	...
	*/
	...
	// FetchAnalyticsInfoExecute executes the request
	//  @return AnalyticsData
	FetchAnalyticsInfoExecute(r ApiFetchAnalyticsInfoRequest) (*AnalyticsData, *http.Response, error)
}
...
type ApiFetchAnalyticsInfoRequest struct {
	ctx context.Context
	ApiService AnalyticsExposureAPIFetchAnalyticsInformationApi
	afId string
