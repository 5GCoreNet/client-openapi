...
type AnalyticsExposureSubscriptionsApi interface {
	...
	*/
	...
	CreateNewSubscriptionExecute(r ApiCreateNewSubscriptionRequest) (*AnalyticsExposureSubsc, *http.Response, error)
	...
	*/
	...
	//  @return []AnalyticsExposureSubsc
	ReadAllSubscriptionsExecute(r ApiReadAllSubscriptionsRequest) ([]AnalyticsExposureSubsc, *http.Response, error)
}
...
type ApiCreateNewSubscriptionRequest struct {
	ctx context.Context
	ApiService AnalyticsExposureSubscriptionsApi
	afId string
