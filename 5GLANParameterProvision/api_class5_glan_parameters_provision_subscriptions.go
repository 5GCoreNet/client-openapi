...
type Class5GLANParametersProvisionSubscriptionsApi interface {
	...
	*/
	...
	CreateAnSubscriptionExecute(r ApiCreateAnSubscriptionRequest) (*Model5GLanParametersProvision, *http.Response, error)
	...
	*/
	...
	// RealAllSubscriptionsExecute executes the request
	//  @return []Model5GLanParametersProvision
	RealAllSubscriptionsExecute(r ApiRealAllSubscriptionsRequest) ([]Model5GLanParametersProvision, *http.Response, error)
}
...
type ApiCreateAnSubscriptionRequest struct {
	ctx context.Context
	ApiService Class5GLANParametersProvisionSubscriptionsApi
	afId string
