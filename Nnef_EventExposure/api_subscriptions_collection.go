...
type SubscriptionsCollectionApi interface {
	...
	*/
	...
	CreateIndividualSubcriptionExecute(r ApiCreateIndividualSubcriptionRequest) (*NefEventExposureSubsc, *http.Response, error)
}
...
func (r ApiCreateIndividualSubcriptionRequest) Execute() (*NefEventExposureSubsc, *http.Response, error) {
...
//  @return NefEventExposureSubsc
func (a *SubscriptionsCollectionApiService) CreateIndividualSubcriptionExecute(r ApiCreateIndividualSubcriptionRequest) (*NefEventExposureSubsc, *http.Response, error) {
	var (
