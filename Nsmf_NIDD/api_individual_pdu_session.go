...
type IndividualPDUSessionApi interface {
	...
	*/
	Deliver(ctx context.Context, pduSessionRef string) ApiDeliverRequest
...
type ApiDeliverRequest struct {
	ctx context.Context
	ApiService IndividualPDUSessionApi
...
func (a *IndividualPDUSessionApiService) DeliverExecute(r ApiDeliverRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"pduSessionRef"+"}", url.PathEscape(parameterToString(r.pduSessionRef, "")), -1)
