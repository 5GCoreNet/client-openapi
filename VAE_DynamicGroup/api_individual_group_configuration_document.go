...
type IndividualGroupConfigurationDocumentApi interface {
	...
	*/
	DeleteGroupConfiguration(ctx context.Context, configId string) ApiDeleteGroupConfigurationRequest

	// DeleteGroupConfigurationExecute executes the request
	DeleteGroupConfigurationExecute(r ApiDeleteGroupConfigurationRequest) (*http.Response, error)
	...
	*/
	ReadDynamicGroupConfiguration(ctx context.Context, configId string) ApiReadDynamicGroupConfigurationRequest

	// ReadDynamicGroupConfigurationExecute executes the request
	//  @return GroupConfigurationData
	ReadDynamicGroupConfigurationExecute(r ApiReadDynamicGroupConfigurationRequest) (*GroupConfigurationData, *http.Response, error)
}
...
type ApiDeleteGroupConfigurationRequest struct {
	ctx context.Context
	ApiService IndividualGroupConfigurationDocumentApi
	configId string
}
