...
type DefaultApi interface {
	...
	*/
	NotificationSinkPost(ctx context.Context) ApiNotificationSinkPostRequest

	// NotificationSinkPostExecute executes the request
	NotificationSinkPostExecute(r ApiNotificationSinkPostRequest) (*http.Response, error)
}
