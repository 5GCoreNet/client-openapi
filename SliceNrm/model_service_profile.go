...
// GetV2XModels returns the V2XModels field value if set, zero value otherwise.
func (o *ServiceProfile) GetV2XModels() V2XCommModels {
	if o == nil || isNil(o.V2XModels) {
...
// GetV2XModelsOk returns a tuple with the V2XModels field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServiceProfile) GetV2XModelsOk() (*V2XCommModels, bool) {
	if o == nil || isNil(o.V2XModels) {
    return nil, false
	}
	return o.V2XModels, true
}
...
// SetV2XModels gets a reference to the given V2XCommModels and assigns it to the V2XModels field.
...
func (o ServiceProfile) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.V2XModels) {
		toSerialize["v2XModels"] = o.V2XModels
	}
