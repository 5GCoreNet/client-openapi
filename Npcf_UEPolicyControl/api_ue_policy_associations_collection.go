...
type UEPolicyAssociationsCollectionApi interface {
	...
	*/
	CreateIndividualUEPolicyAssociation(ctx context.Context) ApiCreateIndividualUEPolicyAssociationRequest

	// CreateIndividualUEPolicyAssociationExecute executes the request
	//  @return PolicyAssociation
	CreateIndividualUEPolicyAssociationExecute(r ApiCreateIndividualUEPolicyAssociationRequest) (*PolicyAssociation, *http.Response, error)
}
...
type ApiCreateIndividualUEPolicyAssociationRequest struct {
	ctx context.Context
	ApiService UEPolicyAssociationsCollectionApi
