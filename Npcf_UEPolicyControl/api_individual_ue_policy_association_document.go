...
type IndividualUEPolicyAssociationDocumentApi interface {
	...
	*/
	DeleteIndividualUEPolicyAssociation(ctx context.Context, polAssoId string) ApiDeleteIndividualUEPolicyAssociationRequest

	// DeleteIndividualUEPolicyAssociationExecute executes the request
	DeleteIndividualUEPolicyAssociationExecute(r ApiDeleteIndividualUEPolicyAssociationRequest) (*http.Response, error)
	...
	*/
	ReadIndividualUEPolicyAssociation(ctx context.Context, polAssoId string) ApiReadIndividualUEPolicyAssociationRequest

	// ReadIndividualUEPolicyAssociationExecute executes the request
	//  @return PolicyAssociation
	ReadIndividualUEPolicyAssociationExecute(r ApiReadIndividualUEPolicyAssociationRequest) (*PolicyAssociation, *http.Response, error)
	...
	*/
	ReportObservedEventTriggersForIndividualUEPolicyAssociation(ctx context.Context, polAssoId string) ApiReportObservedEventTriggersForIndividualUEPolicyAssociationRequest

	// ReportObservedEventTriggersForIndividualUEPolicyAssociationExecute executes the request
	//  @return PolicyUpdate
	ReportObservedEventTriggersForIndividualUEPolicyAssociationExecute(r ApiReportObservedEventTriggersForIndividualUEPolicyAssociationRequest) (*PolicyUpdate, *http.Response, error)
}
...
type ApiDeleteIndividualUEPolicyAssociationRequest struct {
	ctx context.Context
	ApiService IndividualUEPolicyAssociationDocumentApi
	polAssoId string
}
...
func (a *IndividualUEPolicyAssociationDocumentApiService) DeleteIndividualUEPolicyAssociationExecute(r ApiDeleteIndividualUEPolicyAssociationRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"polAssoId"+"}", url.PathEscape(parameterToString(r.polAssoId, "")), -1)
