...
type ACSConfigurationSubscriptionsApi interface {
	...
	*/
	...
	CreateAnSubscriptionExecute(r ApiCreateAnSubscriptionRequest) (*AcsConfigurationData, *http.Response, error)
	...
	*/
	...
	//  @return []AcsConfigurationData
	ReadAllSubscriptionsExecute(r ApiReadAllSubscriptionsRequest) ([]AcsConfigurationData, *http.Response, error)
}
...
type ApiCreateAnSubscriptionRequest struct {
	ctx context.Context
	ApiService ACSConfigurationSubscriptionsApi
	afId string
