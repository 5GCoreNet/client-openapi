...
type NFInstancesStoreApi interface {
	...
	*/
	...
	//  @return SearchResult
	SearchNFInstancesExecute(r ApiSearchNFInstancesRequest) (*SearchResult, *http.Response, error)
}
...
func (a *NFInstancesStoreApiService) SearchNFInstancesExecute(r ApiSearchNFInstancesRequest) (*SearchResult, *http.Response, error) {
	...
	if r.ipv4Index != nil {
		localVarQueryParams.Add("ipv4-index", parameterToString(*r.ipv4Index, ""))
	}
	if r.ipv6Index != nil {
		localVarQueryParams.Add("ipv6-index", parameterToString(*r.ipv6Index, ""))
	}
	if r.nsiList != nil {
	...
	if r.extPreferredLocality != nil {
		localVarQueryParams.Add("ext-preferred-locality", parameterToString(*r.extPreferredLocality, ""))
	}
	if r.accessType != nil {
	...
	if r.remoteSnpnId != nil {
		localVarQueryParams.Add("remote-snpn-id", parameterToString(*r.remoteSnpnId, ""))
	}
	...
	if r.ismfSupportInd != nil {
		localVarQueryParams.Add("ismf-support-ind", parameterToString(*r.ismfSupportInd, ""))
	}
	if r.nrfDiscUri != nil {
	...
	if r.mlAnalyticsInfoList != nil {
		localVarQueryParams.Add("ml-analytics-info-list", parameterToString(*r.mlAnalyticsInfoList, "csv"))
	}
	...
	if r.targetNwResolution != nil {
		localVarQueryParams.Add("target-nw-resolution", parameterToString(*r.targetNwResolution, ""))
	}
	if r.excludeNfinstList != nil {
		localVarQueryParams.Add("exclude-nfinst-list", parameterToString(*r.excludeNfinstList, "csv"))
	}
	if r.excludeNfservinstList != nil {
		localVarQueryParams.Add("exclude-nfservinst-list", parameterToString(*r.excludeNfservinstList, "csv"))
	}
	if r.excludeNfservicesetList != nil {
		localVarQueryParams.Add("exclude-nfserviceset-list", parameterToString(*r.excludeNfservicesetList, "csv"))
	}
	if r.excludeNfsetList != nil {
		localVarQueryParams.Add("exclude-nfset-list", parameterToString(*r.excludeNfsetList, "csv"))
	}
	if r.preferredAnalyticsDelays != nil {
		localVarQueryParams.Add("preferred-analytics-delays", parameterToString(*r.preferredAnalyticsDelays, ""))
	}
