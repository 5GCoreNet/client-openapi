...
type IntegrityAlgorithm struct {
	IntegrityAlgorithmAnyOf *IntegrityAlgorithmAnyOf
	string *string
}
...
func (dst *IntegrityAlgorithm) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into IntegrityAlgorithmAnyOf
	err = json.Unmarshal(data, &dst.IntegrityAlgorithmAnyOf);
	if err == nil {
		jsonIntegrityAlgorithmAnyOf, _ := json.Marshal(dst.IntegrityAlgorithmAnyOf)
		if string(jsonIntegrityAlgorithmAnyOf) == "{}" { // empty struct
			dst.IntegrityAlgorithmAnyOf = nil
		} else {
			return nil // data stored in dst.IntegrityAlgorithmAnyOf, return on the first match
		}
	} else {
		dst.IntegrityAlgorithmAnyOf = nil
	}
...
func (src *IntegrityAlgorithm) MarshalJSON() ([]byte, error) {
	if src.IntegrityAlgorithmAnyOf != nil {
		return json.Marshal(&src.IntegrityAlgorithmAnyOf)
	}
