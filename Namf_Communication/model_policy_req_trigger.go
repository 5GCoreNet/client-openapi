...
type PolicyReqTrigger struct {
	PolicyReqTriggerAnyOf *PolicyReqTriggerAnyOf
	string *string
}
...
func (dst *PolicyReqTrigger) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into PolicyReqTriggerAnyOf
	err = json.Unmarshal(data, &dst.PolicyReqTriggerAnyOf);
	if err == nil {
		jsonPolicyReqTriggerAnyOf, _ := json.Marshal(dst.PolicyReqTriggerAnyOf)
		if string(jsonPolicyReqTriggerAnyOf) == "{}" { // empty struct
			dst.PolicyReqTriggerAnyOf = nil
		} else {
			return nil // data stored in dst.PolicyReqTriggerAnyOf, return on the first match
		}
	} else {
		dst.PolicyReqTriggerAnyOf = nil
	}
...
func (src *PolicyReqTrigger) MarshalJSON() ([]byte, error) {
	if src.PolicyReqTriggerAnyOf != nil {
		return json.Marshal(&src.PolicyReqTriggerAnyOf)
	}
