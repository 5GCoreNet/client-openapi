...
type IndividualSubscriptionDocumentApi interface {
	...
	*/
	AMFStatusChangeSubscribeModfy(ctx context.Context, subscriptionId string) ApiAMFStatusChangeSubscribeModfyRequest

	// AMFStatusChangeSubscribeModfyExecute executes the request
	//  @return SubscriptionData
	AMFStatusChangeSubscribeModfyExecute(r ApiAMFStatusChangeSubscribeModfyRequest) (*SubscriptionData, *http.Response, error)
