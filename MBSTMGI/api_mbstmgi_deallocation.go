...
type MBSTMGIDeallocationApi interface {

	/*
	DeallocateTmgi Request the deallocation of MBS TMGI(s).

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiDeallocateTmgiRequest
	*/
	DeallocateTmgi(ctx context.Context) ApiDeallocateTmgiRequest

	// DeallocateTmgiExecute executes the request
	DeallocateTmgiExecute(r ApiDeallocateTmgiRequest) (*http.Response, error)
}

// MBSTMGIDeallocationApiService MBSTMGIDeallocationApi service
type MBSTMGIDeallocationApiService service

type ApiDeallocateTmgiRequest struct {
	ctx context.Context
	ApiService MBSTMGIDeallocationApi
	tmgiDeallocRequest *TmgiDeallocRequest
}

func (r ApiDeallocateTmgiRequest) TmgiDeallocRequest(tmgiDeallocRequest TmgiDeallocRequest) ApiDeallocateTmgiRequest {
	r.tmgiDeallocRequest = &tmgiDeallocRequest
	return r
}

func (r ApiDeallocateTmgiRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeallocateTmgiExecute(r)
}
...
func (a *MBSTMGIDeallocationApiService) DeallocateTmgiExecute(r ApiDeallocateTmgiRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MBSTMGIDeallocationApiService.DeallocateTmgi")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/deallocate"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.tmgiDeallocRequest == nil {
		return nil, reportError("tmgiDeallocRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.tmgiDeallocRequest
