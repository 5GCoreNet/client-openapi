...
type TMGIAllocationOrTimerExpiryRefreshApi interface {
	...
	*/
	...
	AllocateTmgiExecute(r ApiAllocateTmgiRequest) (*TmgiAllocResponse, *http.Response, error)
}
...
type ApiAllocateTmgiRequest struct {
	ctx context.Context
	ApiService TMGIAllocationOrTimerExpiryRefreshApi
