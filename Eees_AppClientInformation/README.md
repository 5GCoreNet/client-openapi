# Go API client for Eees_AppClientInformation
...
```golang
import Eees_AppClientInformation "//"
```
...
```golang
ctx := context.WithValue(context.Background(), Eees_AppClientInformation.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), Eees_AppClientInformation.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), Eees_AppClientInformation.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), Eees_AppClientInformation.ContextOperationServerVariables, map[string]map[string]string{
