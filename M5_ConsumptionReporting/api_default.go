...
type DefaultApi interface {
	...
	*/
	SubmitConsumptionReport(ctx context.Context, aspId string) ApiSubmitConsumptionReportRequest

	// SubmitConsumptionReportExecute executes the request
	SubmitConsumptionReportExecute(r ApiSubmitConsumptionReportRequest) (*http.Response, error)
}
...
func (a *DefaultApiService) SubmitConsumptionReportExecute(r ApiSubmitConsumptionReportRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"aspId"+"}", url.PathEscape(parameterToString(r.aspId, "")), -1)
