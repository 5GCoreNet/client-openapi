...
type RedundantTransmissionType struct {
	RedundantTransmissionTypeAnyOf *RedundantTransmissionTypeAnyOf
	string *string
}
...
func (dst *RedundantTransmissionType) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into RedundantTransmissionTypeAnyOf
	err = json.Unmarshal(data, &dst.RedundantTransmissionTypeAnyOf);
	if err == nil {
		jsonRedundantTransmissionTypeAnyOf, _ := json.Marshal(dst.RedundantTransmissionTypeAnyOf)
		if string(jsonRedundantTransmissionTypeAnyOf) == "{}" { // empty struct
			dst.RedundantTransmissionTypeAnyOf = nil
		} else {
			return nil // data stored in dst.RedundantTransmissionTypeAnyOf, return on the first match
		}
	} else {
		dst.RedundantTransmissionTypeAnyOf = nil
	}
...
func (src *RedundantTransmissionType) MarshalJSON() ([]byte, error) {
	if src.RedundantTransmissionTypeAnyOf != nil {
		return json.Marshal(&src.RedundantTransmissionTypeAnyOf)
	}
