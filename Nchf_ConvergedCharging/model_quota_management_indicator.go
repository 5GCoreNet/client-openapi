...
type QuotaManagementIndicator struct {
	QuotaManagementIndicatorAnyOf *QuotaManagementIndicatorAnyOf
	string *string
}
...
func (dst *QuotaManagementIndicator) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into QuotaManagementIndicatorAnyOf
	err = json.Unmarshal(data, &dst.QuotaManagementIndicatorAnyOf);
	if err == nil {
		jsonQuotaManagementIndicatorAnyOf, _ := json.Marshal(dst.QuotaManagementIndicatorAnyOf)
		if string(jsonQuotaManagementIndicatorAnyOf) == "{}" { // empty struct
			dst.QuotaManagementIndicatorAnyOf = nil
		} else {
			return nil // data stored in dst.QuotaManagementIndicatorAnyOf, return on the first match
		}
	} else {
		dst.QuotaManagementIndicatorAnyOf = nil
	}
...
func (src *QuotaManagementIndicator) MarshalJSON() ([]byte, error) {
	if src.QuotaManagementIndicatorAnyOf != nil {
		return json.Marshal(&src.QuotaManagementIndicatorAnyOf)
	}
