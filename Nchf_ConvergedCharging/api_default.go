...
type DefaultApi interface {
	...
	*/
	ChargingdataChargingDataRefReleasePost(ctx context.Context, chargingDataRef string) ApiChargingdataChargingDataRefReleasePostRequest

	// ChargingdataChargingDataRefReleasePostExecute executes the request
	ChargingdataChargingDataRefReleasePostExecute(r ApiChargingdataChargingDataRefReleasePostRequest) (*http.Response, error)
	...
	*/
	ChargingdataChargingDataRefUpdatePost(ctx context.Context, chargingDataRef string) ApiChargingdataChargingDataRefUpdatePostRequest

	// ChargingdataChargingDataRefUpdatePostExecute executes the request
	//  @return ChargingDataResponse
	ChargingdataChargingDataRefUpdatePostExecute(r ApiChargingdataChargingDataRefUpdatePostRequest) (*ChargingDataResponse, *http.Response, error)
	...
	*/
	ChargingdataPost(ctx context.Context) ApiChargingdataPostRequest

	// ChargingdataPostExecute executes the request
	//  @return ChargingDataResponse
	ChargingdataPostExecute(r ApiChargingdataPostRequest) (*ChargingDataResponse, *http.Response, error)
}
...
func (a *DefaultApiService) ChargingdataChargingDataRefReleasePostExecute(r ApiChargingdataChargingDataRefReleasePostRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"ChargingDataRef"+"}", url.PathEscape(parameterToString(r.chargingDataRef, "")), -1)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 404 {
			var v ChargingdataPost400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarHTTPResponse, newErr
