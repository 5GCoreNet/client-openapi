...
type TrafficForwardingWay struct {
	TrafficForwardingWayAnyOf *TrafficForwardingWayAnyOf
	string *string
}
...
func (dst *TrafficForwardingWay) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into TrafficForwardingWayAnyOf
	err = json.Unmarshal(data, &dst.TrafficForwardingWayAnyOf);
	if err == nil {
		jsonTrafficForwardingWayAnyOf, _ := json.Marshal(dst.TrafficForwardingWayAnyOf)
		if string(jsonTrafficForwardingWayAnyOf) == "{}" { // empty struct
			dst.TrafficForwardingWayAnyOf = nil
		} else {
			return nil // data stored in dst.TrafficForwardingWayAnyOf, return on the first match
		}
	} else {
		dst.TrafficForwardingWayAnyOf = nil
	}
...
func (src *TrafficForwardingWay) MarshalJSON() ([]byte, error) {
	if src.TrafficForwardingWayAnyOf != nil {
		return json.Marshal(&src.TrafficForwardingWayAnyOf)
	}
