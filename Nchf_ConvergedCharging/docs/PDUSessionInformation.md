...
**DnnSelectionMode** | Pointer to [**DnnSelectionMode**](DnnSelectionMode.md) |  | [optional] 
...
**RedundantTransmissionType** | Pointer to [**RedundantTransmissionType**](RedundantTransmissionType.md) |  | [optional] 
**PDUSessionPairID** | Pointer to **int32** | Integer where the allowed values correspond to the value range of an unsigned 32-bit integer.  | [optional] 
**CpCIoTOptimisationIndicator** | Pointer to **bool** |  | [optional] 
**Var5GSControlPlaneOnlyIndicator** | Pointer to **bool** |  | [optional] 
**SmallDataRateControlIndicator** | Pointer to **bool** |  | [optional] 
**Var5GLANTypeService** | Pointer to [**Model5GLANTypeService**](Model5GLANTypeService.md) |  | [optional] 
...
### HasCpCIoTOptimisationIndicator
