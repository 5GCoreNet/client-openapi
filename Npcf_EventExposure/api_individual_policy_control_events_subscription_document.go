...
type IndividualPolicyControlEventsSubscriptionDocumentApi interface {
	...
	*/
	...
	// DeletePcEventExposureSubscExecute executes the request
	DeletePcEventExposureSubscExecute(r ApiDeletePcEventExposureSubscRequest) (*http.Response, error)
	...
	*/
	GetPcEventExposureSubsc(ctx context.Context, subscriptionId string) ApiGetPcEventExposureSubscRequest

	// GetPcEventExposureSubscExecute executes the request
	//  @return PcEventExposureSubsc
	GetPcEventExposureSubscExecute(r ApiGetPcEventExposureSubscRequest) (*PcEventExposureSubsc, *http.Response, error)
	...
	*/
	PutPcEventExposureSubsc(ctx context.Context, subscriptionId string) ApiPutPcEventExposureSubscRequest

	// PutPcEventExposureSubscExecute executes the request
	//  @return PcEventExposureSubsc
	PutPcEventExposureSubscExecute(r ApiPutPcEventExposureSubscRequest) (*PcEventExposureSubsc, *http.Response, error)
}
...
type ApiDeletePcEventExposureSubscRequest struct {
	ctx context.Context
	ApiService IndividualPolicyControlEventsSubscriptionDocumentApi
