...
type PolicyControlEventsSubscriptionCollectionApi interface {

	/*
	PostPcEventExposureSubsc Creates a new Individual Policy Control Events Subscription resource

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiPostPcEventExposureSubscRequest
	*/
	PostPcEventExposureSubsc(ctx context.Context) ApiPostPcEventExposureSubscRequest

	// PostPcEventExposureSubscExecute executes the request
	//  @return PcEventExposureSubsc
	PostPcEventExposureSubscExecute(r ApiPostPcEventExposureSubscRequest) (*PcEventExposureSubsc, *http.Response, error)
}
...
type ApiPostPcEventExposureSubscRequest struct {
	ctx context.Context
	ApiService PolicyControlEventsSubscriptionCollectionApi
...
func (r ApiPostPcEventExposureSubscRequest) Execute() (*PcEventExposureSubsc, *http.Response, error) {
	return r.ApiService.PostPcEventExposureSubscExecute(r)
}
...
func (a *PolicyControlEventsSubscriptionCollectionApiService) PostPcEventExposureSubscExecute(r ApiPostPcEventExposureSubscRequest) (*PcEventExposureSubsc, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PolicyControlEventsSubscriptionCollectionApiService.PostPcEventExposureSubsc")
	if err != nil {
