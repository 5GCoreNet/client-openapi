...
// APIClient manages communication with the EES ACR Status Update Service API v1.0.1
...
type APIClient struct {
	...
	RequestACRUpdateApi RequestACRUpdateApi
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.RequestACRUpdateApi = (*RequestACRUpdateApiService)(&c.common)
