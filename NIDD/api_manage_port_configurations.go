...
type ManagePortConfigurationsApi interface {
	...
	*/
	FetchAllManagePortConfigurations(ctx context.Context, scsAsId string, configurationId string) ApiFetchAllManagePortConfigurationsRequest

	// FetchAllManagePortConfigurationsExecute executes the request
	//  @return []ManagePort
	FetchAllManagePortConfigurationsExecute(r ApiFetchAllManagePortConfigurationsRequest) ([]ManagePort, *http.Response, error)
}
...
type ApiFetchAllManagePortConfigurationsRequest struct {
	ctx context.Context
	ApiService ManagePortConfigurationsApi
	scsAsId string
