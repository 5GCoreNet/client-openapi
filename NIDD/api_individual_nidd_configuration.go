...
type IndividualNIDDConfigurationApi interface {
	...
	*/
	DeleteNIDDConfiguration(ctx context.Context, scsAsId string, configurationId string) ApiDeleteNIDDConfigurationRequest

	// DeleteNIDDConfigurationExecute executes the request
	DeleteNIDDConfigurationExecute(r ApiDeleteNIDDConfigurationRequest) (*http.Response, error)
	...
	*/
	FetchIndNIDDConfiguration(ctx context.Context, scsAsId string, configurationId string) ApiFetchIndNIDDConfigurationRequest

	// FetchIndNIDDConfigurationExecute executes the request
	//  @return NiddConfiguration
	FetchIndNIDDConfigurationExecute(r ApiFetchIndNIDDConfigurationRequest) (*NiddConfiguration, *http.Response, error)
	...
	*/
	ModifyNIDDConfiguration(ctx context.Context, scsAsId string, configurationId string) ApiModifyNIDDConfigurationRequest

	// ModifyNIDDConfigurationExecute executes the request
	//  @return NiddConfiguration
	ModifyNIDDConfigurationExecute(r ApiModifyNIDDConfigurationRequest) (*NiddConfiguration, *http.Response, error)
}
...
type ApiDeleteNIDDConfigurationRequest struct {
	ctx context.Context
	ApiService IndividualNIDDConfigurationApi
	scsAsId string
