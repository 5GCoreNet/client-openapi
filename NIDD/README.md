...
```golang
ctx := context.WithValue(context.Background(), NIDD.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), NIDD.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), NIDD.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), NIDD.ContextOperationServerVariables, map[string]map[string]string{
