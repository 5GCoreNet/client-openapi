...
func Interface{}AsNiddConfigurationStatusNotification(v *interface{}) NiddConfigurationStatusNotification {
	return NiddConfigurationStatusNotification{
		Interface{}: v,
	}
}
...
func (dst *NiddConfigurationStatusNotification) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(NiddConfigurationStatusNotification)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(NiddConfigurationStatusNotification)")
	}
}
...
type NullableNiddConfigurationStatusNotification struct {
	value *NiddConfigurationStatusNotification
	isSet bool
}
...
func NewNullableNiddConfigurationStatusNotification(val *NiddConfigurationStatusNotification) *NullableNiddConfigurationStatusNotification {
	return &NullableNiddConfigurationStatusNotification{value: val, isSet: true}
}
