...
type NIDDDownlinkDataDeliveriesApi interface {
	...
	*/
	CreateDownlinkDataDelivery(ctx context.Context, scsAsId string, configurationId string) ApiCreateDownlinkDataDeliveryRequest

	// CreateDownlinkDataDeliveryExecute executes the request
	//  @return NiddDownlinkDataTransfer
	CreateDownlinkDataDeliveryExecute(r ApiCreateDownlinkDataDeliveryRequest) (*NiddDownlinkDataTransfer, *http.Response, error)
	...
	*/
	FetchAllDownlinkDataDeliveries(ctx context.Context, scsAsId string, configurationId string) ApiFetchAllDownlinkDataDeliveriesRequest

	// FetchAllDownlinkDataDeliveriesExecute executes the request
	//  @return []NiddDownlinkDataTransfer
	FetchAllDownlinkDataDeliveriesExecute(r ApiFetchAllDownlinkDataDeliveriesRequest) ([]NiddDownlinkDataTransfer, *http.Response, error)
}
...
type ApiCreateDownlinkDataDeliveryRequest struct {
	ctx context.Context
	ApiService NIDDDownlinkDataDeliveriesApi
	scsAsId string
