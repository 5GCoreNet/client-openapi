...
type NIDDConfigurationsApi interface {
	...
	*/
	CreateNIDDConfiguration(ctx context.Context, scsAsId string) ApiCreateNIDDConfigurationRequest

	// CreateNIDDConfigurationExecute executes the request
	//  @return NiddConfiguration
	CreateNIDDConfigurationExecute(r ApiCreateNIDDConfigurationRequest) (*NiddConfiguration, *http.Response, error)
	...
	*/
	FetchAllNIDDConfigurations(ctx context.Context, scsAsId string) ApiFetchAllNIDDConfigurationsRequest

	// FetchAllNIDDConfigurationsExecute executes the request
	//  @return []NiddConfiguration
	FetchAllNIDDConfigurationsExecute(r ApiFetchAllNIDDConfigurationsRequest) ([]NiddConfiguration, *http.Response, error)
}
...
type ApiCreateNIDDConfigurationRequest struct {
	ctx context.Context
	ApiService NIDDConfigurationsApi
	scsAsId string
