...
type IndividualDCCFDataCollectionProfileDocumentApi interface {
	...
	*/
	DeleteDCCFDataCollectionProfile(ctx context.Context, profileId string) ApiDeleteDCCFDataCollectionProfileRequest

	// DeleteDCCFDataCollectionProfileExecute executes the request
	DeleteDCCFDataCollectionProfileExecute(r ApiDeleteDCCFDataCollectionProfileRequest) (*http.Response, error)
	...
	*/
	UpdateDCCFDataCollectionProfile(ctx context.Context, profileId string) ApiUpdateDCCFDataCollectionProfileRequest

	// UpdateDCCFDataCollectionProfileExecute executes the request
	//  @return NdccfDataCollectionProfile
	UpdateDCCFDataCollectionProfileExecute(r ApiUpdateDCCFDataCollectionProfileRequest) (*NdccfDataCollectionProfile, *http.Response, error)
}
...
type ApiDeleteDCCFDataCollectionProfileRequest struct {
	ctx context.Context
	ApiService IndividualDCCFDataCollectionProfileDocumentApi
	profileId string
}
