...
type DefaultApi interface {
	...
	*/
	OfflinechargingdataOfflineChargingDataRefReleasePost(ctx context.Context, offlineChargingDataRef string) ApiOfflinechargingdataOfflineChargingDataRefReleasePostRequest

	// OfflinechargingdataOfflineChargingDataRefReleasePostExecute executes the request
	OfflinechargingdataOfflineChargingDataRefReleasePostExecute(r ApiOfflinechargingdataOfflineChargingDataRefReleasePostRequest) (*http.Response, error)
	...
	*/
	OfflinechargingdataOfflineChargingDataRefUpdatePost(ctx context.Context, offlineChargingDataRef string) ApiOfflinechargingdataOfflineChargingDataRefUpdatePostRequest

	// OfflinechargingdataOfflineChargingDataRefUpdatePostExecute executes the request
	//  @return ChargingDataResponse
	OfflinechargingdataOfflineChargingDataRefUpdatePostExecute(r ApiOfflinechargingdataOfflineChargingDataRefUpdatePostRequest) (*ChargingDataResponse, *http.Response, error)
	...
	*/
	OfflinechargingdataPost(ctx context.Context) ApiOfflinechargingdataPostRequest

	// OfflinechargingdataPostExecute executes the request
	//  @return ChargingDataResponse
	OfflinechargingdataPostExecute(r ApiOfflinechargingdataPostRequest) (*ChargingDataResponse, *http.Response, error)
}
...
func (a *DefaultApiService) OfflinechargingdataOfflineChargingDataRefReleasePostExecute(r ApiOfflinechargingdataOfflineChargingDataRefReleasePostRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"OfflineChargingDataRef"+"}", url.PathEscape(parameterToString(r.offlineChargingDataRef, "")), -1)
