...
type IndividualBDTPolicyDocumentApi interface {
	...
	*/
	GetBDTPolicy(ctx context.Context, bdtPolicyId string) ApiGetBDTPolicyRequest

	// GetBDTPolicyExecute executes the request
	//  @return BdtPolicy
	GetBDTPolicyExecute(r ApiGetBDTPolicyRequest) (*BdtPolicy, *http.Response, error)
	...
	*/
	UpdateBDTPolicy(ctx context.Context, bdtPolicyId string) ApiUpdateBDTPolicyRequest

	// UpdateBDTPolicyExecute executes the request
	//  @return BdtPolicy
	UpdateBDTPolicyExecute(r ApiUpdateBDTPolicyRequest) (*BdtPolicy, *http.Response, error)
}
...
type ApiGetBDTPolicyRequest struct {
	ctx context.Context
	ApiService IndividualBDTPolicyDocumentApi
	bdtPolicyId string
}
...
func (a *IndividualBDTPolicyDocumentApiService) GetBDTPolicyExecute(r ApiGetBDTPolicyRequest) (*BdtPolicy, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"bdtPolicyId"+"}", url.PathEscape(parameterToString(r.bdtPolicyId, "")), -1)
