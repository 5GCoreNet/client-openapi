...
type N2MessagesHandlerCustomOperationApi interface {
	...
	*/
	N2MessageTransfer(ctx context.Context) ApiN2MessageTransferRequest

	// N2MessageTransferExecute executes the request
	//  @return MbsN2MessageTransferRspData
	N2MessageTransferExecute(r ApiN2MessageTransferRequest) (*MbsN2MessageTransferRspData, *http.Response, error)
}
...
type ApiN2MessageTransferRequest struct {
	ctx context.Context
	ApiService N2MessagesHandlerCustomOperationApi
