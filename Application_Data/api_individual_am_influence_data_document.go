...
type IndividualAMInfluenceDataDocumentApi interface {
	...
	*/
	CreateOrReplaceIndividualAmInfluenceData(ctx context.Context, amInfluenceId string) ApiCreateOrReplaceIndividualAmInfluenceDataRequest

	// CreateOrReplaceIndividualAmInfluenceDataExecute executes the request
	//  @return AmInfluData
	CreateOrReplaceIndividualAmInfluenceDataExecute(r ApiCreateOrReplaceIndividualAmInfluenceDataRequest) (*AmInfluData, *http.Response, error)
	...
	*/
	DeleteIndividualAmInfluenceData(ctx context.Context, amInfluenceId string) ApiDeleteIndividualAmInfluenceDataRequest

	// DeleteIndividualAmInfluenceDataExecute executes the request
	DeleteIndividualAmInfluenceDataExecute(r ApiDeleteIndividualAmInfluenceDataRequest) (*http.Response, error)
	...
	*/
	UpdateIndividualAmInfluenceData(ctx context.Context, amInfluenceId string) ApiUpdateIndividualAmInfluenceDataRequest

	// UpdateIndividualAmInfluenceDataExecute executes the request
	//  @return AmInfluData
	UpdateIndividualAmInfluenceDataExecute(r ApiUpdateIndividualAmInfluenceDataRequest) (*AmInfluData, *http.Response, error)
}
...
type ApiCreateOrReplaceIndividualAmInfluenceDataRequest struct {
	ctx context.Context
	ApiService IndividualAMInfluenceDataDocumentApi
...
func (a *IndividualAMInfluenceDataDocumentApiService) CreateOrReplaceIndividualAmInfluenceDataExecute(r ApiCreateOrReplaceIndividualAmInfluenceDataRequest) (*AmInfluData, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"amInfluenceId"+"}", url.PathEscape(parameterToString(r.amInfluenceId, "")), -1)
