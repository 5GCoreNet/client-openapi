...
type InfluenceDataStoreApi interface {
	...
	*/
	...
	ReadInfluenceDataExecute(r ApiReadInfluenceDataRequest) ([]TrafficInfluData, *http.Response, error)
}
...
func (a *InfluenceDataStoreApiService) ReadInfluenceDataExecute(r ApiReadInfluenceDataRequest) ([]TrafficInfluData, *http.Response, error) {
	...
	if r.influenceIds != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("influence-Ids", parameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("influence-Ids", parameterToString(t, "multi"))
		}
	}
	if r.dnns != nil {
		t := *r.dnns
