...
type ApplicationDataSubscriptionsCollectionApi interface {
	...
	*/
	...
	CreateIndividualApplicationDataSubscriptionExecute(r ApiCreateIndividualApplicationDataSubscriptionRequest) (*ApplicationDataSubs, *http.Response, error)
	...
	*/
	...
	//  @return []ApplicationDataSubs
	ReadApplicationDataChangeSubscriptionsExecute(r ApiReadApplicationDataChangeSubscriptionsRequest) ([]ApplicationDataSubs, *http.Response, error)
}
...
func (a *ApplicationDataSubscriptionsCollectionApiService) ReadApplicationDataChangeSubscriptionsExecute(r ApiReadApplicationDataChangeSubscriptionsRequest) ([]ApplicationDataSubs, *http.Response, error) {
	...
	if r.dataFilter != nil {
		localVarQueryParams.Add("data-filter", parameterToString(*r.dataFilter, ""))
	}
	// to determine the Content-Type header
