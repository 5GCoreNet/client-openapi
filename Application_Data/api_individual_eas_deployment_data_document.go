...
type IndividualEasDeploymentDataDocumentApi interface {
	...
	*/
	DeleteIndividualEasDeployData(ctx context.Context, easDeployInfoId string) ApiDeleteIndividualEasDeployDataRequest

	// DeleteIndividualEasDeployDataExecute executes the request
	DeleteIndividualEasDeployDataExecute(r ApiDeleteIndividualEasDeployDataRequest) (*http.Response, error)
}
...
type ApiDeleteIndividualEasDeployDataRequest struct {
	ctx context.Context
	ApiService IndividualEasDeploymentDataDocumentApi
