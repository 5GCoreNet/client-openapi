...
type EASDeploymentDataStoreApi interface {
	...
	*/
	ReadEasDeployData(ctx context.Context) ApiReadEasDeployDataRequest

	// ReadEasDeployDataExecute executes the request
	//  @return []EasDeployInfoData
	ReadEasDeployDataExecute(r ApiReadEasDeployDataRequest) ([]EasDeployInfoData, *http.Response, error)
}
...
type ApiReadEasDeployDataRequest struct {
	ctx context.Context
	ApiService EASDeploymentDataStoreApi
	dnn *string
	snssai *Snssai
...
func (a *EASDeploymentDataStoreApiService) ReadEasDeployDataExecute(r ApiReadEasDeployDataRequest) ([]EasDeployInfoData, *http.Response, error) {
	...
	if r.internalGroupId != nil {
		localVarQueryParams.Add("internal-group-id", parameterToString(*r.internalGroupId, ""))
	}
	if r.appId != nil {
