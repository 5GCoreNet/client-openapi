# Go API client for Eecs_ServiceProvisioning
...
```golang
import Eecs_ServiceProvisioning "//"
```
...
```golang
ctx := context.WithValue(context.Background(), Eecs_ServiceProvisioning.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), Eecs_ServiceProvisioning.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), Eecs_ServiceProvisioning.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), Eecs_ServiceProvisioning.ContextOperationServerVariables, map[string]map[string]string{
