...
type IPTVConfigurationsApi interface {
	...
	*/
	...
	CreateNewSubscriptionExecute(r ApiCreateNewSubscriptionRequest) (*IptvConfigData, *http.Response, error)
	...
	*/
	...
	//  @return []IptvConfigData
	ReadAllSubscriptionsExecute(r ApiReadAllSubscriptionsRequest) ([]IptvConfigData, *http.Response, error)
}
...
type ApiCreateNewSubscriptionRequest struct {
	ctx context.Context
	ApiService IPTVConfigurationsApi
	afId string
