...
type GPSIToSUPITranslationOrSUPIToGPSITranslationApi interface {
	...
	*/
	...
	GetSupiOrGpsiExecute(r ApiGetSupiOrGpsiRequest) (*IdTranslationResult, *http.Response, error)
}
...
func (a *GPSIToSUPITranslationOrSUPIToGPSITranslationApiService) GetSupiOrGpsiExecute(r ApiGetSupiOrGpsiRequest) (*IdTranslationResult, *http.Response, error) {
	...
	if r.afId != nil {
		localVarQueryParams.Add("af-id", parameterToString(*r.afId, ""))
	}
	if r.appPortId != nil {
		localVarQueryParams.Add("app-port-id", parameterToString(*r.appPortId, ""))
	}
	if r.afServiceId != nil {
		localVarQueryParams.Add("af-service-id", parameterToString(*r.afServiceId, ""))
	}
	if r.mtcProviderInfo != nil {
		localVarQueryParams.Add("mtc-provider-info", parameterToString(*r.mtcProviderInfo, ""))
	}
	if r.requestedGpsiType != nil {
		localVarQueryParams.Add("requested-gpsi-type", parameterToString(*r.requestedGpsiType, ""))
	}
