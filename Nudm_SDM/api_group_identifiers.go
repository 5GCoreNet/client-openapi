...
type GroupIdentifiersApi interface {
	...
	*/
	...
	GetGroupIdentifiersExecute(r ApiGetGroupIdentifiersRequest) (*GroupIdentifiers, *http.Response, error)
}
...
func (a *GroupIdentifiersApiService) GetGroupIdentifiersExecute(r ApiGetGroupIdentifiersRequest) (*GroupIdentifiers, *http.Response, error) {
	...
	if r.extGroupId != nil {
		localVarQueryParams.Add("ext-group-id", parameterToString(*r.extGroupId, ""))
	}
	if r.intGroupId != nil {
		localVarQueryParams.Add("int-group-id", parameterToString(*r.intGroupId, ""))
	}
	if r.ueIdInd != nil {
		localVarQueryParams.Add("ue-id-ind", parameterToString(*r.ueIdInd, ""))
	}
