...
type RetrievalOfTheIndividualSharedDataApi interface {
	...
	*/
	...
	//  @return SharedData
	GetIndividualSharedDataExecute(r ApiGetIndividualSharedDataRequest) (*SharedData, *http.Response, error)
}
...
func (a *RetrievalOfTheIndividualSharedDataApiService) GetIndividualSharedDataExecute(r ApiGetIndividualSharedDataRequest) (*SharedData, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"sharedDataId"+"}", url.PathEscape(parameterToString(r.sharedDataId, "csv")), -1)
