...
type RetrievalOfSharedDataApi interface {
	...
	*/
	...
	//  @return []SharedData
	GetSharedDataExecute(r ApiGetSharedDataRequest) ([]SharedData, *http.Response, error)
}
...
func (a *RetrievalOfSharedDataApiService) GetSharedDataExecute(r ApiGetSharedDataRequest) ([]SharedData, *http.Response, error) {
	...
	localVarQueryParams.Add("shared-data-ids", parameterToString(*r.sharedDataIds, "csv"))
	if r.supportedFeatures != nil {
		localVarQueryParams.Add("supportedFeatures", parameterToString(*r.supportedFeatures, ""))
	}
	if r.supportedFeatures2 != nil {
		localVarQueryParams.Add("supported-features", parameterToString(*r.supportedFeatures2, ""))
	}
