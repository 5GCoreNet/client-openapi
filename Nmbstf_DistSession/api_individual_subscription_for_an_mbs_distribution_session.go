...
type IndividualSubscriptionForAnMBSDistributionSessionApi interface {
	...
	*/
	StatusSubscribeMod(ctx context.Context, subscriptionId string, distSessionRef string) ApiStatusSubscribeModRequest

	// StatusSubscribeModExecute executes the request
	//  @return DistSessionSubscription
	StatusSubscribeModExecute(r ApiStatusSubscribeModRequest) (*DistSessionSubscription, *http.Response, error)
}
...
type ApiStatusSubscribeModRequest struct {
	ctx context.Context
	ApiService IndividualSubscriptionForAnMBSDistributionSessionApi
