...
type SubscriptionsCollectionForMBSDistributionSessionApi interface {
	...
	*/
	StatusSubscribe(ctx context.Context, distSessionRef string) ApiStatusSubscribeRequest

	// StatusSubscribeExecute executes the request
	//  @return StatusSubscribeRspData
	StatusSubscribeExecute(r ApiStatusSubscribeRequest) (*StatusSubscribeRspData, *http.Response, error)
}
...
type ApiStatusSubscribeRequest struct {
	ctx context.Context
	ApiService SubscriptionsCollectionForMBSDistributionSessionApi
...
func (a *SubscriptionsCollectionForMBSDistributionSessionApiService) StatusSubscribeExecute(r ApiStatusSubscribeRequest) (*StatusSubscribeRspData, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubscriptionsCollectionForMBSDistributionSessionApiService.StatusSubscribe")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/dist-sessions/{distSessionRef}/subscriptions"
	localVarPath = strings.Replace(localVarPath, "{"+"distSessionRef"+"}", url.PathEscape(parameterToString(r.distSessionRef, "")), -1)
