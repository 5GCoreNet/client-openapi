...
type LPIParametersProvisioningsApi interface {
	...
	@return ApiCreateNewResourceRequest
	*/
	CreateNewResource(ctx context.Context, afId string) ApiCreateNewResourceRequest

	// CreateNewResourceExecute executes the request
	//  @return LpiParametersProvision
	CreateNewResourceExecute(r ApiCreateNewResourceRequest) (*LpiParametersProvision, *http.Response, error)
	...
	*/
	ReadAllResources(ctx context.Context, afId string) ApiReadAllResourcesRequest

	// ReadAllResourcesExecute executes the request
	//  @return []LpiParametersProvision
	ReadAllResourcesExecute(r ApiReadAllResourcesRequest) ([]LpiParametersProvision, *http.Response, error)
}
...
type ApiCreateNewResourceRequest struct {
	ctx context.Context
	ApiService LPIParametersProvisioningsApi
	afId string
...
func (r ApiCreateNewResourceRequest) Execute() (*LpiParametersProvision, *http.Response, error) {
	return r.ApiService.CreateNewResourceExecute(r)
}
...
func (a *LPIParametersProvisioningsApiService) CreateNewResourceExecute(r ApiCreateNewResourceRequest) (*LpiParametersProvision, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LPIParametersProvisioningsApiService.CreateNewResource")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{afId}/provisionedLpis"
...
func (a *LPIParametersProvisioningsApiService) ReadAllResourcesExecute(r ApiReadAllResourcesRequest) ([]LpiParametersProvision, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LPIParametersProvisioningsApiService.ReadAllResources")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
