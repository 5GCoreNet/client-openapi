...
type IndividualLPIParametersProvisioningApi interface {
	...
	*/
	DeleteAnResource(ctx context.Context, afId string, provisionedLpiId string) ApiDeleteAnResourceRequest

	// DeleteAnResourceExecute executes the request
	DeleteAnResourceExecute(r ApiDeleteAnResourceRequest) (*http.Response, error)
	...
	*/
	FullyUpdateAnResource(ctx context.Context, afId string, provisionedLpiId string) ApiFullyUpdateAnResourceRequest

	// FullyUpdateAnResourceExecute executes the request
	//  @return LpiParametersProvision
	FullyUpdateAnResourceExecute(r ApiFullyUpdateAnResourceRequest) (*LpiParametersProvision, *http.Response, error)
	...
	*/
	PartialUpdateAnResource(ctx context.Context, afId string, provisionedLpiId string) ApiPartialUpdateAnResourceRequest

	// PartialUpdateAnResourceExecute executes the request
	//  @return LpiParametersProvision
	PartialUpdateAnResourceExecute(r ApiPartialUpdateAnResourceRequest) (*LpiParametersProvision, *http.Response, error)
	...
	*/
	ReadAnResource(ctx context.Context, afId string, provisionedLpiId string) ApiReadAnResourceRequest

	// ReadAnResourceExecute executes the request
	//  @return LpiParametersProvision
	ReadAnResourceExecute(r ApiReadAnResourceRequest) (*LpiParametersProvision, *http.Response, error)
}
...
type ApiDeleteAnResourceRequest struct {
	ctx context.Context
	ApiService IndividualLPIParametersProvisioningApi
	afId string
...
func (a *IndividualLPIParametersProvisioningApiService) DeleteAnResourceExecute(r ApiDeleteAnResourceRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"provisionedLpiId"+"}", url.PathEscape(parameterToString(r.provisionedLpiId, "")), -1)
