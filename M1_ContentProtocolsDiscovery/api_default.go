...
type DefaultApi interface {
	...
	*/
	RetrieveContentProtocols(ctx context.Context, provisioningSessionId string) ApiRetrieveContentProtocolsRequest

	// RetrieveContentProtocolsExecute executes the request
	//  @return ContentProtocols
	RetrieveContentProtocolsExecute(r ApiRetrieveContentProtocolsRequest) (*ContentProtocols, *http.Response, error)
}
