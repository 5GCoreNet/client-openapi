...
type IndividualEASDiscoverySubscriptionApi interface {
	...
	*/
	...
	SubscriptionsSubscriptionIdPatchExecute(r ApiSubscriptionsSubscriptionIdPatchRequest) (*EasDiscoverySubscription, *http.Response, error)
	...
	*/
	...
	//  @return EasDiscoverySubscription
	SubscriptionsSubscriptionIdPutExecute(r ApiSubscriptionsSubscriptionIdPutRequest) (*EasDiscoverySubscription, *http.Response, error)
}
...
type ApiSubscriptionsSubscriptionIdDeleteRequest struct {
	ctx context.Context
	ApiService IndividualEASDiscoverySubscriptionApi
