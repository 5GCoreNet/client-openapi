...
type IndividualRealTimeUAVStatusSubscriptionDocumentApi interface {
	...
	*/
	DeleteRTUavStatusSubscription(ctx context.Context, subscriptionId string) ApiDeleteRTUavStatusSubscriptionRequest

	// DeleteRTUavStatusSubscriptionExecute executes the request
	DeleteRTUavStatusSubscriptionExecute(r ApiDeleteRTUavStatusSubscriptionRequest) (*http.Response, error)
	...
	*/
	GetRTUavStatusSubscription(ctx context.Context, subscriptionId string) ApiGetRTUavStatusSubscriptionRequest

	// GetRTUavStatusSubscriptionExecute executes the request
	//  @return RTUavStatusSubsc
	GetRTUavStatusSubscriptionExecute(r ApiGetRTUavStatusSubscriptionRequest) (*RTUavStatusSubsc, *http.Response, error)
	...
	*/
	UpdateRTUavStatusSubscription(ctx context.Context, subscriptionId string) ApiUpdateRTUavStatusSubscriptionRequest

	// UpdateRTUavStatusSubscriptionExecute executes the request
	//  @return RTUavStatusSubsc
	UpdateRTUavStatusSubscriptionExecute(r ApiUpdateRTUavStatusSubscriptionRequest) (*RTUavStatusSubsc, *http.Response, error)
}
...
type ApiDeleteRTUavStatusSubscriptionRequest struct {
	ctx context.Context
	ApiService IndividualRealTimeUAVStatusSubscriptionDocumentApi
