...
type KeyRecordsCollectionApi interface {
	...
	*/
	RetrieveKeyMgmtInfo(ctx context.Context) ApiRetrieveKeyMgmtInfoRequest

	// RetrieveKeyMgmtInfoExecute executes the request
	//  @return ValKeyInfo
	RetrieveKeyMgmtInfoExecute(r ApiRetrieveKeyMgmtInfoRequest) (*ValKeyInfo, *http.Response, error)
}
...
type ApiRetrieveKeyMgmtInfoRequest struct {
	ctx context.Context
	ApiService KeyRecordsCollectionApi
	valServiceId *string
...
func (a *KeyRecordsCollectionApiService) RetrieveKeyMgmtInfoExecute(r ApiRetrieveKeyMgmtInfoRequest) (*ValKeyInfo, *http.Response, error) {
	...
	if r.valTgtUe != nil {
		localVarQueryParams.Add("val-tgt-ue", parameterToString(*r.valTgtUe, ""))
	}
