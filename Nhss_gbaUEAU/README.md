# Go API client for Nhss_gbaUEAU
...
```golang
ctx := context.WithValue(context.Background(), Nhss_gbaUEAU.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), Nhss_gbaUEAU.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), Nhss_gbaUEAU.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), Nhss_gbaUEAU.ContextOperationServerVariables, map[string]map[string]string{
