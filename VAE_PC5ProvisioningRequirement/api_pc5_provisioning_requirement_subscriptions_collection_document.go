...
type PC5ProvisioningRequirementSubscriptionsCollectionDocumentApi interface {
	...
	*/
	...
	CreateExecute(r ApiCreateRequest) (*ProvisioningRequirement, *http.Response, error)
}
...
type ApiCreateRequest struct {
	ctx context.Context
	ApiService PC5ProvisioningRequirementSubscriptionsCollectionDocumentApi
...
func (a *PC5ProvisioningRequirementSubscriptionsCollectionDocumentApiService) CreateExecute(r ApiCreateRequest) (*ProvisioningRequirement, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PC5ProvisioningRequirementSubscriptionsCollectionDocumentApiService.Create")
	if err != nil {
