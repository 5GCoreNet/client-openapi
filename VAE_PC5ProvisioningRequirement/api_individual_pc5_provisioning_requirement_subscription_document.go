...
type IndividualPC5ProvisioningRequirementSubscriptionDocumentApi interface {
	...
	*/
	DeletePC5ProvisioningRequirementSubscription(ctx context.Context, subscriptionId string) ApiDeletePC5ProvisioningRequirementSubscriptionRequest

	// DeletePC5ProvisioningRequirementSubscriptionExecute executes the request
	DeletePC5ProvisioningRequirementSubscriptionExecute(r ApiDeletePC5ProvisioningRequirementSubscriptionRequest) (*http.Response, error)
	...
	*/
	ReadPC5ProvisioningRequirementSubscription(ctx context.Context, subscriptionId string) ApiReadPC5ProvisioningRequirementSubscriptionRequest

	// ReadPC5ProvisioningRequirementSubscriptionExecute executes the request
	//  @return ProvisioningRequirement
	ReadPC5ProvisioningRequirementSubscriptionExecute(r ApiReadPC5ProvisioningRequirementSubscriptionRequest) (*ProvisioningRequirement, *http.Response, error)
}
...
type ApiDeletePC5ProvisioningRequirementSubscriptionRequest struct {
	ctx context.Context
	ApiService IndividualPC5ProvisioningRequirementSubscriptionDocumentApi
