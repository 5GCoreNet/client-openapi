...
type VAEPC5ProvisioningRequirementSubscriptionResourcePutServiceOperationApi interface {
	...
	*/
	UpdatePC5ProvisioningRequirementSubscription(ctx context.Context, subscriptionId string) ApiUpdatePC5ProvisioningRequirementSubscriptionRequest

	// UpdatePC5ProvisioningRequirementSubscriptionExecute executes the request
	//  @return ProvisioningRequirement
	UpdatePC5ProvisioningRequirementSubscriptionExecute(r ApiUpdatePC5ProvisioningRequirementSubscriptionRequest) (*ProvisioningRequirement, *http.Response, error)
}
...
type ApiUpdatePC5ProvisioningRequirementSubscriptionRequest struct {
	ctx context.Context
	ApiService VAEPC5ProvisioningRequirementSubscriptionResourcePutServiceOperationApi
