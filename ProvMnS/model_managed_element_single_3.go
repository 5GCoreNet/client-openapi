...
type NullableManagedElementSingle3 struct {
	value *ManagedElementSingle3
	isSet bool
}

func (v NullableManagedElementSingle3) Get() *ManagedElementSingle3 {
	return v.value
}

func (v *NullableManagedElementSingle3) Set(val *ManagedElementSingle3) {
	v.value = val
	v.isSet = true
}

func (v NullableManagedElementSingle3) IsSet() bool {
	return v.isSet
}
...
func NewNullableManagedElementSingle3(val *ManagedElementSingle3) *NullableManagedElementSingle3 {
	return &NullableManagedElementSingle3{value: val, isSet: true}
}
