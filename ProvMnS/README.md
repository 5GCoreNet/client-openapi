...
```golang
ctx := context.WithValue(context.Background(), ProvMnS.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), ProvMnS.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), ProvMnS.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), ProvMnS.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**ClassNameidDelete**](docs/DefaultApi.md#classnameiddelete) | **Delete** /{className}&#x3D;{id} | Deletes one or multiple resources
...
## Documentation For Models
 ...
 - [AIMLContext](docs/AIMLContext.md)
 ...
 - [AnalyticsScope](docs/AnalyticsScope.md)
 - [AnalyticsScopeOneOf](docs/AnalyticsScopeOneOf.md)
 - [AnalyticsScopeOneOf1](docs/AnalyticsScopeOneOf1.md)
