...
type NullableMDARequestSingleAllOf struct {
	value *MDARequestSingleAllOf
	isSet bool
}

func (v NullableMDARequestSingleAllOf) Get() *MDARequestSingleAllOf {
	return v.value
}

func (v *NullableMDARequestSingleAllOf) Set(val *MDARequestSingleAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMDARequestSingleAllOf) IsSet() bool {
	return v.isSet
}
...
func NewNullableMDARequestSingleAllOf(val *MDARequestSingleAllOf) *NullableMDARequestSingleAllOf {
	return &NullableMDARequestSingleAllOf{value: val, isSet: true}
}
