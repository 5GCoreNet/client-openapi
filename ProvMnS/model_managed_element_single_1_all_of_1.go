...
func NewManagedElementSingle1AllOf1() *ManagedElementSingle1AllOf1 {
	this := ManagedElementSingle1AllOf1{}
	return &this
}
...
type NullableManagedElementSingle1AllOf1 struct {
	value *ManagedElementSingle1AllOf1
	isSet bool
}

func (v NullableManagedElementSingle1AllOf1) Get() *ManagedElementSingle1AllOf1 {
	return v.value
}

func (v *NullableManagedElementSingle1AllOf1) Set(val *ManagedElementSingle1AllOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableManagedElementSingle1AllOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableManagedElementSingle1AllOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagedElementSingle1AllOf1(val *ManagedElementSingle1AllOf1) *NullableManagedElementSingle1AllOf1 {
	return &NullableManagedElementSingle1AllOf1{value: val, isSet: true}
}
