...
// SubNetworkSingle5AsResourcesAiMlNrm is a convenience function that returns SubNetworkSingle5 wrapped in ResourcesAiMlNrm
func SubNetworkSingle5AsResourcesAiMlNrm(v *SubNetworkSingle5) ResourcesAiMlNrm {
	return ResourcesAiMlNrm{
		SubNetworkSingle5: v,
	}
}
