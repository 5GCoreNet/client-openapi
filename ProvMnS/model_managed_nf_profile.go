...
// GetNFInfo returns the NFInfo field value if set, zero value otherwise.
func (o *ManagedNFProfile) GetNFInfo() NFInfo {
	if o == nil || isNil(o.NFInfo) {
		var ret NFInfo
		return ret
	}
	return *o.NFInfo
...
// GetNFInfoOk returns a tuple with the NFInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ManagedNFProfile) GetNFInfoOk() (*NFInfo, bool) {
	if o == nil || isNil(o.NFInfo) {
    return nil, false
	}
	return o.NFInfo, true
}
...
// SetNFInfo gets a reference to the given NFInfo and assigns it to the NFInfo field.
