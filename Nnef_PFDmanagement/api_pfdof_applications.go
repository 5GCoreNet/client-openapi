...
type PFDOfApplicationsApi interface {
	...
	*/
	NnefPFDmanagementAllFetch(ctx context.Context) ApiNnefPFDmanagementAllFetchRequest

	// NnefPFDmanagementAllFetchExecute executes the request
	//  @return []PfdDataForApp
	NnefPFDmanagementAllFetchExecute(r ApiNnefPFDmanagementAllFetchRequest) ([]PfdDataForApp, *http.Response, error)
}
...
type ApiNnefPFDmanagementAllFetchRequest struct {
	ctx context.Context
	ApiService PFDOfApplicationsApi
...
func (a *PFDOfApplicationsApiService) NnefPFDmanagementAllFetchExecute(r ApiNnefPFDmanagementAllFetchRequest) ([]PfdDataForApp, *http.Response, error) {
...

	{
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("application-ids", parameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("application-ids", parameterToString(t, "multi"))
		}
	}
