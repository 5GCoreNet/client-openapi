...
type IndividualMBSSessionSubscriptionApi interface {
	...
	*/
	DeleteIndMBSSessionsSubsc(ctx context.Context, subscriptionId string) ApiDeleteIndMBSSessionsSubscRequest

	// DeleteIndMBSSessionsSubscExecute executes the request
	DeleteIndMBSSessionsSubscExecute(r ApiDeleteIndMBSSessionsSubscRequest) (*http.Response, error)
	...
	*/
	ReadIndMBSSessionsSubsc(ctx context.Context, subscriptionId string) ApiReadIndMBSSessionsSubscRequest

	// ReadIndMBSSessionsSubscExecute executes the request
	//  @return MbsSessionSubsc
	ReadIndMBSSessionsSubscExecute(r ApiReadIndMBSSessionsSubscRequest) (*MbsSessionSubsc, *http.Response, error)
}
...
type ApiDeleteIndMBSSessionsSubscRequest struct {
	ctx context.Context
	ApiService IndividualMBSSessionSubscriptionApi
