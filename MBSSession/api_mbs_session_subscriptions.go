...
type MBSSessionSubscriptionsApi interface {
	...
	*/
	CreateMBSSessionsSubsc(ctx context.Context) ApiCreateMBSSessionsSubscRequest

	// CreateMBSSessionsSubscExecute executes the request
	//  @return MbsSessionSubsc
	CreateMBSSessionsSubscExecute(r ApiCreateMBSSessionsSubscRequest) (*MbsSessionSubsc, *http.Response, error)
	...
	*/
	ReadMBSSessionsSubscs(ctx context.Context) ApiReadMBSSessionsSubscsRequest

	// ReadMBSSessionsSubscsExecute executes the request
	//  @return []MbsSessionSubsc
	ReadMBSSessionsSubscsExecute(r ApiReadMBSSessionsSubscsRequest) ([]MbsSessionSubsc, *http.Response, error)
}
...
type ApiCreateMBSSessionsSubscRequest struct {
	ctx context.Context
	ApiService MBSSessionSubscriptionsApi
