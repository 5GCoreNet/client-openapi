...
type MBSSessionsCollectionApi interface {
	...
	*/
	CreateMBSSession(ctx context.Context) ApiCreateMBSSessionRequest

	// CreateMBSSessionExecute executes the request
	//  @return MbsSessionCreateRsp
	CreateMBSSessionExecute(r ApiCreateMBSSessionRequest) (*MbsSessionCreateRsp, *http.Response, error)
}
