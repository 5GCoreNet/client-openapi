...
type MBSParametersProvisioningApi interface {
	...
	*/
	CreateMBSParamsProvisioning(ctx context.Context) ApiCreateMBSParamsProvisioningRequest

	// CreateMBSParamsProvisioningExecute executes the request
	//  @return MbsPpData
	CreateMBSParamsProvisioningExecute(r ApiCreateMBSParamsProvisioningRequest) (*MbsPpData, *http.Response, error)
}
...
type ApiCreateMBSParamsProvisioningRequest struct {
	ctx context.Context
	ApiService MBSParametersProvisioningApi
	mbsPpData *MbsPpData
}
