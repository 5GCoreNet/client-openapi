...
type BlockCRUDApi interface {
	...
	*/
	CreateOrModifyBlock(ctx context.Context, realmId string, storageId string, recordId string, blockId string) ApiCreateOrModifyBlockRequest

	// CreateOrModifyBlockExecute executes the request
	//  @return interface{}
	CreateOrModifyBlockExecute(r ApiCreateOrModifyBlockRequest) (interface{}, *http.Response, error)
	...
	*/
	DeleteBlock(ctx context.Context, realmId string, storageId string, recordId string, blockId string) ApiDeleteBlockRequest

	// DeleteBlockExecute executes the request
	//  @return interface{}
	DeleteBlockExecute(r ApiDeleteBlockRequest) (interface{}, *http.Response, error)
	...
	*/
	GetBlock(ctx context.Context, realmId string, storageId string, recordId string, blockId string) ApiGetBlockRequest

	// GetBlockExecute executes the request
	//  @return interface{}
	GetBlockExecute(r ApiGetBlockRequest) (interface{}, *http.Response, error)
	...
	*/
	GetBlockList(ctx context.Context, realmId string, storageId string, recordId string) ApiGetBlockListRequest

	// GetBlockListExecute executes the request
	//  @return GetBlockList200Response
	GetBlockListExecute(r ApiGetBlockListRequest) (*GetBlockList200Response, *http.Response, error)
}
...
func (a *BlockCRUDApiService) CreateOrModifyBlockExecute(r ApiCreateOrModifyBlockRequest) (interface{}, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"blockId"+"}", url.PathEscape(parameterToString(r.blockId, "")), -1)
