...
type RecordCRUDApi interface {
	...
	*/
	BulkDeleteRecords(ctx context.Context, realmId string, storageId string) ApiBulkDeleteRecordsRequest

	// BulkDeleteRecordsExecute executes the request
	//  @return RecordIdList
	BulkDeleteRecordsExecute(r ApiBulkDeleteRecordsRequest) (*RecordIdList, *http.Response, error)
	...
	*/
	CreateOrModifyRecord(ctx context.Context, realmId string, storageId string, recordId string) ApiCreateOrModifyRecordRequest

	// CreateOrModifyRecordExecute executes the request
	//  @return Record
	CreateOrModifyRecordExecute(r ApiCreateOrModifyRecordRequest) (*Record, *http.Response, error)
	...
	*/
	DeleteRecord(ctx context.Context, realmId string, storageId string, recordId string) ApiDeleteRecordRequest

	// DeleteRecordExecute executes the request
	//  @return Record
	DeleteRecordExecute(r ApiDeleteRecordRequest) (*Record, *http.Response, error)
	...
	*/
	GetMeta(ctx context.Context, realmId string, storageId string, recordId string) ApiGetMetaRequest

	// GetMetaExecute executes the request
	//  @return RecordMeta
	GetMetaExecute(r ApiGetMetaRequest) (*RecordMeta, *http.Response, error)
	...
	*/
	GetRecord(ctx context.Context, realmId string, storageId string, recordId string) ApiGetRecordRequest

	// GetRecordExecute executes the request
	//  @return Record
	GetRecordExecute(r ApiGetRecordRequest) (*Record, *http.Response, error)
	...
	*/
	SearchRecord(ctx context.Context, realmId string, storageId string) ApiSearchRecordRequest

	// SearchRecordExecute executes the request
	//  @return RecordSearchResult
	SearchRecordExecute(r ApiSearchRecordRequest) (*RecordSearchResult, *http.Response, error)
	...
	*/
	UpdateMeta(ctx context.Context, realmId string, storageId string, recordId string) ApiUpdateMetaRequest

	// UpdateMetaExecute executes the request
	//  @return PatchResult
	UpdateMetaExecute(r ApiUpdateMetaRequest) (*PatchResult, *http.Response, error)
}
...
func (a *RecordCRUDApiService) CreateOrModifyRecordExecute(r ApiCreateOrModifyRecordRequest) (*Record, *http.Response, error) {
	...
	if r.getPrevious != nil {
		localVarQueryParams.Add("get-previous", parameterToString(*r.getPrevious, ""))
	}
	if r.supportedFeatures != nil {
		localVarQueryParams.Add("supported-features", parameterToString(*r.supportedFeatures, ""))
	}
...
func (a *RecordCRUDApiService) SearchRecordExecute(r ApiSearchRecordRequest) (*RecordSearchResult, *http.Response, error) {
	...
	if r.countIndicator != nil {
		localVarQueryParams.Add("count-indicator", parameterToString(*r.countIndicator, ""))
	}
	if r.supportedFeatures != nil {
		localVarQueryParams.Add("supported-features", parameterToString(*r.supportedFeatures, ""))
	}
	if r.retrieveRecords != nil {
		localVarQueryParams.Add("retrieve-records", parameterToString(*r.retrieveRecords, ""))
	}
