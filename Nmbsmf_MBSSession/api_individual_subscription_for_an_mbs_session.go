...
type IndividualSubscriptionForAnMBSSessionApi interface {
	...
	*/
	StatusSubscribeMod(ctx context.Context, subscriptionId string) ApiStatusSubscribeModRequest

	// StatusSubscribeModExecute executes the request
	//  @return MbsSessionSubscription
	StatusSubscribeModExecute(r ApiStatusSubscribeModRequest) (*MbsSessionSubscription, *http.Response, error)
	...
	*/
	StatusUnSubscribe(ctx context.Context, subscriptionId string) ApiStatusUnSubscribeRequest

	// StatusUnSubscribeExecute executes the request
	StatusUnSubscribeExecute(r ApiStatusUnSubscribeRequest) (*http.Response, error)
}
...
type ApiStatusSubscribeModRequest struct {
	ctx context.Context
	ApiService IndividualSubscriptionForAnMBSSessionApi
