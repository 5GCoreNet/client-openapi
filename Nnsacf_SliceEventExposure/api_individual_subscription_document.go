...
type IndividualSubscriptionDocumentApi interface {
	...
	*/
	CompleteModifySubscription(ctx context.Context, subscriptionId string) ApiCompleteModifySubscriptionRequest

	// CompleteModifySubscriptionExecute executes the request
	//  @return CreatedSACEventSubscription
	CompleteModifySubscriptionExecute(r ApiCompleteModifySubscriptionRequest) (*CreatedSACEventSubscription, *http.Response, error)
	...
	*/
	PartialModifySubscription(ctx context.Context, subscriptionId string) ApiPartialModifySubscriptionRequest

	// PartialModifySubscriptionExecute executes the request
	//  @return CreatedSACEventSubscription
	PartialModifySubscriptionExecute(r ApiPartialModifySubscriptionRequest) (*CreatedSACEventSubscription, *http.Response, error)
}
