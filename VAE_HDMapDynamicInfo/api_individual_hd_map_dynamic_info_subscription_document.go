...
type IndividualHdMapDynamicInfoSubscriptionDocumentApi interface {
	...
	*/
	ReadHdMapDynamicInfoSubscription(ctx context.Context, subscriptionId string) ApiReadHdMapDynamicInfoSubscriptionRequest

	// ReadHdMapDynamicInfoSubscriptionExecute executes the request
	//  @return HdMapDynamicInfoData
	ReadHdMapDynamicInfoSubscriptionExecute(r ApiReadHdMapDynamicInfoSubscriptionRequest) (*HdMapDynamicInfoData, *http.Response, error)
}
...
type ApiReadHdMapDynamicInfoSubscriptionRequest struct {
	ctx context.Context
	ApiService IndividualHdMapDynamicInfoSubscriptionDocumentApi
