...
type IndividualHdmapDynamicinfoSubscriptionDocumentApi interface {
	...
	*/
	DeleteHdMapDynamicInfoSubscription(ctx context.Context, subscriptionId string) ApiDeleteHdMapDynamicInfoSubscriptionRequest

	// DeleteHdMapDynamicInfoSubscriptionExecute executes the request
	DeleteHdMapDynamicInfoSubscriptionExecute(r ApiDeleteHdMapDynamicInfoSubscriptionRequest) (*http.Response, error)
}
