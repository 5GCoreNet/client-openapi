# Go API client for PfdManagement
...
```golang
ctx := context.WithValue(context.Background(), PfdManagement.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), PfdManagement.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), PfdManagement.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), PfdManagement.ContextOperationServerVariables, map[string]map[string]string{
