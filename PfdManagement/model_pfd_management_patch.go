...
// GetPfdDatas returns the PfdDatas field value if set, zero value otherwise.
func (o *PfdManagementPatch) GetPfdDatas() map[string]PfdData {
	if o == nil || isNil(o.PfdDatas) {
...
// GetPfdDatasOk returns a tuple with the PfdDatas field value if set, nil otherwise
...
// SetPfdDatas gets a reference to the given map[string]PfdData and assigns it to the PfdDatas field.
...
func (o PfdManagementPatch) MarshalJSON() ([]byte, error) {
...
type NullablePfdManagementPatch struct {
	value *PfdManagementPatch
	isSet bool
}

func (v NullablePfdManagementPatch) Get() *PfdManagementPatch {
	return v.value
}

func (v *NullablePfdManagementPatch) Set(val *PfdManagementPatch) {
	v.value = val
	v.isSet = true
}

func (v NullablePfdManagementPatch) IsSet() bool {
	return v.isSet
}

func (v *NullablePfdManagementPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePfdManagementPatch(val *PfdManagementPatch) *NullablePfdManagementPatch {
	return &NullablePfdManagementPatch{value: val, isSet: true}
}

func (v NullablePfdManagementPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePfdManagementPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
