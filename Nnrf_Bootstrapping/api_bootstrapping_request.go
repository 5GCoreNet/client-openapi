...
type BootstrappingRequestApi interface {
	...
	*/
	BootstrappingInfoRequest(ctx context.Context) ApiBootstrappingInfoRequestRequest

	// BootstrappingInfoRequestExecute executes the request
	//  @return BootstrappingInfo
	BootstrappingInfoRequestExecute(r ApiBootstrappingInfoRequestRequest) (*BootstrappingInfo, *http.Response, error)
}
...
type ApiBootstrappingInfoRequestRequest struct {
	ctx context.Context
	ApiService BootstrappingRequestApi
	ifNoneMatch *string
}
