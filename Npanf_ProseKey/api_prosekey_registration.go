...
type ProsekeyRegistrationApi interface {
	...
	*/
	ProseKeyRegistration(ctx context.Context) ApiProseKeyRegistrationRequest

	// ProseKeyRegistrationExecute executes the request
	ProseKeyRegistrationExecute(r ApiProseKeyRegistrationRequest) (*http.Response, error)
}
...
type ApiProseKeyRegistrationRequest struct {
	ctx context.Context
	ApiService ProsekeyRegistrationApi
