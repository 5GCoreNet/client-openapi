...
------------ | ------------- | ------------- | -------------
*ProseKeyRetrievalApi* | [**ProseKeyRetrieval**](docs/ProseKeyRetrievalApi.md#prosekeyretrieval) | **Post** /prose-keys/retrieve | retrieve the prose key
*ProsekeyRegistrationApi* | [**ProseKeyRegistration**](docs/ProsekeyRegistrationApi.md#prosekeyregistration) | **Post** /prose-keys/register | Register the Prose Key
...
## Documentation For Models
 ...
 - [ProseContextInfo](docs/ProseContextInfo.md)
 - [ProseKeyRequest](docs/ProseKeyRequest.md)
 - [ProseKeyResponse](docs/ProseKeyResponse.md)
