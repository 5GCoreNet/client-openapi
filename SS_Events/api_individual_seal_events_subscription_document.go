...
type IndividualSEALEventsSubscriptionDocumentApi interface {
	...
	*/
	DeleteIndSealEventSubsc(ctx context.Context, subscriptionId string) ApiDeleteIndSealEventSubscRequest

	// DeleteIndSealEventSubscExecute executes the request
	DeleteIndSealEventSubscExecute(r ApiDeleteIndSealEventSubscRequest) (*http.Response, error)
	...
	*/
	ModifyIndSealEventSubsc(ctx context.Context, subscriptionId string) ApiModifyIndSealEventSubscRequest

	// ModifyIndSealEventSubscExecute executes the request
	//  @return SEALEventSubscription
	ModifyIndSealEventSubscExecute(r ApiModifyIndSealEventSubscRequest) (*SEALEventSubscription, *http.Response, error)
	...
	*/
	UpdateIndSealEventSubsc(ctx context.Context, subscriptionId string) ApiUpdateIndSealEventSubscRequest

	// UpdateIndSealEventSubscExecute executes the request
	//  @return SEALEventSubscription
	UpdateIndSealEventSubscExecute(r ApiUpdateIndSealEventSubscRequest) (*SEALEventSubscription, *http.Response, error)
}
...
type ApiDeleteIndSealEventSubscRequest struct {
	ctx context.Context
	ApiService IndividualSEALEventsSubscriptionDocumentApi
