...
type SEALEventsSubscriptionsCollectionApi interface {
	...
	*/
	CreateSealEventSubsc(ctx context.Context) ApiCreateSealEventSubscRequest

	// CreateSealEventSubscExecute executes the request
	//  @return SEALEventSubscription
	CreateSealEventSubscExecute(r ApiCreateSealEventSubscRequest) (*SEALEventSubscription, *http.Response, error)
}
...
type ApiCreateSealEventSubscRequest struct {
	ctx context.Context
	ApiService SEALEventsSubscriptionsCollectionApi
...
func (r ApiCreateSealEventSubscRequest) Execute() (*SEALEventSubscription, *http.Response, error) {
	return r.ApiService.CreateSealEventSubscExecute(r)
}
...
Creates a new individual SEAL Event Subscription.
 ...
 @return ApiCreateSealEventSubscRequest
*/
func (a *SEALEventsSubscriptionsCollectionApiService) CreateSealEventSubsc(ctx context.Context) ApiCreateSealEventSubscRequest {
	return ApiCreateSealEventSubscRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return SEALEventSubscription
func (a *SEALEventsSubscriptionsCollectionApiService) CreateSealEventSubscExecute(r ApiCreateSealEventSubscRequest) (*SEALEventSubscription, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SEALEventsSubscriptionsCollectionApiService.CreateSealEventSubsc")
	if err != nil {
