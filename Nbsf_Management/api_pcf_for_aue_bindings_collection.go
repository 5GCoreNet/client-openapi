...
type PCFForAUEBindingsCollectionApi interface {
	...
	*/
	...
	// CreatePCFforUEBindingExecute executes the request
	//  @return PcfForUeBinding
	CreatePCFforUEBindingExecute(r ApiCreatePCFforUEBindingRequest) (*PcfForUeBinding, *http.Response, error)
	...
	*/
	...
	// GetPCFForUeBindingsExecute executes the request
	//  @return []PcfForUeBinding
	GetPCFForUeBindingsExecute(r ApiGetPCFForUeBindingsRequest) ([]PcfForUeBinding, *http.Response, error)
}
...
type ApiCreatePCFforUEBindingRequest struct {
	ctx context.Context
	ApiService PCFForAUEBindingsCollectionApi
