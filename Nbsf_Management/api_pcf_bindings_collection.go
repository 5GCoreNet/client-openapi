...
type PCFBindingsCollectionApi interface {
	...
	*/
	CreatePCFBinding(ctx context.Context) ApiCreatePCFBindingRequest

	// CreatePCFBindingExecute executes the request
	//  @return PcfBinding
	CreatePCFBindingExecute(r ApiCreatePCFBindingRequest) (*PcfBinding, *http.Response, error)
	...
	*/
	...
	// GetPCFBindingsExecute executes the request
	//  @return PcfBinding
	GetPCFBindingsExecute(r ApiGetPCFBindingsRequest) (*PcfBinding, *http.Response, error)
}
...
type ApiCreatePCFBindingRequest struct {
	ctx context.Context
	ApiService PCFBindingsCollectionApi
...
func (a *PCFBindingsCollectionApiService) GetPCFBindingsExecute(r ApiGetPCFBindingsRequest) (*PcfBinding, *http.Response, error) {
	...
	if r.ipv4Addr != nil {
		localVarQueryParams.Add("ipv4Addr", parameterToString(*r.ipv4Addr, ""))
	}
	if r.ipv6Prefix != nil {
		localVarQueryParams.Add("ipv6Prefix", parameterToString(*r.ipv6Prefix, ""))
	}
	if r.macAddr48 != nil {
		localVarQueryParams.Add("macAddr48", parameterToString(*r.macAddr48, ""))
	}
	if r.dnn != nil {
	...
	if r.ipDomain != nil {
		localVarQueryParams.Add("ipDomain", parameterToString(*r.ipDomain, ""))
	}
	if r.suppFeat != nil {
