...
type IndividualPCFBindingDocumentApi interface {
	...
	*/
	DeleteIndPCFBinding(ctx context.Context, bindingId string) ApiDeleteIndPCFBindingRequest

	// DeleteIndPCFBindingExecute executes the request
	DeleteIndPCFBindingExecute(r ApiDeleteIndPCFBindingRequest) (*http.Response, error)
}
...
type ApiDeleteIndPCFBindingRequest struct {
	ctx context.Context
	ApiService IndividualPCFBindingDocumentApi
	bindingId string
}
