...
type IndividualPCFForAnMBSSessionBindingDocumentApi interface {
	...
	*/
	DeleteIndPCFMbsBinding(ctx context.Context, bindingId string) ApiDeleteIndPCFMbsBindingRequest

	// DeleteIndPCFMbsBindingExecute executes the request
	DeleteIndPCFMbsBindingExecute(r ApiDeleteIndPCFMbsBindingRequest) (*http.Response, error)
	...
	*/
	ModifyIndPCFMbsBinding(ctx context.Context, bindingId string) ApiModifyIndPCFMbsBindingRequest

	// ModifyIndPCFMbsBindingExecute executes the request
	//  @return PcfForUeBinding
	ModifyIndPCFMbsBindingExecute(r ApiModifyIndPCFMbsBindingRequest) (*PcfForUeBinding, *http.Response, error)
}
...
type ApiDeleteIndPCFMbsBindingRequest struct {
	ctx context.Context
	ApiService IndividualPCFForAnMBSSessionBindingDocumentApi
	bindingId string
}
...
func (a *IndividualPCFForAnMBSSessionBindingDocumentApiService) DeleteIndPCFMbsBindingExecute(r ApiDeleteIndPCFMbsBindingRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"bindingId"+"}", url.PathEscape(parameterToString(r.bindingId, "")), -1)
...
func (r ApiModifyIndPCFMbsBindingRequest) Execute() (*PcfForUeBinding, *http.Response, error) {
...
// Execute executes the request
//  @return PcfForUeBinding
func (a *IndividualPCFForAnMBSSessionBindingDocumentApiService) ModifyIndPCFMbsBindingExecute(r ApiModifyIndPCFMbsBindingRequest) (*PcfForUeBinding, *http.Response, error) {
	var (
