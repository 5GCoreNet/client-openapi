...
type IndividualPCFForAPDUSessionBindingDocumentApi interface {
	...
	*/
	UpdateIndPCFBinding(ctx context.Context, bindingId string) ApiUpdateIndPCFBindingRequest

	// UpdateIndPCFBindingExecute executes the request
	//  @return PcfBinding
	UpdateIndPCFBindingExecute(r ApiUpdateIndPCFBindingRequest) (*PcfBinding, *http.Response, error)
}
...
type ApiUpdateIndPCFBindingRequest struct {
	ctx context.Context
	ApiService IndividualPCFForAPDUSessionBindingDocumentApi
	bindingId string
