...
type PCFForAnMBSSessionBindingsCollectionApi interface {
	...
	*/
	CreatePCFMbsBinding(ctx context.Context) ApiCreatePCFMbsBindingRequest

	// CreatePCFMbsBindingExecute executes the request
	//  @return PcfMbsBinding
	CreatePCFMbsBindingExecute(r ApiCreatePCFMbsBindingRequest) (*PcfMbsBinding, *http.Response, error)
	...
	*/
	GetPCFMbsBinding(ctx context.Context) ApiGetPCFMbsBindingRequest

	// GetPCFMbsBindingExecute executes the request
	//  @return PcfMbsBinding
	GetPCFMbsBindingExecute(r ApiGetPCFMbsBindingRequest) (*PcfMbsBinding, *http.Response, error)
}
...
type ApiCreatePCFMbsBindingRequest struct {
	ctx context.Context
	ApiService PCFForAnMBSSessionBindingsCollectionApi
...
func (r ApiCreatePCFMbsBindingRequest) Execute() (*PcfMbsBinding, *http.Response, error) {
	return r.ApiService.CreatePCFMbsBindingExecute(r)
}
...
func (a *PCFForAnMBSSessionBindingsCollectionApiService) CreatePCFMbsBindingExecute(r ApiCreatePCFMbsBindingRequest) (*PcfMbsBinding, *http.Response, error) {
	...
	localVarPath := localBasePath + "/pcf-mbs-bindings"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.pcfMbsBinding == nil {
		return localVarReturnValue, nil, reportError("pcfMbsBinding is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.pcfMbsBinding
...
func (r ApiGetPCFMbsBindingRequest) Execute() (*PcfMbsBinding, *http.Response, error) {
	return r.ApiService.GetPCFMbsBindingExecute(r)
}
...
func (a *PCFForAnMBSSessionBindingsCollectionApiService) GetPCFMbsBindingExecute(r ApiGetPCFMbsBindingRequest) (*PcfMbsBinding, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.mbsSessionId == nil {
		return localVarReturnValue, nil, reportError("mbsSessionId is required and must be specified")
	}

	localVarQueryParams.Add("mbs-session-id", parameterToString(*r.mbsSessionId, ""))
	if r.suppFeat != nil {
