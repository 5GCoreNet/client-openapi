...
type IndividualPCFForAUEBindingDocumentApi interface {
	...
	*/
	...
	// DeleteIndPCFforUEBindingExecute executes the request
	DeleteIndPCFforUEBindingExecute(r ApiDeleteIndPCFforUEBindingRequest) (*http.Response, error)
	...
	*/
	...
	// UpdateIndPCFforUEBindingExecute executes the request
	//  @return PcfForUeBinding
	UpdateIndPCFforUEBindingExecute(r ApiUpdateIndPCFforUEBindingRequest) (*PcfForUeBinding, *http.Response, error)
}
...
type ApiDeleteIndPCFforUEBindingRequest struct {
	ctx context.Context
	ApiService IndividualPCFForAUEBindingDocumentApi
	bindingId string
}
