...
type NumberPortabilityStatusDocumentApi interface {
	...
	*/
	GetNumberPortabilityStatus(ctx context.Context, gpsi string) ApiGetNumberPortabilityStatusRequest

	// GetNumberPortabilityStatusExecute executes the request
	//  @return NpStatusInfo
	GetNumberPortabilityStatusExecute(r ApiGetNumberPortabilityStatusRequest) (*NpStatusInfo, *http.Response, error)
}
...
type ApiGetNumberPortabilityStatusRequest struct {
	ctx context.Context
	ApiService NumberPortabilityStatusDocumentApi
	gpsi string
}

func (r ApiGetNumberPortabilityStatusRequest) Execute() (*NpStatusInfo, *http.Response, error) {
	return r.ApiService.GetNumberPortabilityStatusExecute(r)
}
...
func (a *NumberPortabilityStatusDocumentApiService) GetNumberPortabilityStatusExecute(r ApiGetNumberPortabilityStatusRequest) (*NpStatusInfo, *http.Response, error) {
	...
	localVarPath := localBasePath + "/{gpsi}"
	localVarPath = strings.Replace(localVarPath, "{"+"gpsi"+"}", url.PathEscape(parameterToString(r.gpsi, "")), -1)
