...
type AccessTokenRequestApi interface {
	...
	*/
	...
	AccessTokenRequestExecute(r ApiAccessTokenRequestRequest) (*AccessTokenRsp, *http.Response, error)
}
...
func (a *AccessTokenRequestApiService) AccessTokenRequestExecute(r ApiAccessTokenRequestRequest) (*AccessTokenRsp, *http.Response, error) {
	...
	if r.requesterPlmnList != nil {
		localVarFormParams.Add("requesterPlmnList", parameterToString(*r.requesterPlmnList, "multi"))
	}
	if r.requesterSnssaiList != nil {
		localVarFormParams.Add("requesterSnssaiList", parameterToString(*r.requesterSnssaiList, "multi"))
	}
	if r.requesterFqdn != nil {
		localVarFormParams.Add("requesterFqdn", parameterToString(*r.requesterFqdn, ""))
	}
	if r.requesterSnpnList != nil {
		localVarFormParams.Add("requesterSnpnList", parameterToString(*r.requesterSnpnList, "multi"))
	}
	if r.targetPlmn != nil {
	...
	if r.targetSnssaiList != nil {
		localVarFormParams.Add("targetSnssaiList", parameterToString(*r.targetSnssaiList, "multi"))
	}
	if r.targetNsiList != nil {
		localVarFormParams.Add("targetNsiList", parameterToString(*r.targetNsiList, "multi"))
	}
	...
	if r.sourceNfInstanceId != nil {
		localVarFormParams.Add("sourceNfInstanceId", parameterToString(*r.sourceNfInstanceId, ""))
	}
