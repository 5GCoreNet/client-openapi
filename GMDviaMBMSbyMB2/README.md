# Go API client for GMDviaMBMSbyMB2
...
```golang
ctx := context.WithValue(context.Background(), GMDviaMBMSbyMB2.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), GMDviaMBMSbyMB2.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), GMDviaMBMSbyMB2.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), GMDviaMBMSbyMB2.ContextOperationServerVariables, map[string]map[string]string{
