...
func (o TopAttr) MarshalJSON() ([]byte, error) {
...
type NullableTopAttr struct {
	value *TopAttr
	isSet bool
}

func (v NullableTopAttr) Get() *TopAttr {
	return v.value
}

func (v *NullableTopAttr) Set(val *TopAttr) {
	v.value = val
	v.isSet = true
}

func (v NullableTopAttr) IsSet() bool {
	return v.isSet
}

func (v *NullableTopAttr) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTopAttr(val *TopAttr) *NullableTopAttr {
	return &NullableTopAttr{value: val, isSet: true}
}

func (v NullableTopAttr) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTopAttr) UnmarshalJSON(src []byte) error {
	v.isSet = true
