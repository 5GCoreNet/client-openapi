...
// SetThreshold gets a reference to the given ThresholdInfo and assigns it to the Threshold field.
...
// SetAnalyticsPeriod gets a reference to the given []time.Time and assigns it to the AnalyticsPeriod field.
