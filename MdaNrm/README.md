...
```golang
ctx := context.WithValue(context.Background(), MdaNrm.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), MdaNrm.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```golang
ctx := context.WithValue(context.Background(), MdaNrm.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), MdaNrm.ContextOperationServerVariables, map[string]map[string]string{
