...
type DefaultApi interface {
	...
	*/
	ApiInvocationLogsGet(ctx context.Context) ApiApiInvocationLogsGetRequest

	// ApiInvocationLogsGetExecute executes the request
	//  @return InvocationLog
	ApiInvocationLogsGetExecute(r ApiApiInvocationLogsGetRequest) (*InvocationLog, *http.Response, error)
}
